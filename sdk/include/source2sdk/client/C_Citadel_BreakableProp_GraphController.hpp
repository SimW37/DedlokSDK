...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class C_Citadel_BreakableProp_GraphController : public client::CBaseAnimGraphAnimGraphController
    {
    public:
        ...
        char m_flDamageReceived[0x20]; // 0xe8        
