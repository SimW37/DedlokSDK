...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CCitadel_Ability_Spinning_Blade_GraphController : public client::CCitadelBaseAbilityGraphController
    {
    public:
        ...
        char m_bBoomerangCatch[0x20]; // 0xc8        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Ability_Spinning_Blade_GraphController) == 0xe8);
};
