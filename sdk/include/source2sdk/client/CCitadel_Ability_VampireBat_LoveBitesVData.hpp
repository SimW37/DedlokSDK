...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_VampireBat_LoveBitesVData : public client::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_DamageProcModifier;
    ...
    static_assert(sizeof(CCitadel_Ability_VampireBat_LoveBitesVData) == 0x1700);
};
