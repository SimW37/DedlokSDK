...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_ApplyDebuff_ProcVData : public source2sdk::client::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            bool m_bUseNonEmbedded; // 0x690            
            uint8_t _pad0691[0x7]; // 0x691
            ...
            char m_NonEmbeddedModifier[0x10]; // 0x6b0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_ApplyDebuff_ProcVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_ApplyDebuff_ProcVData) == 0x6c0);
    };
};
