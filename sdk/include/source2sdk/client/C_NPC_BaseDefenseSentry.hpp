...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_NPC_BaseDefenseSentry : public source2sdk::client::C_NPC_SimpleAnimatingAI
        {
        public:
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            Vector m_vecUnitStatusOffset; // 0xcb0            
        ...
        static_assert(sizeof(source2sdk::client::C_NPC_BaseDefenseSentry) == 0xcc0);
    };
};
