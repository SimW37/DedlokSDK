...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_TeleportStartParticle[0xe0]; // 0x660        
        ...
        char m_TeleportEndParticle[0xe0]; // 0x740        
        ...
        char m_TeleportTrailParticle[0xe0]; // 0x820        
        ...
        char m_TeleportModelParticle[0xe0]; // 0x900        
        // metadata: MPropertyGroupName "Modifiers"
        // m_BuffModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CEmbeddedSubclass<client::CBaseModifier> m_BuffModifier;
        char m_BuffModifier[0x10]; // 0x9e0        
        // metadata: MPropertyGroupName "Misc"
        float m_flPreTeleportDuration; // 0x9f0        
        [[maybe_unused]] std::uint8_t pad_0x9f4[0x4]; // 0x9f4
        CPiecewiseCurve m_TeleportVerticalOffsetCurve; // 0x9f8        
        // metadata: MPropertyGroupName "Sounds"
        CSoundEventName m_strAmbientLoopingLocalPlayerSound; // 0xa38        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Modifier_VoidSphereVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Modifier_VoidSphereVData) == 0xa48);
};
