...
namespace source2sdk::client
{
    ...
    public:
        ...
        entity2::GameTime_t m_tNextDetonateTime; // 0x894        
        ...
        char m_vecProjectileHitTargets[0x18]; // 0x898        
        [[maybe_unused]] std::uint8_t pad_0x8b0[0x28];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_Citadel_Projectile_Viscous_GooGrenade because it is not a standard-layout class
    static_assert(sizeof(C_Citadel_Projectile_Viscous_GooGrenade) == 0x8d8);
};
