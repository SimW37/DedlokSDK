...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Astro_Shotgun_Toggle_VData : public client::CitadelAbilityVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Ability_Astro_Shotgun_Toggle_VData) == 0x15d8);
};
