...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_Disarm_VData : public source2sdk::client::CCitadel_Item_TrackingProjectileApplyModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Item_Disarm_VData) == 0x17c8);
    };
};
