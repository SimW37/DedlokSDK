...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Inhibitor_ProcVData : public client::CCitadel_Modifier_BaseEventProcVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_Inhibitor_ProcVData) == 0x6a0);
};
