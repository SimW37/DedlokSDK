...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Upgrade_AerialAssualtVData : public source2sdk::client::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_WatcherModifier;
            char m_WatcherModifier[0x10]; // 0x1678            
            ...
            char m_LaunchParticle[0xe0]; // 0x1688            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Upgrade_AerialAssualtVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Upgrade_AerialAssualtVData) == 0x1768);
    };
};
