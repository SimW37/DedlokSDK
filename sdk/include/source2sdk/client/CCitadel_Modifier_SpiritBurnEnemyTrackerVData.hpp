...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_SpiritBurnEnemyTrackerVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_SpiritBurnEnemyTrackerVData) == 0x760);
    };
};
