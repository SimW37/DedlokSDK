...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_BaseProjectileAOEModifierVData : public source2sdk::client::CitadelItemVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Item_BaseProjectileAOEModifierVData) == 0x16b8);
    };
};
