...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::C_CitadelBaseAbility* m_pAbility; // 0xca0            
            float m_flStunDuration; // 0xca8            
            float m_flStunRadius; // 0xcac            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_Projectile_Airheart_Package because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_Projectile_Airheart_Package) == 0xcb0);
    };
};
