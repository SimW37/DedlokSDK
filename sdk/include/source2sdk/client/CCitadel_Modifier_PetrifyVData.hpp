...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_PetrifyVData : public source2sdk::client::CCitadel_Modifier_StunnedVData
        {
        public:
            ...
            char m_DebuffParticle[0xe0]; // 0x740            
            ...
            char m_BuffStartParticle[0xe0]; // 0x820            
            ...
            char m_BuffEndParticle[0xe0]; // 0x900            
            ...
            char m_PostSleepModifier[0x10]; // 0x9e0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_PetrifyVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_PetrifyVData) == 0x9f0);
    };
};
