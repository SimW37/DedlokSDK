...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Objective_RegenVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
