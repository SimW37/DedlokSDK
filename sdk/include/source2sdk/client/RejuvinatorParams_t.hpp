...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::RejuvinatorParams_t, m_flRejuvinatorDropHeight3LaneMap) == 0xc);
        static_assert(offsetof(source2sdk::client::RejuvinatorParams_t, m_flRejuvinatorDropDuration) == 0x10);
        static_assert(offsetof(source2sdk::client::RejuvinatorParams_t, m_TrooperHealthMult) == 0x18);
        static_assert(offsetof(source2sdk::client::RejuvinatorParams_t, m_PlayerRespawnMult) == 0x30);
        static_assert(offsetof(source2sdk::client::RejuvinatorParams_t, m_strRejuvPickupSound) == 0x48);
        
        static_assert(sizeof(source2sdk::client::RejuvinatorParams_t) == 0x58);
    };
};
