...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_DebrisParticle[0xe0]; // 0x660            
            ...
            char m_EnemyVisionModifier[0x10]; // 0x840            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_FissureWallVData) == 0x860);
    };
};
