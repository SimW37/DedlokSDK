...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Chrono_KineticCarbineVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            float m_flShotTimeScaleLingerDuration; // 0x1620            
            ...
            char m_ChargingModifier[0x10]; // 0x1628            
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraKineticCarbineShotFired; // 0x1648            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Chrono_KineticCarbineVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Chrono_KineticCarbineVData) == 0x16d0);
    };
};
