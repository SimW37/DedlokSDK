...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_flShotTimeScaleLingerDuration; // 0x15e8            
            ...
            char m_ChargingModifier[0x10]; // 0x15f0            
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraKineticCarbineShotFired; // 0x1610            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Chrono_KineticCarbineVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Chrono_KineticCarbineVData) == 0x1698);
    };
};
