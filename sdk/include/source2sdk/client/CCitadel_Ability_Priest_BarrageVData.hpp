...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Priest_BarrageVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            CSoundEventName m_ShootSound; // 0x1608            
            CSoundEventName m_ExplodeSound; // 0x1618            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Priest_BarrageVData) == 0x17e8);
    };
};
