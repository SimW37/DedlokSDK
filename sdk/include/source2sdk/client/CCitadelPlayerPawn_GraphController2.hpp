...
namespace source2sdk::client
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x80[0x30]; // 0x80
        ...
        char m_flForwardSpeed[0x18]; // 0xb0        
        ...
        char m_flLookHeading[0x18]; // 0xc8        
        ...
        char m_flStrafeSpeed[0x18]; // 0x110        
        ...
        char m_flVerticalSpeed[0x18]; // 0x128        
        ...
        char m_vLocomotionFacing[0x18]; // 0x140        
        ...
        char m_HeroActionSource[0x20]; // 0x170        
        ...
        char m_CrouchFraction[0x18]; // 0x230        
        ...
        char m_CornerLean[0x20]; // 0x268        
        [[maybe_unused]] std::uint8_t pad_0x288[0x28]; // 0x288
        bool m_bInGraphParamUpdateFlow; // 0x2b0        
        [[maybe_unused]] std::uint8_t pad_0x2b1[0x2f];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadelPlayerPawn_GraphController2 because it is not a standard-layout class
    static_assert(sizeof(CCitadelPlayerPawn_GraphController2) == 0x2e0);
};
