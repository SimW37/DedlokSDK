...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_ThrowSandVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_SilenceDebuff;
            char m_SilenceDebuff[0x10]; // 0x15f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ThrowSandVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ThrowSandVData) == 0x1608);
    };
};
