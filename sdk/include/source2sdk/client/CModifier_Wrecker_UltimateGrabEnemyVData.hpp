...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Wrecker_UltimateGrabEnemyVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CModifier_Wrecker_UltimateGrabEnemyVData) == 0x820);
    };
};
