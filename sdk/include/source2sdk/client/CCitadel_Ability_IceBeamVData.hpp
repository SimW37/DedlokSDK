...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_IceBeamVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_BeamParticle[0xe0]; // 0x15e8            
            ...
            char m_BuildupModifier[0x10]; // 0x17b8            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_BuildupProcModifier;
            char m_BuildupProcModifier[0x10]; // 0x17c8            
            // metadata: MPropertyStartGroup "Sound"
            CSoundEventName m_BeamStartSound; // 0x17d8            
            CSoundEventName m_BeamStopSound; // 0x17e8            
            CSoundEventName m_BeamPointStartLoopSound; // 0x17f8            
            CSoundEventName m_BeamPointEndLoopSound; // 0x1808            
            CSoundEventName m_BeamPointClosestLoopSound; // 0x1818            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_IceBeamVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_IceBeamVData) == 0x1828);
    };
};
