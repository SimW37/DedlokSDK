...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Thumper_2_AuraVData : public source2sdk::client::CCitadelModifierAuraVData
        {
        public:
