...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_DeployParticle[0xe0]; // 0x1668        
        ...
        char m_RespawnParticle[0xe0]; // 0x1748        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_sDeploySound; // 0x1828        
        CSoundEventName m_sRespawnSound; // 0x1838        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_ArmorUpgrade_PersonalRejuvenatorVData) == 0x1848);
};
