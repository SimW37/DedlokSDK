...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_nGrenadeIndex; // 0xd88            
            std::int32_t m_nTotalGrenades; // 0xd8c            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Tier2Boss_RocketBarrage) == 0x1010);
    };
};
