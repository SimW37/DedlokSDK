...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_InnateModifier[0x10]; // 0x15f0            
            ...
            float m_flDamageFalloffEndScale; // 0x1610            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ShieldedSentry_VData) == 0x1618);
    };
};
