...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_ShieldedSentry_VData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CBaseModifier> m_InnateModifier;
            char m_InnateModifier[0x10]; // 0x1620            
            ...
            float m_flDamageFalloffEndScale; // 0x1640            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ShieldedSentry_VData) == 0x1648);
    };
};
