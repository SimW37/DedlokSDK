...
namespace source2sdk::client
{
    ...
    public:
        ...
        // CUtlVector<client::CitadelMuzzle_t> m_vecPrimaryMuzzles;
        ...
        // CUtlVector<client::CitadelMuzzle_t> m_vecSecondaryMuzzles;
        char m_vecSecondaryMuzzles[0x18]; // 0x18        
    };
    #pragma pack(pop)
    
    static_assert(offsetof(CitadelMuzzleSettings_t, m_vecPrimaryMuzzles) == 0x0);
    static_assert(offsetof(CitadelMuzzleSettings_t, m_vecSecondaryMuzzles) == 0x18);
    
    static_assert(sizeof(CitadelMuzzleSettings_t) == 0x30);
};
