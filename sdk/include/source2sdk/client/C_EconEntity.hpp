...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            uint8_t _pad0e58[0x10]; // 0xe58
            // metadata: MNetworkEnable
            source2sdk::client::CAttributeContainer m_AttributeManager; // 0xe68            
            bool m_bClientside; // 0xfc0            
            uint8_t _pad0fc1[0x3]; // 0xfc1
            source2sdk::client::EconEntityParticleDisableMode_t m_nDisableMode; // 0xfc4            
            bool m_bParticleSystemsCreated; // 0xfc8            
            bool m_bForceDestroyAttachedParticlesImmediately; // 0xfc9            
            ...
            char m_vecAttachedParticles[0x18]; // 0xfd0            
            ...
            char m_hViewmodelAttachment[0x4]; // 0xfe8            
            std::int32_t m_iOldTeam; // 0xfec            
            bool m_bAttachmentDirty; // 0xff0            
            source2sdk::client::style_index_t m_iOldStyle; // 0xff1            
            ...
            char m_vecAttachedModels[0x18]; // 0xff8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_EconEntity because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_EconEntity) == 0x1010);
    };
};
