...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbilitySprintVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_SprintParticle[0xe0]; // 0x1618            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strSprintSound; // 0x16f8            
            // metadata: MPropertyStartGroup "+Sprint Properties"
            float m_flSprintAccMS; // 0x1708            
        ...
        static_assert(sizeof(source2sdk::client::CAbilitySprintVData) == 0x1710);
    };
};
