...
namespace source2sdk::client
{
    ...
    public:
        ...
        // CHandle<client::C_Citadel_Ice_Dome_Blocker> m_hBlocker;
        ...
        // CHandle<client::CPointModifierThinker> m_hFriendlyAura;
        ...
        // CHandle<client::CPointModifierThinker> m_hEnemyAura;
    ...
    static_assert(sizeof(CCitadel_Modifier_IceDome) == 0x1e8);
};
