...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            bool m_bEnableMovementToNodes; // 0x16b0            
            uint8_t _pad16b1[0x3]; // 0x16b1
            source2sdk::tier2::CRangeFloat m_flExposedDuration; // 0x16b4            
            source2sdk::tier2::CRangeFloat m_flHideDuration; // 0x16bc            
            ...
            char m_HidingModifier[0x10]; // 0x16c8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CNPC_TrooperNeutralNodeMoverVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CNPC_TrooperNeutralNodeMoverVData) == 0x16d8);
    };
};
