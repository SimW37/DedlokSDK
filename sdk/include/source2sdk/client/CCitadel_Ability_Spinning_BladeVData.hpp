...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_CatchIndicator[0xe0]; // 0x1600            
            ...
            char m_CatchParticle[0xe0]; // 0x16e0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strThrowSound; // 0x17c0            
            CSoundEventName m_strReturnSound; // 0x17d0            
            CSoundEventName m_strCatchSound; // 0x17e0            
            CSoundEventName m_strFailSound; // 0x17f0            
            CSoundEventName m_strHitSound; // 0x1800            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Spinning_BladeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Spinning_BladeVData) == 0x1810);
    };
};
