...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Spinning_BladeVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_CatchIndicator[0xe0]; // 0x1630            
            ...
            char m_CatchParticle[0xe0]; // 0x1710            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strThrowSound; // 0x17f0            
            CSoundEventName m_strReturnSound; // 0x1800            
            CSoundEventName m_strCatchSound; // 0x1810            
            CSoundEventName m_strFailSound; // 0x1820            
            CSoundEventName m_strHitSound; // 0x1830            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Spinning_BladeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Spinning_BladeVData) == 0x1840);
    };
};
