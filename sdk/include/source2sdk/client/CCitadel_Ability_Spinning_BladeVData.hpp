...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_CatchIndicator[0xe0]; // 0x15f8            
            ...
            char m_CatchParticle[0xe0]; // 0x16d8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strThrowSound; // 0x17b8            
            CSoundEventName m_strReturnSound; // 0x17c8            
            CSoundEventName m_strCatchSound; // 0x17d8            
            CSoundEventName m_strFailSound; // 0x17e8            
            CSoundEventName m_strHitSound; // 0x17f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Spinning_BladeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Spinning_BladeVData) == 0x1808);
    };
};
