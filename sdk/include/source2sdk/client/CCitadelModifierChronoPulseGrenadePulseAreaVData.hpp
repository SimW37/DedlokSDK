...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadelModifierChronoPulseGrenadePulseAreaVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadelModifierChronoPulseGrenadePulseAreaVData) == 0x880);
    };
};
