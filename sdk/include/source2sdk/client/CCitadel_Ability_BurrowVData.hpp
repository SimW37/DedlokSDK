...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_BurrowVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_BurrowStartParticle[0xe0]; // 0x1700            
            ...
            char m_BurrowEndParticle[0xe0]; // 0x17e0            
            ...
            char m_BurrowInGroundParticle[0xe0]; // 0x18c0            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_BurrowModifier;
            char m_BurrowModifier[0x10]; // 0x19a0            
            // m_SpinModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_SpinModifier;
            char m_SpinModifier[0x10]; // 0x19b0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strBurrowEndSound; // 0x19c0            
            // metadata: MPropertyStartGroup "+Burrow Properties"
            float m_flChannelEndEnemyPopUpForce; // 0x19d0            
            float m_flChannelEndEnemyPopUpCylinderHeight; // 0x19d4            
            // metadata: MPropertyDescription "Spin Camera Controller that matches the modifier for client"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSpinStart; // 0x19d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_BurrowVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_BurrowVData) == 0x1a60);
    };
};
