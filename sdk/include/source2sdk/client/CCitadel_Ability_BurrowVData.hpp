...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_BurrowStartParticle[0xe0]; // 0x16d0            
            ...
            char m_BurrowEndParticle[0xe0]; // 0x17b0            
            ...
            char m_BurrowInGroundParticle[0xe0]; // 0x1890            
            ...
            char m_BurrowModifier[0x10]; // 0x1970            
            ...
            char m_SpinModifier[0x10]; // 0x1980            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strBurrowEndSound; // 0x1990            
            // metadata: MPropertyStartGroup "+Burrow Properties"
            float m_flChannelEndEnemyPopUpForce; // 0x19a0            
            float m_flChannelEndEnemyPopUpCylinderHeight; // 0x19a4            
            // metadata: MPropertyDescription "Spin Camera Controller that matches the modifier for client"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSpinStart; // 0x19a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_BurrowVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_BurrowVData) == 0x1a30);
    };
};
