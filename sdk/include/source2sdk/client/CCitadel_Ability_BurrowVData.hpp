...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_BurrowStartParticle[0xe0]; // 0x16f8            
            ...
            char m_BurrowEndParticle[0xe0]; // 0x17d8            
            ...
            char m_BurrowInGroundParticle[0xe0]; // 0x18b8            
            ...
            char m_BurrowModifier[0x10]; // 0x1998            
            ...
            char m_SpinModifier[0x10]; // 0x19a8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strBurrowEndSound; // 0x19b8            
            // metadata: MPropertyStartGroup "+Burrow Properties"
            float m_flChannelEndEnemyPopUpForce; // 0x19c8            
            float m_flChannelEndEnemyPopUpCylinderHeight; // 0x19cc            
            // metadata: MPropertyDescription "Spin Camera Controller that matches the modifier for client"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSpinStart; // 0x19d0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_BurrowVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_BurrowVData) == 0x1a58);
    };
};
