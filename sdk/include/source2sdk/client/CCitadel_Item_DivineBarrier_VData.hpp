...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_DivineBarrier_VData : public source2sdk::client::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_DivineBarrierModifier;
            char m_DivineBarrierModifier[0x10]; // 0x1678            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Item_DivineBarrier_VData) == 0x1768);
    };
};
