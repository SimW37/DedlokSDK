...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_UtilityUpgrade_HealthNova_VData : public source2sdk::client::CitadelItemVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_UtilityUpgrade_HealthNova_VData) == 0x1690);
    };
};
