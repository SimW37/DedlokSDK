...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecConnections[0x18]; // 0xa10            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            ...
            char m_vecConnectionDir[0x18]; // 0xa28            
            // metadata: MNetworkEnable
            Vector m_vTangentIn; // 0xa40            
            // metadata: MNetworkEnable
            Vector m_vTangentOut; // 0xa4c            
            // metadata: MNetworkEnable
            float m_flCumulativeDistance; // 0xa58            
            // metadata: MNetworkEnable
            std::int16_t m_iNodeIndex; // 0xa5c            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            std::int16_t m_eCaptureState; // 0xa5e            
            // metadata: MNetworkEnable
            std::int16_t m_iPrimaryLane; // 0xa60            
            // metadata: MNetworkEnable
            bool m_bUseBaseLaneColor; // 0xa62            
            uint8_t _pad0a63[0x1]; // 0xa63
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            std::int16_t m_nRopesParity; // 0xa64            
            // metadata: MNetworkEnable
            bool m_bCornerNode; // 0xa66            
            // metadata: MNetworkEnable
            bool m_bCapturable; // 0xa67            
            // metadata: MNetworkEnable
            bool m_bDisableZippingToByPlayers; // 0xa68            
            uint8_t _pad0a69[0x3]; // 0xa69
            // metadata: MNetworkEnable
            float m_flSpeedMultiplierToBaseBonus; // 0xa6c            
            // metadata: MNetworkEnable
            float m_flSpeedMultiplierFromBaseBonus; // 0xa70            
            ...
            char m_hGuardingBosses[0x18]; // 0xa78            
            // metadata: MNetworkEnable
            float m_flRopeRadius; // 0xa90            
        ...
        static_assert(sizeof(source2sdk::client::CCitadelZipLineNode) == 0xa98);
    };
};
