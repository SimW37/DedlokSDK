...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifierVandalOverflowVData : public source2sdk::client::CCitadel_Modifier_StunnedVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CModifierVandalOverflowVData) == 0x830);
    };
};
