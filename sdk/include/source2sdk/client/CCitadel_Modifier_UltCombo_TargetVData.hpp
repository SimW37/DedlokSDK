...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_UltCombo_TargetVData : public source2sdk::client::CCitadel_Modifier_StunnedVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_UltCombo_TargetVData) == 0x758);
    };
};
