...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_EnchantedHolsters_Watcher_VData : public source2sdk::client::CCitadel_Modifier_Intrinsic_BaseVData
        {
        public:
            ...
            CSoundEventName m_strRefreshStackSound; // 0x670            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_EnchantedHolsters_Watcher_VData) == 0x680);
    };
};
