...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_ResistReductionModifier[0x10]; // 0x16c0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strHitConfirmSound; // 0x16d0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemSilenceGlyphVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CItemSilenceGlyphVData) == 0x16e0);
    };
};
