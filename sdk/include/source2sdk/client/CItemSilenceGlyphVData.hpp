...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CItemSilenceGlyphVData : public source2sdk::client::CitadelItemVData
        {
        public:
            ...
            char m_ResistReductionModifier[0x10]; // 0x1688            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strHitConfirmSound; // 0x1698            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemSilenceGlyphVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CItemSilenceGlyphVData) == 0x16a8);
    };
};
