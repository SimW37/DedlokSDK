...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Fencer_RiposteVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            CSoundEventName m_strDashStart; // 0x19d8            
            CSoundEventName m_strStunImpactSound; // 0x19e8            
            CSoundEventName m_strAvoidDamage; // 0x19f8            
            CSoundEventName m_strStartParry; // 0x1a08            
            ...
            float m_flAirDrag; // 0x1a2c            
            float m_flFallSpeedMax; // 0x1a30            
            float m_flParryMoveSpeed; // 0x1a34            
            float m_flDashAnimDelay; // 0x1a38            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Fencer_RiposteVData) == 0x1a40);
    };
};
