...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SlowModifier[0x10]; // 0x658        
        ...
        char m_DebuffStatusPlayerParticle[0xe0]; // 0x668        
        ...
        char m_DebuffStatusVictimParticle[0xe0]; // 0x748        
        ...
        char m_DebuffStatusNPCParticle[0xe0]; // 0x828        
        ...
        char m_StackDamageParticle[0xe0]; // 0x908        
        ...
        char m_StackReadyParticle[0xe0]; // 0x9e8        
        ...
        char m_StackAppliedParticle[0xe0]; // 0xac8        
    ...
    static_assert(sizeof(CCitadel_Modifier_Mirage_SandPhantom_Passive_Victim_VData) == 0xbd8);
};
