...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_tCooldownStartTime; // 0x1bc8            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tCooldownEndTime; // 0x1bcc            
            // metadata: MNetworkEnable
            bool m_bIsHelperAvailableNet; // 0x1bd0            
            uint8_t _pad1bd1[0x7];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CNPC_FamiliarHelper because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CNPC_FamiliarHelper) == 0x1bd8);
    };
};
