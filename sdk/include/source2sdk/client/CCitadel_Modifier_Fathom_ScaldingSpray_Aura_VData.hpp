...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Fathom_ScaldingSpray_Aura_VData : public source2sdk::client::CCitadelModifierAura_ConeVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Fathom_ScaldingSpray_Aura_VData) == 0x7c8);
    };
};
