...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::DOFDesc_t m_DOFWhileZoomed; // 0x1618            
            ...
            bool m_bDOFFarSettingsAreOffsetByGunRange; // 0x1628            
            uint8_t _pad1629[0x7]; // 0x1629
            // metadata: MPropertyStartGroup "Sounds"
            // metadata: MPropertyFriendlyName "Fire while disarmed sound"
            CSoundEventName m_sDisarmedSound; // 0x1630            
            float m_flMinDisarmedSoundInterval; // 0x1640            
            uint8_t _pad1644[0x4]; // 0x1644
            CSoundEventName m_sObstructedShotSound; // 0x1648            
