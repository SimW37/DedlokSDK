...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            bool m_bHUDElementVisible; // 0xd88            
            uint8_t _pad0d89[0x13]; // 0xd89
            // metadata: MNetworkEnable
            float m_flBlastedCurrentDuration; // 0xd9c            
            uint8_t _pad0da0[0x340];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_PunkGoat_Blasted because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_PunkGoat_Blasted) == 0x10e0);
    };
};
