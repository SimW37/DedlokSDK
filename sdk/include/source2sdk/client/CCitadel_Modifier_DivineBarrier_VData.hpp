...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_DivineBarrier_VData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_TrailParticle[0xe0]; // 0x740            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_DivineBarrier_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_DivineBarrier_VData) == 0x820);
    };
};
