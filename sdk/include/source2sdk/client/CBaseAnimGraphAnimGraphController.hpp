...
namespace source2sdk::client
{
    ...
    public:
        ...
        // m_bHITGROUP_T2_BOSS_FRONT_LEFT_LEG_WEAKPOINT_Destroyed has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CAnimGraphParamOptionalRef<bool> m_bHITGROUP_T2_BOSS_FRONT_LEFT_LEG_WEAKPOINT_Destroyed;
        char m_bHITGROUP_T2_BOSS_FRONT_LEFT_LEG_WEAKPOINT_Destroyed[0x20]; // 0x268        
        // m_bHITGROUP_T2_BOSS_FRONT_RIGHT_LEG_WEAKPOINT_Destroyed has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CAnimGraphParamOptionalRef<bool> m_bHITGROUP_T2_BOSS_FRONT_RIGHT_LEG_WEAKPOINT_Destroyed;
        char m_bHITGROUP_T2_BOSS_FRONT_RIGHT_LEG_WEAKPOINT_Destroyed[0x20]; // 0x288        
        // m_bHITGROUP_T2_BOSS_REAR_LEFT_LEG_WEAKPOINT_Destroyed has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CAnimGraphParamOptionalRef<bool> m_bHITGROUP_T2_BOSS_REAR_LEFT_LEG_WEAKPOINT_Destroyed;
        char m_bHITGROUP_T2_BOSS_REAR_LEFT_LEG_WEAKPOINT_Destroyed[0x20]; // 0x2a8        
        // m_bHITGROUP_T2_BOSS_REAR_RIGHT_LEG_WEAKPOINT_Destroyed has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CAnimGraphParamOptionalRef<bool> m_bHITGROUP_T2_BOSS_REAR_RIGHT_LEG_WEAKPOINT_Destroyed;
        char m_bHITGROUP_T2_BOSS_REAR_RIGHT_LEG_WEAKPOINT_Destroyed[0x20]; // 0x2c8        
        // m_bHITGROUP_T2_BOSS_HEAD_WEAKPOINT_Destroyed has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CAnimGraphParamOptionalRef<bool> m_bHITGROUP_T2_BOSS_HEAD_WEAKPOINT_Destroyed;
        char m_bHITGROUP_T2_BOSS_HEAD_WEAKPOINT_Destroyed[0x20]; // 0x2e8        
        // m_bHITGROUP_T2_BOSS_BACK_WEAKPOINT_Destroyed has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CAnimGraphParamOptionalRef<bool> m_bHITGROUP_T2_BOSS_BACK_WEAKPOINT_Destroyed;
        char m_bHITGROUP_T2_BOSS_BACK_WEAKPOINT_Destroyed[0x20]; // 0x308        
        // m_bHITGROUP_DRONE_BOSS_DRONE_WEAKPOINT_Destroyed has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CAnimGraphParamOptionalRef<bool> m_bHITGROUP_DRONE_BOSS_DRONE_WEAKPOINT_Destroyed;
        char m_bHITGROUP_DRONE_BOSS_DRONE_WEAKPOINT_Destroyed[0x20]; // 0x328        
        // m_bHITGROUP_HEAD_NO_RESIST_Destroyed has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CAnimGraphParamOptionalRef<bool> m_bHITGROUP_HEAD_NO_RESIST_Destroyed;
        char m_bHITGROUP_HEAD_NO_RESIST_Destroyed[0x20]; // 0x348        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CBaseAnimGraphAnimGraphController because it is not a standard-layout class
    static_assert(sizeof(CBaseAnimGraphAnimGraphController) == 0x368);
};
