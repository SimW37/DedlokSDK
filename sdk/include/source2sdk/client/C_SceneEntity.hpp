...
namespace source2sdk::client
{
    ...
    public:
        ...
        bool m_bIsPlayingBack; // 0x5e8        
        // metadata: MNetworkEnable
        bool m_bPaused; // 0x5e9        
        // metadata: MNetworkEnable
        bool m_bMultiplayer; // 0x5ea        
        // metadata: MNetworkEnable
        bool m_bAutogenerated; // 0x5eb        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnResetClientTime"
        float m_flForceClientTime; // 0x5ec        
        // metadata: MNetworkEnable
        // metadata: MNetworkPriority "32"
        uint16_t m_nSceneStringIndex; // 0x5f0        
        bool m_bClientOnly; // 0x5f2        
        [[maybe_unused]] std::uint8_t pad_0x5f3[0x1]; // 0x5f3
        // m_hOwner has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CHandle<client::C_BaseFlex> m_hOwner;
        char m_hOwner[0x4]; // 0x5f4        
        // metadata: MNetworkEnable
        // metadata: MNetworkPriority "32"
        ...
        char m_hActorList[0x18]; // 0x5f8        
        bool m_bWasPlaying; // 0x610        
        [[maybe_unused]] std::uint8_t pad_0x611[0xf]; // 0x611
        ...
        char m_QueuedEvents[0x18]; // 0x620        
        float m_flCurrentTime; // 0x638        
    ...
    static_assert(sizeof(C_SceneEntity) == 0x640);
};
