...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Mirage_FireScarabs_WatcherVData : public client::CCitadel_Modifier_StatStealBaseVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_Mirage_FireScarabs_WatcherVData) == 0x690);
};
