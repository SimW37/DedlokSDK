...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Boho_DoubleHitVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            CSoundEventName m_strSlashSound; // 0x17e8            
            CSoundEventName m_strHitConfirmSound; // 0x17f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Boho_DoubleHitVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Boho_DoubleHitVData) == 0x1808);
    };
};
