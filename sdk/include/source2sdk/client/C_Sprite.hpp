...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hSpriteMaterial[0x8]; // 0x9a0            
            // metadata: MNetworkEnable
            ...
            char m_hAttachedToEntity[0x4]; // 0x9a8            
            // metadata: MNetworkEnable
            source2sdk::modellib::AttachmentHandle_t m_nAttachment; // 0x9ac            
            ...
            float m_flSpriteFramerate; // 0x9b0            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "20"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "256,000000"
            // metadata: MNetworkEncodeFlags "1"
            float m_flFrame; // 0x9b4            
            source2sdk::entity2::GameTime_t m_flDieTime; // 0x9b8            
            uint8_t _pad09bc[0xc]; // 0x9bc
            // metadata: MNetworkEnable
            std::uint32_t m_nBrightness; // 0x9c8            
            // metadata: MNetworkEnable
            float m_flBrightnessDuration; // 0x9cc            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnSpriteScaleChanged"
            float m_flSpriteScale; // 0x9d0            
            // metadata: MNetworkEnable
            float m_flScaleDuration; // 0x9d4            
            // metadata: MNetworkEnable
            bool m_bWorldSpaceScale; // 0x9d8            
            ...
            // metadata: MNetworkEncodeFlags "2"
            float m_flGlowProxySize; // 0x9dc            
            // metadata: MNetworkEnable
            float m_flHDRColorScale; // 0x9e0            
            source2sdk::entity2::GameTime_t m_flLastTime; // 0x9e4            
            float m_flMaxFrame; // 0x9e8            
            float m_flStartScale; // 0x9ec            
            float m_flDestScale; // 0x9f0            
            source2sdk::entity2::GameTime_t m_flScaleTimeStart; // 0x9f4            
            std::int32_t m_nStartBrightness; // 0x9f8            
            std::int32_t m_nDestBrightness; // 0x9fc            
            source2sdk::entity2::GameTime_t m_flBrightnessTimeStart; // 0xa00            
            uint8_t _pad0a04[0xc]; // 0xa04
            // metadata: MNotSaved
            std::int32_t m_nSpriteWidth; // 0xa10            
            // metadata: MNotSaved
            std::int32_t m_nSpriteHeight; // 0xa14            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_Sprite because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_Sprite) == 0xa18);
    };
};
