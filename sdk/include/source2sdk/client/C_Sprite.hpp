...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            source2sdk::modellib::AttachmentHandle_t m_nAttachment; // 0x9b4            
            ...
            source2sdk::entity2::GameTime_t m_flDieTime; // 0x9c0            
            uint8_t _pad09c4[0xc]; // 0x9c4
            // metadata: MNetworkEnable
            std::uint32_t m_nBrightness; // 0x9d0            
            // metadata: MNetworkEnable
            ...
            source2sdk::entity2::GameTime_t m_flLastTime; // 0x9ec            
            float m_flMaxFrame; // 0x9f0            
            float m_flStartScale; // 0x9f4            
            float m_flDestScale; // 0x9f8            
            source2sdk::entity2::GameTime_t m_flScaleTimeStart; // 0x9fc            
            std::int32_t m_nStartBrightness; // 0xa00            
            std::int32_t m_nDestBrightness; // 0xa04            
            source2sdk::entity2::GameTime_t m_flBrightnessTimeStart; // 0xa08            
            ...
            uint8_t _pad0a18[0x98]; // 0xa18
            std::int32_t m_nSpriteWidth; // 0xab0            
            std::int32_t m_nSpriteHeight; // 0xab4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_Sprite because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_Sprite) == 0xab8);
    };
};
