...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CItemSmokeBombPreCastModifierVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_SmokeAreaParticle[0xe0]; // 0x660            
            ...
            char m_CasterParticle[0xe0]; // 0x740            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemSmokeBombPreCastModifierVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CItemSmokeBombPreCastModifierVData) == 0x820);
    };
};
