...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_FervorParticle[0xe0]; // 0x658        
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_BonusesModifier;
        char m_BonusesModifier[0x10]; // 0x738        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Modifier_Fervor_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Modifier_Fervor_VData) == 0x748);
};
