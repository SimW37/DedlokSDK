...
namespace source2sdk::client
{
    ...
    public:
        ...
        uint32_t m_boneIndexAttached; // 0xd40        
        // metadata: MNetworkEnable
        uint32_t m_ragdollAttachedObjectIndex; // 0xd44        
        // metadata: MNetworkEnable
