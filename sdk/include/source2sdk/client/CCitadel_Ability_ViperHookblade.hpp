...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_vecOutgoingHitList[0x18]; // 0xc50        
        ...
        char m_vecReturningHitList[0x18]; // 0xc68        
        [[maybe_unused]] std::uint8_t pad_0xc80[0x1f8];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_ViperHookblade because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_ViperHookblade) == 0xe78);
};
