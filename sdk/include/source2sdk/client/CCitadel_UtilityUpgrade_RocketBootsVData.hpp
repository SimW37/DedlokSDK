...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_LaunchParticle[0xe0]; // 0x1680            
            ...
            char m_InAirWatcherModifier[0x10]; // 0x1760            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_UtilityUpgrade_RocketBootsVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_UtilityUpgrade_RocketBootsVData) == 0x1770);
    };
};
