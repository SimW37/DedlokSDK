...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tDeactivationTime; // 0xcc0            
            bool m_bDeactivated; // 0xcc4            
            uint8_t _pad0cc5[0x3]; // 0xcc5
