...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_SleepDagger_Drowsy_VData : public client::CCitadelModifierVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_SleepDagger_Drowsy_VData) == 0x670);
};
