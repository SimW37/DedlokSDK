...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_PoofInParticle[0xe0]; // 0x15e8            
            ...
            char m_PoofOutParticle[0xe0]; // 0x16c8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strMeow; // 0x17a8            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Nano_CatFormVData) == 0x17c8);
    };
};
