...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_PoofInParticle[0xe0]; // 0x1620            
            ...
            char m_PoofOutParticle[0xe0]; // 0x1700            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strMeow; // 0x17e0            
            CSoundEventName m_strCatFormMeleeSwing; // 0x17f0            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Nano_CatFormVData) == 0x1810);
    };
};
