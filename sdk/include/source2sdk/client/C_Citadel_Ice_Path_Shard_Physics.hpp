...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNotSaved
            source2sdk::client::ice_path_shard_model_desc_t m_ShardDesc; // 0x9a0            
            // metadata: MNetworkEnable
            QAngle m_qForward; // 0x9d8            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartTime; // 0x9e4            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flEndTime; // 0x9e8            
            // metadata: MNetworkEnable
            float m_flShardWidth; // 0x9ec            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_Citadel_Ice_Path_Shard_Physics because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_Citadel_Ice_Path_Shard_Physics) == 0x9f0);
    };
};
