...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_strAreaEffectEnemy[0xe0]; // 0x7b0            
            ...
            char m_strAreaEffectFriendly[0xe0]; // 0x890            
            ...
            char m_strAreaEffectSelf[0xe0]; // 0x970            
