...
namespace source2sdk::client
{
    ...
    public:
        ...
        int32_t m_nReductionsLeft; // 0xe04        
        [[maybe_unused]] std::uint8_t pad_0xe08[0x280]; // 0xe08
        entity2::GameTime_t m_flStuckTime; // 0x1088        
    ...
    static_assert(sizeof(CCitadel_Ability_ShivDash) == 0x1090);
};
