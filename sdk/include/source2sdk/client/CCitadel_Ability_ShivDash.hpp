...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_nReductionsLeft; // 0xdcc            
            uint8_t _pad0dd0[0x280]; // 0xdd0
            source2sdk::entity2::GameTime_t m_flStuckTime; // 0x1050            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ShivDash) == 0x1058);
    };
};
