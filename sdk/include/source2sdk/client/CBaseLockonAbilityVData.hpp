...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CBaseLockonAbilityVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_TargetModifier[0x10]; // 0x1618            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strApplyLockonStack; // 0x1628            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CBaseLockonAbilityVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CBaseLockonAbilityVData) == 0x1638);
    };
};
