...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Galvanic_Storm_VData : public source2sdk::client::CCitadel_Modifier_ChainLightningVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_TechShieldModifier;
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Galvanic_Storm_VData) == 0x890);
    };
};
