...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            uint8_t _pad00c0[0x70]; // 0xc0
            source2sdk::client::CCitadel_Ability_Frank_ShockTarget* pShockTarget; // 0x130            
            source2sdk::client::ParticleIndex_t m_nStoredDamageFXIndex; // 0x138            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Frank_StoredDamageWatcher) == 0x140);
    };
};
