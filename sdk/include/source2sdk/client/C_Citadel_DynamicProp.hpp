...
namespace source2sdk::client
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xf78[0x10]; // 0xf78
        int32_t m_nPlayerTeamEvent; // 0xf88        
        ...
        [[maybe_unused]] std::uint8_t pad_0xfa9[0x7];
    ...
    static_assert(sizeof(C_Citadel_DynamicProp) == 0xfb0);
};
