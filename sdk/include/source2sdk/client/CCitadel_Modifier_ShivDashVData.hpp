...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_ShivDashVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_DashParticle[0xe0]; // 0x660            
            ...
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_DashEchoParticle;
            char m_DashEchoParticle[0xe0]; // 0x740            
            ...
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_DashTrailParticle;
            char m_DashTrailParticle[0xe0]; // 0x820            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_ShivDashVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_ShivDashVData) == 0x900);
    };
};
