...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_strAttackBuffParticle[0xe0]; // 0x658        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_TetherSound; // 0x738        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Modifier_TangoTether_TetherReceiverVData) == 0x748);
};
