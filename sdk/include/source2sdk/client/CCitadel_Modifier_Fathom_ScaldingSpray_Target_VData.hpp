...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Fathom_ScaldingSpray_Target_VData : public client::CCitadelModifierVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_Fathom_ScaldingSpray_Target_VData) == 0x740);
};
