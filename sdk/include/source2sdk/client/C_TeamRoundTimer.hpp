...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_TeamRoundTimer : public source2sdk::client::C_BaseEntity
        {
        public:
            ...
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flTimerEndTime; // 0x5e8            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nTimerLength; // 0x5f0            
            // metadata: MNetworkEnable
            std::int32_t m_nTimerInitialLength; // 0x5f4            
            // metadata: MNetworkEnable
            std::int32_t m_nTimerMaxLength; // 0x5f8            
            // metadata: MNetworkEnable
            bool m_bAutoCountdown; // 0x5fc            
            uint8_t _pad05fd[0x3]; // 0x5fd
            // metadata: MNetworkEnable
            std::int32_t m_nSetupTimeLength; // 0x600            
            // metadata: MNetworkEnable
            std::int32_t m_nState; // 0x604            
            // metadata: MNetworkEnable
            ...
            std::int32_t m_nOldTimerLength; // 0x620            
            std::int32_t m_nOldTimerState; // 0x624            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_TeamRoundTimer because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_TeamRoundTimer) == 0x628);
    };
};
