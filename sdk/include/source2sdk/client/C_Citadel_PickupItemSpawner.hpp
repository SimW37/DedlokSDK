...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_tNextDropTime; // 0xca8            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnPowerupActiveChanged"
            bool m_bPowerupActive; // 0xcac            
        ...
        static_assert(sizeof(source2sdk::client::C_Citadel_PickupItemSpawner) == 0xcb0);
    };
};
