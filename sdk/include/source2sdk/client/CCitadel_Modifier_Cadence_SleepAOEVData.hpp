...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Cadence_SleepAOEVData : public source2sdk::client::CCitadelModifierAuraVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Cadence_SleepAOEVData) == 0x890);
    };
};
