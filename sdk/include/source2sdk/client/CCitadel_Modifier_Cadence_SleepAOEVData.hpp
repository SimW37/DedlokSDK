...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Cadence_SleepAOEVData : public client::CCitadelModifierAuraVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_Cadence_SleepAOEVData) == 0x780);
};
