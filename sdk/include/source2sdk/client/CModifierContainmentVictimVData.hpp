...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_AreaParticle[0xe0]; // 0x658        
        ...
        char m_ChainedParticle[0xe0]; // 0x738        
