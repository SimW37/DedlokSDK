...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_CrushingFistsWatcher_VData : public client::CCitadel_Modifier_Intrinsic_BaseVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_StackingDebuffModifier;
