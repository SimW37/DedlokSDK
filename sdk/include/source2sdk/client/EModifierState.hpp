...
namespace source2sdk::client
{
    ...
    enum class EModifierState : std::uint32_t
    {
        ...
        MODIFIER_STATE_PICKING_UP_IDOL = 0x84,
        ...
        MODIFIER_STATE_ALLOW_MELEE_WHEN_CHANNELING = 0x99,
        MODIFIER_STATE_ALLOW_DASH_WHEN_CHANNELING = 0x9a,
        MODIFIER_STATE_CAN_ACTIVE_RELOAD = 0x9b,
        MODIFIER_STATE_DIGGER_BURROW_CHANNEL = 0x9c,
        MODIFIER_STATE_DIGGER_SPIN = 0x9d,
        MODIFIER_STATE_NEAR_REJUVINATOR = 0x9e,
        MODIFIER_STATE_NEAR_PUNCHABLE_ITEM = 0x9f,
        MODIFIER_STATE_IN_TIER3_PHASE2_BOSS_PIT = 0xa0,
        MODIFIER_STATE_TAKES_FULLDAMAGE_NO_FALLOFF = 0xa1,
        MODIFIER_STATE_PREDATORY_STATUE_TARGET = 0xa2,
        MODIFIER_STATE_FOOTSTEP_SOUNDS_DISABLE = 0xa3,
        MODIFIER_STATE_MOVEMENT_FOLEY_SOUNDS_DISABLE = 0xa4,
        MODIFIER_STATE_DO_NOT_DRAW_MODEL = 0xa5,
        MODIFIER_STATE_SHIV_FRENZIED = 0xa6,
        MODIFIER_STATE_FORCE_ANIM_DUCK = 0xa7,
        MODIFIER_STATE_FORCE_ANIM_KEEP_STILL = 0xa8,
        MODIFIER_STATE_SIPHON_BULLET_LOSS = 0xa9,
        MODIFIER_STATE_APPLY_FOV_MOUSE_SENSITIVITY_SCALE = 0xaa,
        MODIFIER_STATE_NEAR_CLIMBABLE_ROPE = 0xab,
        MODIFIER_STATE_IS_CLIMBING_ROPE = 0xac,
        MODIFIER_STATE_FORCE_CAN_PARRY = 0xad,
        MODIFIER_STATE_IS_MAGIC_SHOCK_IMMUNE = 0xae,
        MODIFIER_STATE_IN_SLIDE_CHARGED_MELEE_ATTACK = 0xaf,
        MODIFIER_STATE_FORCE_GROUND_JUMP = 0xb0,
        MODIFIER_STATE_FROZEN = 0xb1,
        MODIFIER_STATE_ASSASSINATE_LOWHEALTH_TARGET = 0xb2,
        MODIFIER_STATE_TELEPORTER_DISABLED = 0xb3,
        MODIFIER_STATE_IN_SMALL_INTERIOR_SPACE = 0xb4,
        MODIFIER_STATE_IN_MEDIUM_INTERIOR_SPACE = 0xb5,
        MODIFIER_STATE_ENABLE_CLOAK_DESAT = 0xb6,
        MODIFIER_STATE_NANO_RECENT_DAMAGE = 0xb7,
        MODIFIER_STATE_DISABLE_INATTACK2_DESELECT = 0xb8,
        MODIFIER_STATE_FATHOM_DO_NOT_REQUIRE_STAND_STILL_FOR_INVIS = 0xb9,
        MODIFIER_STATE_PULLDOWN_TO_GROUND = 0xba,
        MODIFIER_STATE_IN_SELF_BUBBLE = 0xbb,
        MODIFIER_STATE_GUNSLINGER_MARK = 0xbc,
        MODIFIER_STATE_GHOST_LIFEDRAINED = 0xbd,
        MODIFIER_STATE_INVISIBLE_ON_MINIMAP = 0xbe,
        MODIFIER_STATE_ULTING = 0xbf,
        MODIFIER_STATE_VIPER_VENOM = 0xc0,
        MODIFIER_STATE_MAGICIAN_ULT = 0xc1,
        MODIFIER_STATE_ANIM_ON_GROUND = 0xc2,
        MODIFIER_STATE_ABILITY_MOVEMENT = 0xc3,
        MODIFIER_STATE_ABILITY_MOVEMENT_DEBUFF = 0xc4,
        // MPropertySuppressEnumerator
        MODIFIER_STATE_COUNT = 0xc5,
        // MPropertySuppressEnumerator
