...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_SlowingBullets_ProcVData : public source2sdk::client::CCitadel_Modifier_BaseEventProcVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_SlowingBullets_ProcVData) == 0x6b0);
    };
};
