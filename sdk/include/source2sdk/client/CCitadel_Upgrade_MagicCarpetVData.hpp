...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_SummonParticle[0xe0]; // 0x1678            
            ...
            char m_FlyingCarpetModifier[0x10]; // 0x1758            
            ...
            char m_SummonFlyingCarpetModifier[0x10]; // 0x1768            
            ...
            char m_SummonFlyingCarpetVisualModifier[0x10]; // 0x1778            
            ...
            char m_FlyingCarpetVisualModifier[0x10]; // 0x1788            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flSummonVisualDuration; // 0x1798            
            float m_flBurstSpeedBonus; // 0x179c            
            float m_flBurstSpeedMin; // 0x17a0            
            float m_flBurstSpeedDuration; // 0x17a4            
            float m_flMinDistanceAboveGround; // 0x17a8            
            uint8_t _pad17ac[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Upgrade_MagicCarpetVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Upgrade_MagicCarpetVData) == 0x17b0);
    };
};
