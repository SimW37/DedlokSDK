...
namespace source2sdk::client
{
    ...
    static_assert(offsetof(HealingReceivedSounds_t, m_strHealingInBaseStart) == 0x0);
    static_assert(offsetof(HealingReceivedSounds_t, m_strHealingInBaseLoop) == 0x10);
    static_assert(offsetof(HealingReceivedSounds_t, m_strHealingInBaseToppedOff) == 0x20);
    static_assert(offsetof(HealingReceivedSounds_t, m_strDirectHealing) == 0x30);
    
    static_assert(sizeof(HealingReceivedSounds_t) == 0x40);
};
