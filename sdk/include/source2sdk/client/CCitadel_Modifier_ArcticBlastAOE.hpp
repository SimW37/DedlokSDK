...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CCitadel_Modifier_ArcticBlastAOE : public client::CCitadelModifier
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xc0[0x200]; // 0xc0
        client::ParticleIndex_t m_hAOEEffect; // 0x2c0        
    ...
    static_assert(sizeof(CCitadel_Modifier_ArcticBlastAOE) == 0x2c8);
};
