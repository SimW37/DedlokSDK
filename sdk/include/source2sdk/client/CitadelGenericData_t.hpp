...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_HeroTestingTargetDummyUpgrades[0x18]; // 0x880            
            uint8_t _pad0898[0x50]; // 0x898
            source2sdk::client::DOFDesc_t m_DefaultDOF; // 0x8e8            
            source2sdk::client::RejuvinatorParams_t m_RejuvParams; // 0x8f8            
            source2sdk::client::IdolParams_t m_IdolParams; // 0x958            
            source2sdk::client::TeleporterParams_t m_TeleporterParams; // 0xeb0            
            source2sdk::client::ObjectivesParams_t m_ObjectiveParams; // 0x10a0            
            ...
            char m_mapResourceTypes[0x28]; // 0x1118            
            ...
            char m_vecWeaponGroups[0x18]; // 0x1140            
            ...
            char m_vecArmorGroups[0x18]; // 0x1158            
            ...
            char m_vecSpiritGroups[0x18]; // 0x1170            
            // metadata: MPropertyStartGroup "Street Brawl"
            source2sdk::client::GameModeStreetBrawl_t m_StreetBrawl; // 0x1188            
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_HeroTestingTargetDummyUpgrades) == 0x880);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_DefaultDOF) == 0x8e8);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_RejuvParams) == 0x8f8);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_IdolParams) == 0x958);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_TeleporterParams) == 0xeb0);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_ObjectiveParams) == 0x10a0);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_mapStatTypeImages) == 0x10d0);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_AimSpringStrength) == 0x10f8);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_TargetingSpringStrength) == 0x1108);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_mapResourceTypes) == 0x1118);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_vecWeaponGroups) == 0x1140);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_vecArmorGroups) == 0x1158);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_vecSpiritGroups) == 0x1170);
        static_assert(offsetof(source2sdk::client::CitadelGenericData_t, m_StreetBrawl) == 0x1188);
        
        static_assert(sizeof(source2sdk::client::CitadelGenericData_t) == 0x13a8);
    };
};
