...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::DamageReceivedSounds_t m_DamageReceivedSounds; // 0x80        
        client::HealingReceivedSounds_t m_HealingReceivedSounds; // 0xe0        
        client::DamageIndicatorSounds_t m_DamageIndicatorSounds; // 0x120        
        ...
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_MidbossIndicatorRespawningParticle;
        ...
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_MidbossIndicatorSpawnedParticle;
        ...
        // CUtlVector<client::MinimapOffsetDesc_t> m_MiniMapOffsets;
        char m_MiniMapOffsets[0x18]; // 0x5f8        
        // metadata: MPropertyStartGroup
        client::LaneDesc_t m_LaneInfo[6]; // 0x610        
        client::LaneDesc_t m_NoLaneZip; // 0x6d0        
        Color m_enemyZiplineColor; // 0x6f0        
        Color m_enemyObjectivesColor; // 0x6f4        
        client::NewPlayerMetrics_t m_NewPlayerMetrics[4]; // 0x6f8        
        int32_t m_nItemPricePerTier[6]; // 0x7b8        
        ...
        [[maybe_unused]] std::uint8_t pad_0x818[0x58]; // 0x818
        client::DOFDesc_t m_DefaultDOF; // 0x870        
        client::RejuvinatorParams_t m_RejuvParams; // 0x880        
        client::IdolParams_t m_IdolParams; // 0x8d8        
        client::TeleporterParams_t m_TeleporterParams; // 0xe30        
        client::ObjectivesParams_t m_ObjectiveParams; // 0x1020        
        [[maybe_unused]] std::uint8_t pad_0x104c[0x4]; // 0x104c
        ...
        client::CRemapFloat m_AimSpringStrength; // 0x1078        
        // metadata: MPropertyDescription "Remap camera angle delta to ability targeting spring strength"
        client::CRemapFloat m_TargetingSpringStrength; // 0x1088        
        ...
        // CUtlVector<client::ShopGroups_t> m_vecWeaponGroups;
        ...
        // CUtlVector<client::ShopGroups_t> m_vecArmorGroups;
        ...
        // CUtlVector<client::ShopGroups_t> m_vecSpiritGroups;
    ...
    static_assert(offsetof(CitadelGenericData_t, m_DamageReceivedSounds) == 0x80);
    static_assert(offsetof(CitadelGenericData_t, m_HealingReceivedSounds) == 0xe0);
    static_assert(offsetof(CitadelGenericData_t, m_DamageIndicatorSounds) == 0x120);
    static_assert(offsetof(CitadelGenericData_t, m_strExitCombatSound) == 0x180);
    static_assert(offsetof(CitadelGenericData_t, m_ShoppingEffect) == 0x190);
    static_assert(offsetof(CitadelGenericData_t, m_MinimapZiplinesParticle) == 0x270);
    static_assert(offsetof(CitadelGenericData_t, m_KillStreakFireParticle) == 0x350);
    static_assert(offsetof(CitadelGenericData_t, m_MidbossIndicatorRespawningParticle) == 0x430);
    static_assert(offsetof(CitadelGenericData_t, m_MidbossIndicatorSpawnedParticle) == 0x510);
    static_assert(offsetof(CitadelGenericData_t, m_MinimapTeamRebelsColor) == 0x5f0);
    static_assert(offsetof(CitadelGenericData_t, m_MinimapTeamCombineColor) == 0x5f4);
    static_assert(offsetof(CitadelGenericData_t, m_MiniMapOffsets) == 0x5f8);
    static_assert(offsetof(CitadelGenericData_t, m_LaneInfo) == 0x610);
    static_assert(offsetof(CitadelGenericData_t, m_NoLaneZip) == 0x6d0);
    static_assert(offsetof(CitadelGenericData_t, m_enemyZiplineColor) == 0x6f0);
    static_assert(offsetof(CitadelGenericData_t, m_enemyObjectivesColor) == 0x6f4);
    static_assert(offsetof(CitadelGenericData_t, m_NewPlayerMetrics) == 0x6f8);
    static_assert(offsetof(CitadelGenericData_t, m_nItemPricePerTier) == 0x7b8);
    static_assert(offsetof(CitadelGenericData_t, m_flLanePhaseGoldShareFrac) == 0x7d0);
    static_assert(offsetof(CitadelGenericData_t, m_flPostLanePhaseGoldShareFrac) == 0x7e8);
    static_assert(offsetof(CitadelGenericData_t, m_HeroTestingTargetDummyUpgrades) == 0x800);
    static_assert(offsetof(CitadelGenericData_t, m_DefaultDOF) == 0x870);
    static_assert(offsetof(CitadelGenericData_t, m_RejuvParams) == 0x880);
    static_assert(offsetof(CitadelGenericData_t, m_IdolParams) == 0x8d8);
    static_assert(offsetof(CitadelGenericData_t, m_TeleporterParams) == 0xe30);
    static_assert(offsetof(CitadelGenericData_t, m_ObjectiveParams) == 0x1020);
    static_assert(offsetof(CitadelGenericData_t, m_mapStatTypeImages) == 0x1050);
    static_assert(offsetof(CitadelGenericData_t, m_AimSpringStrength) == 0x1078);
    static_assert(offsetof(CitadelGenericData_t, m_TargetingSpringStrength) == 0x1088);
    static_assert(offsetof(CitadelGenericData_t, m_mapResourceTypes) == 0x1098);
    static_assert(offsetof(CitadelGenericData_t, m_vecWeaponGroups) == 0x10c0);
    static_assert(offsetof(CitadelGenericData_t, m_vecArmorGroups) == 0x10d8);
    static_assert(offsetof(CitadelGenericData_t, m_vecSpiritGroups) == 0x10f0);
    
    static_assert(sizeof(CitadelGenericData_t) == 0x1108);
};
