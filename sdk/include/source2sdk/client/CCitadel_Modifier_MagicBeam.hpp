...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CCitadel_Modifier_MagicBeam : public client::CCitadelModifier
    {
    public:
        // m_hBlocker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CHandle<client::C_Citadel_Magic_Beam_Blocker> m_hBlocker;
    ...
    static_assert(sizeof(CCitadel_Modifier_MagicBeam) == 0x1e8);
};
