...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Citadel_Bull_Leap_LandingBonuses_VData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CModifier_Citadel_Bull_Leap_LandingBonuses_VData) == 0x740);
    };
};
