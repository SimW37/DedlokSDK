...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Viper_PetrifyBolaVData : public client::CitadelAbilityVData
    {
    public:
        ...
        char m_PetrifyModifier[0x10]; // 0x16b8        
    ...
    static_assert(sizeof(CCitadel_Ability_Viper_PetrifyBolaVData) == 0x16d8);
};
