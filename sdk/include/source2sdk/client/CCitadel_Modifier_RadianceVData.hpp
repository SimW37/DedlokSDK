...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_RadianceFxParticle[0xe0]; // 0x658        
        ...
        char m_RadianceDamageParticle[0xe0]; // 0x738        
        ...
        char m_ClientsideDamageParticle[0xe0]; // 0x818        
    ...
    static_assert(sizeof(CCitadel_Modifier_RadianceVData) == 0x908);
};
