...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifierChargedTackleActiveVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_TackleParticle[0xe0]; // 0x660            
            ...
            char m_PullEnemiesParticle[0xe0]; // 0x740            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifierChargedTackleActiveVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CModifierChargedTackleActiveVData) == 0x820);
    };
};
