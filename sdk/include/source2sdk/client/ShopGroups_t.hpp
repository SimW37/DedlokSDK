...
namespace source2sdk::client
{
    ...
    {
    public:
        client::EShopGroups m_eShopGroup; // 0x0        
    ...
    static_assert(offsetof(ShopGroups_t, m_eShopGroup) == 0x0);
    static_assert(offsetof(ShopGroups_t, m_vecUpgrades) == 0x8);
    
    static_assert(sizeof(ShopGroups_t) == 0x20);
};
