...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flLightAttackMaxHoldTime; // 0x1624            
            ...
            float m_flSideDashDodgeDist; // 0x1628            
            ...
            float m_flBackDashDodgeDist; // 0x162c            
            source2sdk::client::TakeDamageFlags_t m_MeleeDamageFlags; // 0x1630            
            CUtlString m_strEffectsAttachName; // 0x1638            
            // metadata: MPropertyStartGroup "AnimGraph2"
            float m_flChargeAnimDelayTime; // 0x1640            
            uint8_t _pad1644[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityMeleeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityMeleeVData) == 0x1648);
    };
};
