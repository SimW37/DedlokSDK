...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifierVacuumAuraVData : public source2sdk::client::CCitadelModifierAuraVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CModifierVacuumAuraVData) == 0x960);
    };
};
