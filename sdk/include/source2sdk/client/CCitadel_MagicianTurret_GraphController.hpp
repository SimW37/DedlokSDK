...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CCitadel_MagicianTurret_GraphController : public client::CBaseAnimGraphAnimGraphController
    {
    public:
    ...
    // Cannot assert offsets of fields in CCitadel_MagicianTurret_GraphController because it is not a standard-layout class
    static_assert(sizeof(CCitadel_MagicianTurret_GraphController) == 0x3a8);
};
