...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_SilenceProc_DebuffVData : public client::CCitadelModifierVData
    {
    public:
