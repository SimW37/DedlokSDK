...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Gunslinger_DemonMarkVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Gunslinger_DemonMarkVData) == 0x1628);
    };
};
