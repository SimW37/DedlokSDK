...
namespace source2sdk::client
{
    ...
    {
    public:
        entity2::GameTime_t m_flTouchDelta; // 0xe60        
        entity2::GameTime_t m_fDeathTime; // 0xe64        
        Vector m_vecDamagePosition; // 0xe68        
        Vector m_vecDamageDirection; // 0xe74        
        client::DamageTypes_t m_nDamageType; // 0xe80        
    ...
    static_assert(sizeof(C_PhysPropClientside) == 0xe88);
};
