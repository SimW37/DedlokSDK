...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_ProjectMindVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_ShieldModifier[0x10]; // 0x9e0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_ProjectMindVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_ProjectMindVData) == 0x9f0);
    };
};
