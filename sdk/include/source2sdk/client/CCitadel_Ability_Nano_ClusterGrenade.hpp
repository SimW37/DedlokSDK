...
namespace source2sdk::client
{
    ...
    public:
        ...
        entity2::GameTime_t m_flNextProjectileTime; // 0xdd8        
        [[maybe_unused]] std::uint8_t pad_0xddc[0x2c4];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Nano_ClusterGrenade because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Nano_ClusterGrenade) == 0x10a0);
};
