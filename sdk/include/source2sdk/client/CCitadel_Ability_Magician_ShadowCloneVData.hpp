...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Magician_ShadowCloneVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_CloneModifier[0x10]; // 0x15e8            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Magician_ShadowCloneVData) == 0x16d8);
    };
};
