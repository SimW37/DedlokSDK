...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Magician_ShadowCloneVData : public client::CitadelAbilityVData
    {
    public:
        ...
        char m_CloneModifier[0x10]; // 0x15c8        
    ...
    static_assert(sizeof(CCitadel_Ability_Magician_ShadowCloneVData) == 0x16b8);
};
