...
namespace source2sdk::client
{
    ...
    {
    public:
        client::ParticleIndex_t m_nActiveFX; // 0xc50        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flParryStartTime; // 0xc54        
        // metadata: MNetworkEnable
        bool m_bAttackParried; // 0xc58        
        [[maybe_unused]] std::uint8_t pad_0xc59[0x3]; // 0xc59
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flParrySuccessTime; // 0xc5c        
    ...
    static_assert(sizeof(CCitadel_Ability_MeleeParry) == 0xcd0);
};
