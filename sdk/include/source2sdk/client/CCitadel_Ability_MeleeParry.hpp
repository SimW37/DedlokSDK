...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nActiveFX; // 0xdc0            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flParryStartTime; // 0xdc4            
            // metadata: MNetworkEnable
            bool m_bAttackParried; // 0xdc8            
            uint8_t _pad0dc9[0x3]; // 0xdc9
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flParrySuccessTime; // 0xdcc            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_MeleeParry) == 0xe50);
    };
};
