...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Gunslinger_WallStunVData : public client::CCitadelModifierVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_StunModifier;
        char m_StunModifier[0x10]; // 0x740        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_CasterMarkTriggerSound; // 0x750        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Modifier_Gunslinger_WallStunVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Modifier_Gunslinger_WallStunVData) == 0x760);
};
