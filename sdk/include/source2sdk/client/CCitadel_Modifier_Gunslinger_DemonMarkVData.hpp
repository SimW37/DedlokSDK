...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Gunslinger_DemonMarkVData : public client::CCitadelModifierVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_Gunslinger_DemonMarkVData) == 0x780);
};
