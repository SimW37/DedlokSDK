...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Gunslinger_DemonMarkVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            CSoundEventName m_CasterMarkTriggerSound; // 0x760            
            CSoundEventName m_VictimMarkTriggerSound; // 0x770            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_Gunslinger_DemonMarkVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Gunslinger_DemonMarkVData) == 0x780);
    };
};
