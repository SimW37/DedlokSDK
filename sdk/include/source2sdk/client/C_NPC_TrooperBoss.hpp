...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CCitadelPlayerClipComponent m_CCitadelPlayerClipComponent; // 0x1470        
        [[maybe_unused]] std::uint8_t pad_0x1490[0xc]; // 0x1490
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(C_NPC_TrooperBoss) == 0x14a8);
};
