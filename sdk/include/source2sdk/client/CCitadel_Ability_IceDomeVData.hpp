...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_IceDomeVData : public client::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_IceDomeModifier;
    ...
    static_assert(sizeof(CCitadel_Ability_IceDomeVData) == 0x1600);
};
