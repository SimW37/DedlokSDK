...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CModifier_Operative_Revelation_Caster_VData : public client::CCitadelModifierVData
    {
    public:
    ...
    static_assert(sizeof(CModifier_Operative_Revelation_Caster_VData) == 0x750);
};
