...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_ZapModifier[0x10]; // 0x1620            
            ...
            CSoundEventName m_strHitSound; // 0x1640            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strProjectileLoopingSound; // 0x1650            
