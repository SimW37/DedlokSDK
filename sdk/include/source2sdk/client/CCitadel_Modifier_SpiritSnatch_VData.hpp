...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_SpiritSnatch_VData : public source2sdk::client::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            char m_SwingParticle[0xe0]; // 0x6b0            
