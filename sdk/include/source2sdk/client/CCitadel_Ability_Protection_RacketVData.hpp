...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_CastOtherParticle[0xe0]; // 0x15c8        
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_ArmorModifier;
        char m_ArmorModifier[0x10]; // 0x16a8        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Protection_RacketVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Protection_RacketVData) == 0x16b8);
};
