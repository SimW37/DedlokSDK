...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Digger_MudShieldVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_BuffParticle[0xe0]; // 0x750            
            ...
            char m_ExplosionParticle[0xe0]; // 0x830            
            // m_ImpactParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ImpactParticle;
            char m_ImpactParticle[0xe0]; // 0x910            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_ExplodeSound; // 0x9f0            
            CSoundEventName m_ImpactSound; // 0xa00            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_Digger_MudShieldVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Digger_MudShieldVData) == 0xa10);
    };
};
