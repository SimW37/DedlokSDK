...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Digger_MudShieldVData : public client::CCitadelModifierVData
    {
    public:
        ...
        char m_ImpactParticle[0xe0]; // 0x818        
    ...
    static_assert(sizeof(CCitadel_Modifier_Digger_MudShieldVData) == 0x918);
};
