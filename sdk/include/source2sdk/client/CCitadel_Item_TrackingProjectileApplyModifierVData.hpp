...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ProjectileImpactParticle[0xe0]; // 0x1610        
        ...
        char m_FriendlyOnlyModifier[0x10]; // 0x1700        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Item_TrackingProjectileApplyModifierVData) == 0x1710);
};
