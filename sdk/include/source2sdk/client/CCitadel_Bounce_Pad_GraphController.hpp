...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CCitadel_Bounce_Pad_GraphController : public client::CBaseAnimGraphAnimGraphController
    {
    public:
