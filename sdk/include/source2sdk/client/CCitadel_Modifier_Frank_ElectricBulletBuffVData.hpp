...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Frank_ElectricBulletBuffVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_ElectricBulletImpactParticle[0xe0]; // 0x760            
            ...
            char m_ElectricBulletTracerParticle[0xe0]; // 0x840            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strElectricBulletHitSound; // 0x920            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_Frank_ElectricBulletBuffVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Frank_ElectricBulletBuffVData) == 0x930);
    };
};
