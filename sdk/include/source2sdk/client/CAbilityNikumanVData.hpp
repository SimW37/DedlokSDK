...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbilityNikumanVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_NikumanModifier;
            char m_NikumanModifier[0x10]; // 0x16c8            
            ...
            char m_SelfBuffModifier[0x10]; // 0x16d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityNikumanVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityNikumanVData) == 0x16e8);
    };
};
