...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_flAmmoFraction[0x18]; // 0x2d0        
        ...
        char m_flLookPitchRelativeToEyes[0x18]; // 0x2e8        
        ...
        char m_flSlideSurfacePitch[0x18]; // 0x300        
