...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_BlitzModifier[0x10]; // 0x1818            
            ...
            char m_TechAmpModifier[0x10]; // 0x1828            
            ...
            char m_SlowParticle[0xe0]; // 0x1838            
        ...
        static_assert(sizeof(source2sdk::client::CAbility_Synth_Blitz_VData) == 0x1928);
    };
};
