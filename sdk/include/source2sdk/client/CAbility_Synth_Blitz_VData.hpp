...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbility_Synth_Blitz_VData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_BlitzModifier;
            char m_BlitzModifier[0x10]; // 0x15f0            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_TechAmpModifier;
            char m_TechAmpModifier[0x10]; // 0x1600            
            ...
            char m_SlowParticle[0xe0]; // 0x1610            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strProcSound; // 0x16f0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Synth_Blitz_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbility_Synth_Blitz_VData) == 0x1700);
    };
};
