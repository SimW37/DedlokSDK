...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BlitzModifier[0x10]; // 0x15c8        
        ...
        char m_TechAmpModifier[0x10]; // 0x15d8        
        ...
        char m_SlowParticle[0xe0]; // 0x15e8        
    ...
    static_assert(sizeof(CAbility_Synth_Blitz_VData) == 0x16d8);
};
