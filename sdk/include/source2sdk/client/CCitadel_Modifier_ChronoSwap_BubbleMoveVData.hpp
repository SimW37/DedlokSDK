...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BeamParticle[0xe0]; // 0x658        
        ...
        char m_HealParticle[0xe0]; // 0x738        
        ...
        char m_DamageParticle[0xe0]; // 0x818        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Modifier_ChronoSwap_BubbleMoveVData) == 0x8f8);
};
