...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_HealParticle[0xe0]; // 0x740            
            ...
            char m_DamageParticle[0xe0]; // 0x820            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_ChronoSwap_BubbleMoveVData) == 0x900);
    };
};
