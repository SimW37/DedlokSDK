...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_StompParticle[0xe0]; // 0x1620            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strStompExplosionSound; // 0x1700            
            ...
            char m_BarbedWireAuraModifier[0x10]; // 0x1720            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityThumper2VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityThumper2VData) == 0x1730);
    };
};
