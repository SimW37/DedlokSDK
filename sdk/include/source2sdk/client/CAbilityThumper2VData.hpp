...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_BarbedWireAuraModifier[0x10]; // 0x1718            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityThumper2VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityThumper2VData) == 0x1728);
    };
};
