...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbilityThumper2VData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_StompParticle[0xe0]; // 0x15e8            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strStompExplosionSound; // 0x16c8            
            // metadata: MPropertyGroupName "Modifiers"
            // m_BuffModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_BuffModifier;
            char m_BuffModifier[0x10]; // 0x16d8            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_BarbedWireAuraModifier;
            char m_BarbedWireAuraModifier[0x10]; // 0x16e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityThumper2VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityThumper2VData) == 0x16f8);
    };
};
