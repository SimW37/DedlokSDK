...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Upgrade_OverdriveClip_VData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_BuffEffect;
            char m_BuffEffect[0xe0]; // 0x660            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Upgrade_OverdriveClip_VData) == 0x820);
    };
};
