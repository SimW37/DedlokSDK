...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CItemAOERootVData : public source2sdk::client::CitadelItemVData
        {
        public:
            ...
            char m_AOEParticle[0xe0]; // 0x16b0            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strRootTargetSound; // 0x1790            
            ...
            char m_TargetModifier[0x10]; // 0x17a0            
            ...
            char m_TetherModifier[0x10]; // 0x17b0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemAOERootVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CItemAOERootVData) == 0x17c0);
    };
};
