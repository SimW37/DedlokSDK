...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_AOEParticle[0xe0]; // 0x1678            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strRootTargetSound; // 0x1758            
            ...
            char m_TargetModifier[0x10]; // 0x1768            
            ...
            char m_TetherModifier[0x10]; // 0x1778            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemAOERootVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CItemAOERootVData) == 0x1788);
    };
};
