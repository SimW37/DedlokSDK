...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Priest_AntiSpiritVestVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_ProcParticle[0xe0]; // 0x1618            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_ShieldBreakModifier;
            char m_ShieldBreakModifier[0x10]; // 0x1708            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Priest_AntiSpiritVestVData) == 0x1728);
    };
};
