...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hFamiliar[0x4]; // 0x1990            
            uint8_t _pad1994[0x4];
            
            // Datamap fields:
            // CCitadelFamiliarClone_MovementServices m_pMovementServices; // 0xf20
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadelFamiliarClonePlayerPawn because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadelFamiliarClonePlayerPawn) == 0x1998);
    };
};
