...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_PreExplodeParticle[0xe0]; // 0x1620            
            ...
            char m_nDeathMarkParticle[0xe0]; // 0x17e0            
            ...
            char m_SlowModifier[0x10]; // 0x18d0            
            ...
            char m_RevivingModifier[0x10]; // 0x18e0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Frank_ReviveVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Frank_ReviveVData) == 0x18f0);
    };
};
