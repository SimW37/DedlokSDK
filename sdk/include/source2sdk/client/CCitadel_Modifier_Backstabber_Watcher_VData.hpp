...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Backstabber_Watcher_VData : public client::CCitadel_Modifier_Intrinsic_BaseVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_Backstabber_Watcher_VData) == 0x688);
};
