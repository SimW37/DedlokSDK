...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_strVoteRevealSound) == 0x9b0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_strLowHealthSound) == 0x9c0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_strHeroSpecificLowHealthSound) == 0x9d0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_strMovementLoop) == 0x9e0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_strPostGameVictorySound) == 0x9f0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_strPostGameDefeatSound) == 0xa00);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_hGameSoundEventScript) == 0xa10);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_hGeneratedVOEventScript) == 0xaf0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_flStealthSpeedMetersPerSecond) == 0xbd0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_bInDevelopment) == 0xbd4);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_bAssignedPlayersOnly) == 0xbd5);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_bNewPlayerRecommended) == 0xbd6);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_bLaneTestingRecommended) == 0xbd7);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_bNeedsTesting) == 0xbd8);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_bLimitedTesting) == 0xbd9);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_bDisabled) == 0xbda);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_bPlayerSelectable) == 0xbdb);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_bPrereleaseOnly) == 0xbdc);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_nComplexity) == 0xbe0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_nAllyBotDifficulty) == 0xbe4);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_nEnemyBotDifficulty) == 0xbe8);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_flMinLowHealthPercentage) == 0xbec);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_flMaxLowHealthPercentage) == 0xbf0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_flMinMidHealthPercentage) == 0xbf4);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_flMaxMidHealthPercentage) == 0xbf8);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_flMinHealthForThreshold) == 0xbfc);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_flMaxHealthForThreshold) == 0xc00);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_flInCombatWithHeroDuration) == 0xc04);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_flInCombatWithNonHeroDuration) == 0xc08);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_flInCombatWithNeutralDuration) == 0xc0c);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_bNAGunFalloffRange) == 0xc10);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapStartingStats) == 0xc18);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapScalingStats) == 0xc40);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_groundDashPositionCurve) == 0xc68);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapModCostBonuses) == 0xca8);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapBoundAbilities) == 0xce8);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapWIPAbilities) == 0xd10);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapItemSlotInfo) == 0xd38);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_eAbilityResourceType) == 0xdb0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_strGunTag) == 0xdb8);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_vecHeroTags) == 0xdc0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_eHeroType) == 0xdd8);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_strRosterBackgroundLayout) == 0xde0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_strHideoutRichPresence) == 0xde8);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapItemDraftCounterWeights) == 0xdf0);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapStandardLevelUpUpgrades) == 0xe30);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapLevelInfo) == 0xe58);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapPurchaseBonuses) == 0xe80);
        static_assert(offsetof(source2sdk::client::CitadelHeroData_t, m_mapItemDraftBucketing) == 0xea8);
        
        static_assert(sizeof(source2sdk::client::CitadelHeroData_t) == 0xef8);
    };
};
