...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Trapper_PoisonJarVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Trapper_PoisonJarVData) == 0x16f0);
    };
};
