...
namespace source2sdk::client
{
    ...
    static_assert(offsetof(CitadelSceneSettings_t, m_bDontPreSettleCloth) == 0x0);
    static_assert(offsetof(CitadelSceneSettings_t, m_strAttachmentName) == 0x8);
    static_assert(offsetof(CitadelSceneSettings_t, m_flFOV) == 0x10);
    static_assert(offsetof(CitadelSceneSettings_t, m_flZNear) == 0x14);
    static_assert(offsetof(CitadelSceneSettings_t, m_flZFar) == 0x18);
    
    static_assert(sizeof(CitadelSceneSettings_t) == 0x20);
};
