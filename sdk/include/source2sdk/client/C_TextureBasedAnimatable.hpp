...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hPositionKeys[0x8]; // 0x9a8            
            // metadata: MNetworkEnable
            ...
            char m_hRotationKeys[0x8]; // 0x9b0            
            // metadata: MNetworkEnable
            Vector m_vAnimationBoundsMin; // 0x9b8            
            // metadata: MNetworkEnable
            Vector m_vAnimationBoundsMax; // 0x9c4            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            float m_flStartTime; // 0x9d0            
            // metadata: MNetworkEnable
            float m_flStartFrame; // 0x9d4            
        ...
        static_assert(sizeof(source2sdk::client::C_TextureBasedAnimatable) == 0x9d8);
    };
};
