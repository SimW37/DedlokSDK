...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_NPC_TrooperNeutral : public source2sdk::client::C_AI_CitadelNPC
        {
        public:
