...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_BoucePadVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_StompParticle[0xe0]; // 0x660            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_BoucePadVData) == 0x750);
    };
};
