...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNotSaved
            std::int32_t m_iLane; // 0x1bc8            
            // metadata: MNetworkEnable
            Vector m_vecElectricBeamTargetEnd; // 0x1bcc            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            source2sdk::client::ETier3State_t m_eAliveState; // 0x1bd8            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            source2sdk::client::ETier3Phase_t m_ePhase; // 0x1bdc            
            // metadata: MNetworkEnable
            Vector m_vShrineAttackTargetPos; // 0x1be0            
        ...
        static_assert(sizeof(source2sdk::client::C_NPC_Boss_Tier3) == 0x1bf0);
    };
};
