...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_TimeWallParticle[0xe0]; // 0x1630            
            ...
            char m_TimeWallChargeParticle[0xe0]; // 0x1710            
            ...
            char m_TimeWallHitParticle[0xe0]; // 0x17f0            
            ...
            char m_TimeWallHitTimerParticle[0xe0]; // 0x18d0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strWallCreated; // 0x19b0            
            CSoundEventName m_strChargeUpSound; // 0x19c0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Chrono_TimeWallVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Chrono_TimeWallVData) == 0x19d0);
    };
};
