...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::TrooperType_t m_TrooperType; // 0x1338            
            float m_flNearDeathDuration; // 0x133c            
            float m_flFlySpeed; // 0x1340            
            float m_flFlyHeight; // 0x1344            
            float m_flMeleeDamage; // 0x1348            
            float m_flMeleeDuration; // 0x134c            
            float m_flMeleeChargeRange; // 0x1350            
            float m_flHealthBarOffsetDucking; // 0x1354            
            // metadata: MPropertyStartGroup "Enemy VS"
            source2sdk::client::TrooperVsConfig_t m_VSPlayer; // 0x1358            
            source2sdk::client::TrooperVsConfig_t m_VSTrooper; // 0x136c            
            source2sdk::client::TrooperVsConfig_t m_VSGuardian; // 0x1380            
            source2sdk::client::TrooperVsConfig_t m_VSWalker; // 0x1394            
            source2sdk::client::TrooperVsConfig_t m_VSWatcher; // 0x13a8            
            source2sdk::client::TrooperVsConfig_t m_VSShrine; // 0x13bc            
            source2sdk::client::TrooperVsConfig_t m_VSPatron; // 0x13d0            
            source2sdk::client::TrooperVsConfig_t m_VSPatronPhase2; // 0x13e4            
            float m_flDPSPctGrowthPerMinute; // 0x13f8            
            bool m_bBossWeaponEnabled; // 0x13fc            
            uint8_t _pad13fd[0x3]; // 0x13fd
            source2sdk::client::CCitadelWeaponInfo m_BossWeapon; // 0x1400            
            ...
            char m_BossAttackParticle[0xe0]; // 0x1b78            
            ...
            char m_LastHitParticle[0xe0]; // 0x1c58            
            ...
            char m_TargetingLaserParticle[0xe0]; // 0x1d38            
            ...
            char m_TargetingEyeFlashParticle[0xe0]; // 0x1e18            
            ...
            char m_sZiplineContainerBreakFromDamageParticle[0xe0]; // 0x1ef8            
            ...
            char m_sZiplineContainerBreakFromLandingParticle[0xe0]; // 0x1fd8            
            ...
            char m_MedicHealActiveParticle[0xe0]; // 0x20b8            
            ...
            char m_HeadHealthChangeAmberParticle[0xe0]; // 0x2198            
            ...
            char m_HeadHealthChangeSapphireParticle[0xe0]; // 0x2278            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_sPlayerLastHitSound; // 0x2358            
            CSoundEventName m_sCelebrationSound; // 0x2368            
            CSoundEventName m_sZiplineContainerBreakSound; // 0x2378            
            ...
            char m_NearDeathModifier[0x10]; // 0x2388            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_ShrinesDownBuffModifier;
            char m_ShrinesDownBuffModifier[0x10]; // 0x2398            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_NpcOutOfCombatRegenModifier;
            char m_NpcOutOfCombatRegenModifier[0x10]; // 0x23a8            
            uint8_t _pad23b8[0x18];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAI_NPC_TrooperVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAI_NPC_TrooperVData) == 0x23d0);
    };
};
