...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Magician_AnimalHexAreaVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_HexAreaModifier;
            char m_HexAreaModifier[0x10]; // 0x1618            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_TargetWarningSound; // 0x1628            
            CSoundEventName m_ProjectileHitConfirm; // 0x1638            
            ...
            char m_AreaWarningEffect[0xe0]; // 0x1648            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Magician_AnimalHexAreaVData) == 0x1728);
    };
};
