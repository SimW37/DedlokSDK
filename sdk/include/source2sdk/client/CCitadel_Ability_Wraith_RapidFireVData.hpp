...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Wraith_RapidFireVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            CSoundEventName m_TargetBuffSound; // 0x16c8            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_RapidFireModifier;
            char m_RapidFireModifier[0x10]; // 0x16d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Wraith_RapidFireVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Wraith_RapidFireVData) == 0x16e8);
    };
};
