...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            CSoundEventName m_TargetBuffSound; // 0x1700            
            ...
            char m_RapidFireModifier[0x10]; // 0x1710            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Wraith_RapidFireVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Wraith_RapidFireVData) == 0x1720);
    };
};
