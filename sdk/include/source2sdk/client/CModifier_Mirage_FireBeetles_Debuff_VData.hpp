...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CModifier_Mirage_FireBeetles_Debuff_VData : public client::CCitadelModifierVData
    {
    public:
