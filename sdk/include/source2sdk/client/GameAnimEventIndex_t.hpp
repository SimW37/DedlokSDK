...
namespace source2sdk::client
{
    ...
    enum class GameAnimEventIndex_t : std::uint32_t
    {
        ...
        AE_ENABLE_PLATFORM_PLAYER_FOLLOWS_YAW = 0x21,
        AE_ENABLE_PLATFORM_PLAYER_IGNORES_YAW = 0x22,
        AE_DESTRUCTIBLE_PART_DESTROY = 0x23,
        AE_NPC_LEFTFOOT = 0x24,
        AE_NPC_RIGHTFOOT = 0x25,
        AE_NPC_BODYDROP_LIGHT = 0x26,
        AE_NPC_BODYDROP_HEAVY = 0x27,
        AE_NPC_SWISHSOUND = 0x28,
        AE_NPC_WEAPON_DROP = 0x29,
        AE_NPC_RAGDOLL = 0x2a,
        AE_NPC_ATTACK_BROADCAST = 0x2b,
        AE_PREDICTED_PLAYSOUND = 0x2c,
        AE_RAGDOLL_WINDOW = 0x2d,
        AE_MELEE_ATTACK = 0x2e,
    };
};
