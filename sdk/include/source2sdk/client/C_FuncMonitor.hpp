...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            CUtlString m_targetCamera; // 0x9a0            
            // metadata: MNetworkEnable
            std::int32_t m_nResolutionEnum; // 0x9a8            
            // metadata: MNetworkEnable
            bool m_bRenderShadows; // 0x9ac            
            // metadata: MNetworkEnable
            bool m_bUseUniqueColorTarget; // 0x9ad            
            uint8_t _pad09ae[0x2]; // 0x9ae
            // metadata: MNetworkEnable
            CUtlString m_brushModelName; // 0x9b0            
            // metadata: MNetworkEnable
            ...
            char m_hTargetCamera[0x4]; // 0x9b8            
            // metadata: MNetworkEnable
            bool m_bEnabled; // 0x9bc            
            // metadata: MNetworkEnable
            bool m_bDraw3DSkybox; // 0x9bd            
            uint8_t _pad09be[0x462];
        };
        #pragma pack(pop)
