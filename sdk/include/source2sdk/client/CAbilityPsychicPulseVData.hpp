...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbilityPsychicPulseVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_PulseParticle[0xe0]; // 0x15f8            
            // metadata: MPropertyStartGroup "+Psychic Pulse Properties"
            float m_flCastEffectLifetime; // 0x16d8            
            float m_flConeAngle; // 0x16dc            
            float m_flConeHalfWidth; // 0x16e0            
        ...
        static_assert(sizeof(source2sdk::client::CAbilityPsychicPulseVData) == 0x16e8);
    };
};
