...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_PulseParticle[0xe0]; // 0x1828            
            // metadata: MPropertyStartGroup "+Psychic Pulse Properties"
            float m_flCastEffectLifetime; // 0x1908            
            float m_flConeAngle; // 0x190c            
            float m_flConeHalfWidth; // 0x1910            
        ...
        static_assert(sizeof(source2sdk::client::CAbilityPsychicPulseVData) == 0x1918);
    };
};
