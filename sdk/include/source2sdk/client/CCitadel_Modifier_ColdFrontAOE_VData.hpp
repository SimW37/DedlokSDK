...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_ColdFrontAOE_VData : public client::CCitadelModifierVData
    {
    public:
