...
namespace source2sdk::client
{
    ...
    {
    public:
        entity2::GameTime_t m_flFlyingStartTime; // 0xdc0        
        [[maybe_unused]] std::uint8_t pad_0xdc4[0x84]; // 0xdc4
