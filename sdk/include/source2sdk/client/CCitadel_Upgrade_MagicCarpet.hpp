...
namespace source2sdk::client
{
    ...
    {
    public:
        entity2::GameTime_t m_flFlyingStartTime; // 0xc68        
        [[maybe_unused]] std::uint8_t pad_0xc6c[0xac]; // 0xc6c
