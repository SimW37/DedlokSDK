...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Spellbreaker_VData : public source2sdk::client::CCitadel_Modifier_Intrinsic_BaseVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Spellbreaker_VData) == 0x740);
    };
};
