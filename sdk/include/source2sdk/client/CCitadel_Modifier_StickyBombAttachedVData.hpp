...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BombAttachedParticle[0xe0]; // 0x658        
        ...
        char m_StunAttachedParticle[0xe0]; // 0x738        
        // m_ExplodeParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ExplodeParticle;
        char m_ExplodeParticle[0xe0]; // 0x818        
        ...
        char m_BombAttachedVictimTeamParticle[0xe0]; // 0x8f8        
        ...
        char m_DebuffModifier[0x10]; // 0xa08        
    ...
    static_assert(sizeof(CCitadel_Modifier_StickyBombAttachedVData) == 0xa20);
};
