...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            bool m_bBeamTurnToFire; // 0x11e0            
            uint8_t _pad11e1[0x7]; // 0x11e1
            ...
            float m_flStompParryRadius; // 0x1664            
            float m_flStompParryImpulse; // 0x1668            
            float m_flStompParryImpulseInAir; // 0x166c            
            float m_flStompParryDamageMult; // 0x1670            
            ...
            CSoundEventName m_StompParriedSound; // 0x1690            
            CSoundEventName m_StompImpactSound; // 0x16a0            
            // metadata: MPropertyStartGroup "Gun"
            float m_flBurstDuration; // 0x16b0            
            float m_flBurstCooldown; // 0x16b4            
            ...
            char m_BackdoorProtectionModifier[0x10]; // 0x16b8            
            float m_flBackDoorProtectionRange; // 0x16c8            
            ...
            char m_InvulModifier[0x10]; // 0x16d0            
            float m_flInvulModifierRange; // 0x16e0            
            ...
            char m_RangedArmorModifier[0x10]; // 0x16e8            
            ...
            char m_FriendlyAuraModifier[0x10]; // 0x16f8            
            ...
            char m_NearbyEnemyResist[0x10]; // 0x1708            
            ...
            char m_StatTrackerAuraModifier[0x10]; // 0x1718            
            ...
            char m_vecWeakPoints[0x18]; // 0x1728            
            float m_flWeakPointCritMultiplier; // 0x1740            
            float m_flWeakenedCritMultiplier; // 0x1744            
            float m_flWeakpointAttentionThreshold; // 0x1748            
            float m_flWeakpointAttentionHoldDuration; // 0x174c            
            float m_flWeakpointAttentionDecayRate; // 0x1750            
            float m_flReducedBuildupAfterWeakenedDuration; // 0x1754            
            float m_flReducedBuildupAfterWeakenedFactor; // 0x1758            
            uint8_t _pad175c[0x4]; // 0x175c
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadel_Modifier_Base_Buildup> m_WeakenedBuildupModifier;
            char m_WeakenedBuildupModifier[0x10]; // 0x1760            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_WeakenedModifier;
            char m_WeakenedModifier[0x10]; // 0x1770            
            ...
            char m_EmpoweredModifierLevel1[0x10]; // 0x1780            
            ...
            char m_EmpoweredModifierLevel2[0x10]; // 0x1790            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CNPC_Boss_Tier2VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CNPC_Boss_Tier2VData) == 0x17a0);
    };
};
