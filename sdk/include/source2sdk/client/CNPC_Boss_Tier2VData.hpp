...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x16cc[0x4]; // 0x16cc
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_RangedArmorModifier;
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_NearbyEnemyResist;
    ...
    static_assert(sizeof(CNPC_Boss_Tier2VData) == 0x1700);
};
