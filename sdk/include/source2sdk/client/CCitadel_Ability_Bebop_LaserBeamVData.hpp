...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_RestrictionModifier[0x10]; // 0x1620            
            ...
            char m_ChargeParticle[0xe0]; // 0x1630            
            // metadata: MPropertyStartGroup "GamePlay"
            float m_flCancelCooldown; // 0x1710            
            ...
            char m_BeamParticleLocal[0xe0]; // 0x17f8            
            ...
            char m_BeamHitParticle[0xe0]; // 0x18d8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strLaserStartSound; // 0x19b8            
            CSoundEventName m_strLaserEndSound; // 0x19c8            
            CSoundEventName m_strLaserLoopSound; // 0x19d8            
            CSoundEventName m_strLaserHitSound; // 0x19e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Bebop_LaserBeamVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Bebop_LaserBeamVData) == 0x19f8);
    };
};
