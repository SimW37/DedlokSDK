...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_ScalingPowerUpVData : public client::CCitadelModifierVData
    {
    public:
        ...
        char m_vecModifierValues[0x18]; // 0x658        
    ...
    static_assert(sizeof(CCitadel_Modifier_ScalingPowerUpVData) == 0x678);
};
