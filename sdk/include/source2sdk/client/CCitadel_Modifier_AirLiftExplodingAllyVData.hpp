...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_AirLiftExplodingAllyVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_strExplodeEffect[0xe0]; // 0x660            
