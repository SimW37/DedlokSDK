...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_WeaponDamageBonusModifier[0x10]; // 0x15f0            
            ...
            char m_TeleportTrailParticle[0xe0]; // 0x1600            
            // m_ImpactParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ImpactParticle;
            char m_ImpactParticle[0xe0]; // 0x16e0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strCasterLoopingSound; // 0x17c0            
            CSoundEventName m_strProjectileExpireSound; // 0x17d0            
            CSoundEventName m_strImpactSound; // 0x17e0            
            CSoundEventName m_strTimerSound; // 0x17f0            
        ...
        static_assert(sizeof(source2sdk::client::CAbility_Synth_PlasmaFlux_VData) == 0x1888);
    };
};
