...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifierRiotCastDelayVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_UnstoppableModifier[0x10]; // 0x660            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifierRiotCastDelayVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CModifierRiotCastDelayVData) == 0x670);
    };
};
