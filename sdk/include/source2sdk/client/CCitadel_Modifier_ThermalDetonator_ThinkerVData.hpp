...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_ThermalDetonator_ThinkerVData : public source2sdk::client::CCitadelModifierAuraVData
        {
        public:
            ...
            char m_GroundParticle[0xe0]; // 0x7b0            
            ...
            char m_GroundParticleFriendly[0xe0]; // 0x890            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_ThermalDetonator_ThinkerVData) == 0x970);
    };
};
