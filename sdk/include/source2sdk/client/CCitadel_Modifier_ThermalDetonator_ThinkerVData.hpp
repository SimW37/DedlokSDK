...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_GroundParticle[0xe0]; // 0x6b0            
            ...
            char m_GroundParticleFriendly[0xe0]; // 0x790            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_ThermalDetonator_ThinkerVData) == 0x870);
    };
};
