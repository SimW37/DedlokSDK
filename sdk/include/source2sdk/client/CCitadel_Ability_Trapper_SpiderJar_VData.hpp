...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_SpiderExplodeParticle[0xe0]; // 0x1620            
            ...
            char m_JarExplodeParticle[0xe0]; // 0x1700            
            ...
            char m_SpiritStealDebuffModifier[0x10]; // 0x17e0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Trapper_SpiderJar_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Trapper_SpiderJar_VData) == 0x17f0);
    };
};
