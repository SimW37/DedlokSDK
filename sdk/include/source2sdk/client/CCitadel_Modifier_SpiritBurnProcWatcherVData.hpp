...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_SpiritBurnProcWatcherVData : public source2sdk::client::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CBaseModifier> m_SpiritBurnDamageTracker;
            char m_SpiritBurnDamageTracker[0x10]; // 0x690            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_SpiritBurnProcWatcherVData) == 0x6a0);
    };
};
