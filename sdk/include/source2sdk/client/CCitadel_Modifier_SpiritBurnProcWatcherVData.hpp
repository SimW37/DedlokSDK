...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_SpiritBurnProcWatcherVData : public client::CCitadel_Modifier_BaseEventProcVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CBaseModifier> m_SpiritBurnDamageTracker;
    ...
    static_assert(sizeof(CCitadel_Modifier_SpiritBurnProcWatcherVData) == 0x6a0);
};
