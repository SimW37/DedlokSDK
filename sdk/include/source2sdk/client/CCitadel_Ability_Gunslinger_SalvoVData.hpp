...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BulletWarningParticle[0xe0]; // 0x15c8        
        ...
        char m_ProcWatcherModifier[0x10]; // 0x16a8        
