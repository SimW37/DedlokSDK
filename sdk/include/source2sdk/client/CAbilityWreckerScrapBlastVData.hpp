...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbilityWreckerScrapBlastVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CAbilityWreckerScrapBlastVData) == 0x17e8);
    };
};
