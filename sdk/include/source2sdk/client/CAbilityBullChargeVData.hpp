...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceImpact; // 0x15f0            
        ...
        static_assert(sizeof(source2sdk::client::CAbilityBullChargeVData) == 0x17c0);
    };
};
