...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_EtherealBulletsVData : public client::CCitadel_Modifier_BaseEventProcVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_BulletDamageBuffModifier;
    ...
    static_assert(sizeof(CCitadel_Modifier_EtherealBulletsVData) == 0x790);
};
