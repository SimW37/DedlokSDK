...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_ExplosiveBullets : public source2sdk::client::CCitadel_Modifier_BaseBulletPreRollProc
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_ExplosiveBullets) == 0x220);
    };
};
