...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_SalvoBulletVData : public source2sdk::client::CCitadel_Modifier_BaseBulletPreRollProcVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_SalvoBulletVData) == 0xa60);
    };
};
