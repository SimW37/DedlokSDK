...
namespace source2sdk::client
{
    ...
    public:
        ...
        // metadata: MNetworkEnable
        client::ValueRemapperInputType_t m_nInputType; // 0x5e4        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        client::ValueRemapperOutputType_t m_nOutputType; // 0x600        
        ...
        // metadata: MNetworkEnable
        client::ValueRemapperHapticsType_t m_nHapticsType; // 0x620        
        // metadata: MNetworkEnable
        client::ValueRemapperMomentumType_t m_nMomentumType; // 0x624        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        client::ValueRemapperRatchetType_t m_nRatchetType; // 0x634        
        ...
        entity2::GameTime_t m_flPreviousUpdateTickTime; // 0x648        
    ...
    static_assert(sizeof(C_PointValueRemapper) == 0x658);
};
