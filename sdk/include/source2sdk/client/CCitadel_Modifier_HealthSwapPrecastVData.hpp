...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_strTargetParticleEffect[0xe0]; // 0x660            
            ...
            char m_strTargetEnemyParticleEffect[0xe0]; // 0x740            
            ...
            char m_strTargetScreenParticleEffect[0xe0]; // 0x820            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_HealthSwapPrecastVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_HealthSwapPrecastVData) == 0x900);
    };
};
