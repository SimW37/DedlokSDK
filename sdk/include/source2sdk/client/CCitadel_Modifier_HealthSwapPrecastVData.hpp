...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_strTargetParticleEffect[0xe0]; // 0x658        
        ...
        char m_strTargetEnemyParticleEffect[0xe0]; // 0x738        
