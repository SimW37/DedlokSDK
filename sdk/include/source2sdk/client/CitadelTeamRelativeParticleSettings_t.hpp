...
namespace source2sdk::client
{
    ...
    public:
        ...
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_strFriendlyParticle;
        ...
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_strEnemyParticle;
        ...
        // metadata: MPropertySuppressExpr "m_bUseConfig"
        animationsystem::ParticleAttachment_t m_AttachmentType; // 0x1d0        
    ...
    static_assert(offsetof(CitadelTeamRelativeParticleSettings_t, m_strFriendlyParticle) == 0x0);
    static_assert(offsetof(CitadelTeamRelativeParticleSettings_t, m_strEnemyParticle) == 0xe0);
    static_assert(offsetof(CitadelTeamRelativeParticleSettings_t, m_bUseConfig) == 0x1c0);
    static_assert(offsetof(CitadelTeamRelativeParticleSettings_t, m_strConfigName) == 0x1c8);
    static_assert(offsetof(CitadelTeamRelativeParticleSettings_t, m_AttachmentType) == 0x1d0);
    static_assert(offsetof(CitadelTeamRelativeParticleSettings_t, m_strAttachmentName) == 0x1d8);
    
    static_assert(sizeof(CitadelTeamRelativeParticleSettings_t) == 0x1e0);
};
