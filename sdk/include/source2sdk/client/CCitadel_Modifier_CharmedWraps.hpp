...
namespace source2sdk::client
{
    ...
    {
    public:
        entity2::GameTime_t m_fLastPrimingLightAttackTime; // 0x178        
        [[maybe_unused]] std::uint8_t pad_0x17c[0x84];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Modifier_CharmedWraps because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Modifier_CharmedWraps) == 0x200);
};
