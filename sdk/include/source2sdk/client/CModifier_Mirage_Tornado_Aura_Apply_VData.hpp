...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Mirage_Tornado_Aura_Apply_VData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_TossModifier;
            char m_TossModifier[0x10]; // 0x660            
            ...
            char m_LiftModifier[0x10]; // 0x670            
            CSoundEventName m_strHitConfirmSound; // 0x680            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifier_Mirage_Tornado_Aura_Apply_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CModifier_Mirage_Tornado_Aura_Apply_VData) == 0x690);
    };
};
