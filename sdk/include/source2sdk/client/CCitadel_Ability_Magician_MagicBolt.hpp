...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecDeployedProjectiles[0x18]; // 0xd90            
            std::int32_t m_iCurrentRedirects; // 0xda8            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Magician_MagicBolt) == 0x1070);
    };
};
