...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            uint8_t _pad0ca8[0x20]; // 0xca8
            CUtlString m_strFruitModelName; // 0xcc8            
            VectorWS m_vStartPos; // 0xcd0            
            VectorWS m_vEndPos; // 0xcdc            
            float m_flGrowDuration; // 0xce8            
        ...
        static_assert(sizeof(source2sdk::client::C_Citadel_DruidHealingTree) == 0xcf0);
    };
};
