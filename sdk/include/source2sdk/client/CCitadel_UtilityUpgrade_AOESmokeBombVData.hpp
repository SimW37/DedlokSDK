...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_CastCompleteParticle[0xe0]; // 0x1668        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strBuffGainedSound; // 0x1748        
