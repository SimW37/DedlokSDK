...
namespace source2sdk::client
{
    ...
    public:
        ...
        CSoundEventName m_HeadShotVictimSound; // 0x1610        
        CSoundEventName m_HeadShotConfirmationSound; // 0x1620        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_WeaponUpgrade_HeadshotBooster_VData) == 0x1630);
};
