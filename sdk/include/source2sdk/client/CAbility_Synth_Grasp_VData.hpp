...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbility_Synth_Grasp_VData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_CasterModifier[0x10]; // 0x1618            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_VictimModifier;
            char m_VictimModifier[0x10]; // 0x1628            
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_BulletShieldModifier;
            char m_BulletShieldModifier[0x10]; // 0x1638            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Synth_Grasp_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbility_Synth_Grasp_VData) == 0x1648);
    };
};
