...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            uint8_t _pad0eb0[0x380]; // 0xeb0
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartWindUpTime; // 0x1230            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartFiringTime; // 0x1234            
            // metadata: MNetworkEnable
            bool m_bFiring; // 0x1238            
            uint8_t _pad1239[0x16f];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_PrimaryWeapon_Bebop because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_PrimaryWeapon_Bebop) == 0x13a8);
    };
};
