...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_flBackDoorProtectionRange; // 0x1828            
            float m_flEnemyTrooperProtectionRange; // 0x182c            
            ...
            char m_BackdoorProtectionModifier[0x10]; // 0x1830            
            ...
            char m_BackdoorBulletResistModifier[0x10]; // 0x1840            
            ...
            char m_ObjectiveRegen[0x10]; // 0x1850            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CNPC_TrooperBarrackBossVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CNPC_TrooperBarrackBossVData) == 0x1860);
    };
};
