...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flLandedFlatGroundFrictionGraceTime; // 0x1644            
            ...
            float m_flSlideActivationProbeForwardOffset; // 0x16bc            
            // metadata: MPropertyDescription "Maximum distance between probe samples"
            float m_flMaxDistanceBetweenProbeSamples; // 0x16c0            
            ...
            float m_flSampleVelDiffStdDevScaleCutoff; // 0x16cc            
            ...
            float m_flAirDragMaxAngle; // 0x16dc            
            ...
            float m_flAirDragResetTime; // 0x16e0            
            // metadata: MPropertyDescription "How long after you stop sliding do we consider it to still be a slide-jump."
            float m_flLateSlideJumpWindow; // 0x16e4            
            // metadata: MPropertyDescription "Speed remap to slide effect intensity"
            source2sdk::client::CRemapFloat m_SlideEffectRemap; // 0x16e8            
            // metadata: MPropertyDescription "The curve defining the getup anim's speed penalty duration(x) and severity(y)."
            CPiecewiseCurve m_GetupSpeedCurve; // 0x16f8            
            // metadata: MPropertyDescription "How long after you stop sliding do we consider it to still be a slide-jump."
            float m_flGetupBusyDuration; // 0x1738            
            // metadata: MPropertyDescription "The amount that sliding reduces recoil. 100 = no recoil at all."
            float m_flSlidingRecoilReduction; // 0x173c            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceStartSliding; // 0x1740            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceEndSliding; // 0x17c8            
            ...
            char m_SlideParticle[0xe0]; // 0x1850            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strStartSound; // 0x1930            
            CSoundEventName m_strLoopingSound; // 0x1940            
            CSoundEventName m_strStopSound; // 0x1950            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilitySlideVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilitySlideVData) == 0x1960);
    };
};
