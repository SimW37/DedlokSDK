...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CRemapFloat m_SlideEffectRemap; // 0x1690        
        ...
        client::CitadelCameraOperationsSequence_t m_cameraSequenceStartSliding; // 0x16e8        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceEndSliding; // 0x1770        
        ...
        char m_SlideParticle[0xe0]; // 0x17f8        
    ...
    static_assert(sizeof(CAbilitySlideVData) == 0x1908);
};
