...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Item_FocusLens_VData : public client::CCitadel_Item_TrackingProjectileApplyModifierVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_DamageModifier;
