...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_CrushingFistsDebuff_VData : public client::CCitadelModifierVData
    {
    public:
        ...
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ProcNotificationEffect;
    ...
    static_assert(sizeof(CCitadel_Modifier_CrushingFistsDebuff_VData) == 0x760);
};
