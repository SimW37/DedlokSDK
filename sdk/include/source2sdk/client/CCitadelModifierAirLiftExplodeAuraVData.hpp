...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadelModifierAirLiftExplodeAuraVData : public source2sdk::client::CCitadelModifierAuraVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadelModifierAirLiftExplodeAuraVData) == 0x890);
    };
};
