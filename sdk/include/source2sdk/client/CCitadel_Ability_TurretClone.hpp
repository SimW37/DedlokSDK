...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            bool m_bHasTurretReady; // 0xec8            
            uint8_t _pad0ec9[0x3]; // 0xec9
            // metadata: MNetworkEnable
            std::int32_t m_iCurrentSwapCount; // 0xecc            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flTurretExpireTime; // 0xed0            
            uint8_t _pad0ed4[0x4]; // 0xed4
            source2sdk::client::ShotID_t m_nLastBulletShotID; // 0xed8            
            // metadata: MNetworkEnable
            ...
            char m_pActiveTurret[0x4]; // 0xedc            
            source2sdk::client::ParticleIndex_t m_nTurretFXIndex; // 0xee0            
            uint8_t _pad0ee4[0x144];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_TurretClone because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_TurretClone) == 0x1028);
    };
};
