...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Galvanic_Storm_EffectVData : public source2sdk::client::CCitadel_Modifier_ChainLightningEffectVData
        {
        public:
            ...
            char m_BuffChainParticle[0xe0]; // 0x760            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Galvanic_Storm_EffectVData) == 0x840);
    };
};
