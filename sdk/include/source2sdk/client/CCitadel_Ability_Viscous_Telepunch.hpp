...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            Vector m_vecTeleportPosition; // 0x1858            
            // metadata: MNetworkEnable
            Vector m_vecTeleportPositionNormal; // 0x1864            
            // metadata: MNetworkEnable
            source2sdk::client::ETelepunchState_t m_eTelepunchState; // 0x1870            
            uint8_t _pad1871[0x3]; // 0x1871
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flNextStateTime; // 0x1874            
            uint8_t _pad1878[0x10];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Viscous_Telepunch because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Viscous_Telepunch) == 0x1888);
    };
};
