...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecCurrentTargets[0x18]; // 0xd88            
            uint8_t _pad0da0[0x4]; // 0xda0
            // metadata: MNetworkEnable
            std::int32_t m_nKillsEarned; // 0xda4            
            // metadata: MNetworkEnable
            std::int32_t m_nAssistsEarned; // 0xda8            
            uint8_t _pad0dac[0x344];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Drifter_Hunger because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Drifter_Hunger) == 0x10f0);
    };
};
