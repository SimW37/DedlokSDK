...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_SatiatedModifier[0x10]; // 0x1630            
            ...
            char m_HungryModifier[0x10]; // 0x1640            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Drifter_HungerVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Drifter_HungerVData) == 0x1650);
    };
};
