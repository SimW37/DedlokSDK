...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Drifter_HungerVData : public client::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_SatiatedModifier;
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_HungryModifier;
