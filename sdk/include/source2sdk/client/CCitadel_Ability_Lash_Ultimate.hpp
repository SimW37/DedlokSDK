...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            uint8_t _pad0f80[0x2]; // 0xf80
            // metadata: MNetworkEnable
            source2sdk::client::ELashGrappleState m_EGrappleState; // 0xf82            
            uint8_t _pad0f83[0x1]; // 0xf83
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStateEnterTime; // 0xf84            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flNextStateTime; // 0xf88            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flBoostEndTime; // 0xf8c            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Lash_Ultimate) == 0x1118);
    };
};
