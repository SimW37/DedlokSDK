...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_DashJumpParticle[0xe0]; // 0x1700            
            ...
            char m_AirJumpParticle[0xe0]; // 0x17e0            
            ...
            CSoundEventName m_GroundJumpExecutedSound; // 0x19a0            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_AirJumpSound; // 0x19b0            
            // metadata: MPropertyStartGroup "Air Jump"
            float m_flMantleRefundWindow; // 0x19c0            
            float m_flZiplineRefundWindow; // 0x19c4            
            float m_flLateJumpGraceWindow; // 0x19c8            
            // metadata: MPropertyDescription "The most we'll adjust your speed in the input direction when performing an air jump"
            float m_flMaxSpeedDelta; // 0x19cc            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strDashJumpSound; // 0x19d0            
            // metadata: MPropertyStartGroup "Roll Jump"
            float m_flDashJumpStartTime; // 0x19e0            
            float m_flDashJumpEndTime; // 0x19e4            
            ...
            float m_flCollidedWallMaxDist; // 0x1a20            
            // metadata: MPropertyDescription "How far we'll trace using the player's velocity to find a wall to jump off of"
            source2sdk::client::CRemapFloat m_flRemapSpeedToWallJumpVelocityDist; // 0x1a24            
            ...
            float m_flWallJumpFullPowerRechargeTime; // 0x1a34            
            ...
            float m_flWallJumpPowerMin; // 0x1a38            
            ...
            float m_flWallJumpPowerBias; // 0x1a3c            
            ...
            float m_flWallJumpLateralInputSuppressTime; // 0x1a90            
            ...
            float m_flWallJumpReturnToWallBonusAccel; // 0x1a94            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityJumpVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityJumpVData) == 0x1a98);
    };
};
