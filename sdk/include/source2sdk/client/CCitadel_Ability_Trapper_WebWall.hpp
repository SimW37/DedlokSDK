...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            Vector m_vecCastPosition; // 0xec8            
            // metadata: MNetworkEnable
            Vector m_vecCastPositionNormal; // 0xed4            
            // metadata: MNetworkEnable
            Vector m_vecEndPosition; // 0xee0            
            // metadata: MNetworkEnable
            Vector m_vecEndPositionNormal; // 0xeec            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Trapper_WebWall because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Trapper_WebWall) == 0xef8);
    };
};
