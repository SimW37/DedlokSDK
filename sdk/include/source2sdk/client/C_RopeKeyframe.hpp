...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_LinksTouchingSomething[0x4]; // 0x9a8            
            // metadata: MNotSaved
            std::int32_t m_nLinksTouchingSomething; // 0x9ac            
            // metadata: MNotSaved
            bool m_bApplyWind; // 0x9b0            
            uint8_t _pad09b1[0x3]; // 0x9b1
            // metadata: MNotSaved
            std::int32_t m_fPrevLockedPoints; // 0x9b4            
            // metadata: MNotSaved
            std::int32_t m_iForcePointMoveCounter; // 0x9b8            
            // metadata: MNotSaved
            bool m_bPrevEndPointPos[2]; // 0x9bc            
            uint8_t _pad09be[0x2]; // 0x9be
            // metadata: MNotSaved
            Vector m_vPrevEndPointPos[2]; // 0x9c0            
            // metadata: MNotSaved
            float m_flCurScroll; // 0x9d8            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            float m_flScrollSpeed; // 0x9dc            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            std::uint16_t m_RopeFlags; // 0x9e0            
            ...
            char m_iRopeMaterialModelIndex[0x8]; // 0x9e8            
            uint8_t _pad09f0[0x270]; // 0x9f0
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            std::uint8_t m_nSegments; // 0xc60            
            ...
            char m_hEndPoint[0x4]; // 0xc68            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            source2sdk::modellib::AttachmentHandle_t m_iStartAttachment; // 0xc6c            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            source2sdk::modellib::AttachmentHandle_t m_iEndAttachment; // 0xc6d            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            std::uint8_t m_Subdiv; // 0xc6e            
            uint8_t _pad0c6f[0x1]; // 0xc6f
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "RecomputeSprings"
            // metadata: MNotSaved
            std::int16_t m_RopeLength; // 0xc70            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "RecomputeSprings"
            // metadata: MNotSaved
            std::int16_t m_Slack; // 0xc72            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "10"
            // metadata: MNetworkMinValue "0,100000"
            // metadata: MNetworkMaxValue "10,000000"
            // metadata: MNotSaved
            float m_TextureScale; // 0xc74            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            std::uint8_t m_fLockedPoints; // 0xc78            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            std::uint8_t m_nChangeCount; // 0xc79            
            uint8_t _pad0c7a[0x2]; // 0xc7a
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            float m_Width; // 0xc7c            
            // metadata: MNotSaved
            source2sdk::client::C_RopeKeyframe_CPhysicsDelegate m_PhysicsDelegate; // 0xc80            
            // metadata: MNotSaved
            ...
            char m_hMaterial[0x8]; // 0xc90            
            // metadata: MNotSaved
            std::int32_t m_TextureHeight; // 0xc98            
            // metadata: MNotSaved
            Vector m_vecImpulse; // 0xc9c            
            // metadata: MNotSaved
            Vector m_vecPreviousImpulse; // 0xca8            
            // metadata: MNotSaved
            float m_flCurrentGustTimer; // 0xcb4            
            // metadata: MNotSaved
            float m_flCurrentGustLifetime; // 0xcb8            
            // metadata: MNotSaved
            float m_flTimeToNextGust; // 0xcbc            
            // metadata: MNotSaved
            Vector m_vWindDir; // 0xcc0            
            // metadata: MNotSaved
            Vector m_vColorMod; // 0xccc            
            // metadata: MNotSaved
            Vector m_vCachedEndPointAttachmentPos[2]; // 0xcd8            
            // metadata: MNotSaved
            QAngle m_vCachedEndPointAttachmentAngle[2]; // 0xcf0            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            bool m_bConstrainBetweenEndpoints; // 0xd08            
