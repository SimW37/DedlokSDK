...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flPercentageSpeedIncrease; // 0x664            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceStartBoost; // 0x668            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_ZiplineBoostVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_ZiplineBoostVData) == 0x6f0);
    };
};
