...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_BubbleVData : public source2sdk::client::CitadelItemVData
        {
        public:
            ...
            CSoundEventName m_CastTargetSound; // 0x1758            
            ...
            char m_BubbleModifier[0x10]; // 0x1768            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_BubbleVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Item_BubbleVData) == 0x1778);
    };
};
