...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CTakeDamageResult result; // 0xf8        
    ...
    static_assert(offsetof(SummaryTakeDamageInfo_t, result) == 0xf8);
    static_assert(offsetof(SummaryTakeDamageInfo_t, hTarget) == 0x118);
    
    static_assert(sizeof(SummaryTakeDamageInfo_t) == 0x120);
};
