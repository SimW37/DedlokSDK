...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_ViscousWeapon_Alt_VData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_strChargingParticle[0xe0]; // 0x1618            
            ...
            char m_FiringParticle[0xe0]; // 0x17d8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_ExplosionSound; // 0x18b8            
            CSoundEventName m_ChargeSound; // 0x18c8            
            CSoundEventName m_ShootSound; // 0x18d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ViscousWeapon_Alt_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ViscousWeapon_Alt_VData) == 0x18e8);
    };
};
