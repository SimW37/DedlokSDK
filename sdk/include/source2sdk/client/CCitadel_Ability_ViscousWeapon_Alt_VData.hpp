...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_strChargingParticle[0xe0]; // 0x15f0            
            ...
            char m_FiringParticle[0xe0]; // 0x17b0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_ExplosionSound; // 0x1890            
            CSoundEventName m_ChargeSound; // 0x18a0            
            CSoundEventName m_ShootSound; // 0x18b0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ViscousWeapon_Alt_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ViscousWeapon_Alt_VData) == 0x18c0);
    };
};
