...
namespace source2sdk::client
{
    ...
    public:
        ...
        uint8_t m_Flags; // 0x9a8        
        // metadata: MNetworkEnable
        uint8_t m_LightStyle; // 0x9a9        
        [[maybe_unused]] std::uint8_t pad_0x9aa[0x2]; // 0x9aa
        // metadata: MNetworkEnable
        float m_Radius; // 0x9ac        
        // metadata: MNetworkEnable
        int32_t m_Exponent; // 0x9b0        
        // metadata: MNetworkEnable
