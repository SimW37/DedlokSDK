...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNotSaved
            std::uint8_t m_Flags; // 0x9a0            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            std::uint8_t m_LightStyle; // 0x9a1            
            uint8_t _pad09a2[0x2]; // 0x9a2
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            float m_Radius; // 0x9a4            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            std::int32_t m_Exponent; // 0x9a8            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "360,000000"
            // metadata: MNotSaved
            float m_InnerAngle; // 0x9ac            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "360,000000"
            // metadata: MNotSaved
            float m_OuterAngle; // 0x9b0            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            float m_SpotRadius; // 0x9b4            
            uint8_t _pad09b8[0x10];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DynamicLight because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DynamicLight) == 0x9c8);
    };
};
