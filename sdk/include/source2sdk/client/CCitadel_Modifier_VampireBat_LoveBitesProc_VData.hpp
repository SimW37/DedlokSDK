...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_VampireBat_LoveBitesProc_VData : public client::CCitadelModifierVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_VampireBat_LoveBitesProc_VData) == 0x670);
};
