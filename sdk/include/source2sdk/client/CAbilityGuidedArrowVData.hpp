...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraCancelledTransitionBacktoArcher; // 0x15e8            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraExplodedTransitionBackToArcher; // 0x1670            
            float m_flCameraHoldAtExplosion; // 0x16f8            
            float m_flFadeToBlackTime; // 0x16fc            
            ...
            char m_GuidedArrowChannelParticle[0xe0]; // 0x18c0            
            ...
            float m_ArrowOffsetX; // 0x1a80            
            float m_ArrowCameraDistance; // 0x1a84            
            float m_ArrowCameraHeightOffset; // 0x1a88            
            float m_ArrowInitialPitch; // 0x1a8c            
            ...
            char m_KillCheckModifier[0x10]; // 0x1ab0            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strExplodeSound; // 0x1ac0            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flTrackAmount; // 0x1ad0            
            float m_flSpeedAccel; // 0x1ad4            
            float m_flSpeedDeccel; // 0x1ad8            
            float m_flBaseProjectileSpeed; // 0x1adc            
            float m_flMaxProjectileSpeed; // 0x1ae0            
            float m_flArrowModelTurnSpringStrength; // 0x1ae4            
            float m_flKillCheckWindow; // 0x1ae8            
            float m_flWorldCollideGraceWindow; // 0x1aec            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityGuidedArrowVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityGuidedArrowVData) == 0x1af0);
    };
};
