...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraCancelledTransitionBacktoArcher; // 0x1620            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraExplodedTransitionBackToArcher; // 0x16a8            
            float m_flCameraHoldAtExplosion; // 0x1730            
            float m_flFadeToBlackTime; // 0x1734            
            ...
            char m_SpectatingProjectileParticle[0xe0]; // 0x1738            
            ...
            char m_GuidedArrowChannelParticle[0xe0]; // 0x18f8            
            ...
            char m_ProjectileModel[0xe0]; // 0x19d8            
            float m_ArrowOffsetX; // 0x1ab8            
            float m_ArrowCameraDistance; // 0x1abc            
            float m_ArrowCameraHeightOffset; // 0x1ac0            
            float m_ArrowInitialPitch; // 0x1ac4            
            ...
            char m_GuidingModifier[0x10]; // 0x1ac8            
            ...
            char m_KillCheckModifier[0x10]; // 0x1ae8            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strExplodeSound; // 0x1af8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flTrackAmount; // 0x1b08            
            float m_flSpeedAccel; // 0x1b0c            
            float m_flSpeedDeccel; // 0x1b10            
            float m_flBaseProjectileSpeed; // 0x1b14            
            float m_flMaxProjectileSpeed; // 0x1b18            
            float m_flArrowModelTurnSpringStrength; // 0x1b1c            
            float m_flKillCheckWindow; // 0x1b20            
            float m_flWorldCollideGraceWindow; // 0x1b24            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityGuidedArrowVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityGuidedArrowVData) == 0x1b28);
    };
};
