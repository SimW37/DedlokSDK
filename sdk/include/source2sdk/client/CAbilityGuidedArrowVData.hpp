...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraCancelledTransitionBacktoArcher; // 0x15f0            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraExplodedTransitionBackToArcher; // 0x1678            
        ...
        static_assert(sizeof(source2sdk::client::CAbilityGuidedArrowVData) == 0x1af8);
    };
};
