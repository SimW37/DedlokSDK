...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_RocketBarrageVolleyVData : public client::CCitadelModifierVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_RocketBarrageVolleyVData) == 0x830);
};
