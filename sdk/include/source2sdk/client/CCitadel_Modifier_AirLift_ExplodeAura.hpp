...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_AirLift_ExplodeAura : public source2sdk::client::CCitadelModifierAura
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_AirLift_ExplodeAura) == 0x108);
    };
};
