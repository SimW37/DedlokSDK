...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Synth_Affliction_Debuff_VData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            char m_EffectParticle[0xe0]; // 0x660            
        ...
        static_assert(sizeof(source2sdk::client::CModifier_Synth_Affliction_Debuff_VData) == 0x820);
    };
};
