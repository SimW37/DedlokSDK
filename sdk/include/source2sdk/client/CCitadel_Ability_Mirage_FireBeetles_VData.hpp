...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_StatStealModifier[0x10]; // 0x16e8            
            ...
            char m_StealWatcherModifier[0x10]; // 0x16f8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_ExplosionSound; // 0x1708            
            CSoundEventName m_strHitConfirm; // 0x1718            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Mirage_FireBeetles_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Mirage_FireBeetles_VData) == 0x1728);
    };
};
