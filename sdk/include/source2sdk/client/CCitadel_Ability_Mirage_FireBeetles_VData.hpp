...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_StatStealModifier[0x10]; // 0x1720            
            ...
            char m_StealWatcherModifier[0x10]; // 0x1730            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_ExplosionSound; // 0x1740            
            CSoundEventName m_strHitConfirm; // 0x1750            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Mirage_FireBeetles_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Mirage_FireBeetles_VData) == 0x1760);
    };
};
