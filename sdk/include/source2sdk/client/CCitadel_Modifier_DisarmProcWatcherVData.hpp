...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_DisarmProcWatcherVData : public source2sdk::client::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_DisarmProcModifier;
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_DisarmProcWatcherVData) == 0x7a0);
    };
};
