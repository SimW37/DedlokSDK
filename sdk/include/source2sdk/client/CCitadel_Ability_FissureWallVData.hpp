...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_FriendlyWallParticle[0xe0]; // 0x15e8            
            ...
            char m_EnemyWallParticle[0xe0]; // 0x16c8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_WallTravelSoundLoop; // 0x17a8            
            ...
            char m_WallModifier[0x10]; // 0x17b8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_FissureWallVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_FissureWallVData) == 0x17c8);
    };
};
