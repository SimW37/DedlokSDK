...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_FriendlyWallParticle[0xe0]; // 0x15c8        
        ...
        char m_EnemyWallParticle[0xe0]; // 0x16a8        
