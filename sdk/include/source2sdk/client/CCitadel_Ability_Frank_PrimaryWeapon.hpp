...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            uint8_t _pad0fa0[0x8]; // 0xfa0
            source2sdk::client::C_CitadelPlayerPawn* m_pNextShooter; // 0xfa8            
            uint8_t _pad0fb0[0x88];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Frank_PrimaryWeapon because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Frank_PrimaryWeapon) == 0x1038);
    };
};
