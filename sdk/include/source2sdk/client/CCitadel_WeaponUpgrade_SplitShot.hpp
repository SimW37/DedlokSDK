...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ShotID_t m_nLastShotID; // 0xd88            
            source2sdk::client::ShotID_t m_nLastHitShotID; // 0xd8c            
            std::int32_t m_nWpnBatchCount; // 0xd90            
            uint8_t _pad0d94[0x6c]; // 0xd94
            source2sdk::client::ShotID_t m_nLastBulletHitShotID; // 0xe00            
            std::int32_t m_nLastBulletHitCount; // 0xe04            
            ...
            char m_eLastBulletHitEnt[0x4]; // 0xe08            
            // metadata: MNetworkEnable
            bool m_bSplitShotActive; // 0xe0c            
            uint8_t _pad0e0d[0x183];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_SplitShot because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_WeaponUpgrade_SplitShot) == 0xf90);
    };
};
