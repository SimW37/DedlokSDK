...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ZipLineEnemyKnockdownProtectionParticle[0xe0]; // 0x658        
        ...
        char m_ZipLineSelfKnockdownProtectionParticle[0xe0]; // 0x738        
        ...
        char m_ZipLineKnockdownProtectionStatusParticle[0xe0]; // 0x818        
        ...
        char m_ZipLineKnockdownProtectionStatusEnemyParticle[0xe0]; // 0x8f8        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Modifier_ZiplineKnockdownImmuneVData) == 0x9d8);
};
