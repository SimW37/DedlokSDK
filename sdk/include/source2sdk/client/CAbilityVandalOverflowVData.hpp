...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_LiftModifier[0x10]; // 0x15e8            
            ...
            char m_TargetParticle[0xe0]; // 0x15f8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_TargetCastSound; // 0x16d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityVandalOverflowVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityVandalOverflowVData) == 0x16e8);
    };
};
