...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbilityVandalOverflowVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_LiftModifier[0x10]; // 0x1620            
            ...
            char m_TargetParticle[0xe0]; // 0x1630            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_TargetCastSound; // 0x1710            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityVandalOverflowVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityVandalOverflowVData) == 0x1720);
    };
};
