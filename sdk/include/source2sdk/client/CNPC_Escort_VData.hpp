...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CNPC_Escort_VData : public source2sdk::client::CAI_CitadelNPCVData
        {
        public:
            ...
            char m_strSpawnParticle[0xe0]; // 0x1338            
            ...
            float m_flActivateDelay; // 0x1430            
        ...
        static_assert(sizeof(source2sdk::client::CNPC_Escort_VData) == 0x1438);
    };
};
