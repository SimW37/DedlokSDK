...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Wrecker_UltimateThrowEnemyVData : public source2sdk::client::CCitadel_Modifier_StunnedVData
        {
        public:
            ...
            char m_EnemyHeroStasisEffect[0xe0]; // 0x740            
            ...
            char m_EnemyHeroGrabEffect[0xe0]; // 0x820            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifier_Wrecker_UltimateThrowEnemyVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CModifier_Wrecker_UltimateThrowEnemyVData) == 0x900);
    };
};
