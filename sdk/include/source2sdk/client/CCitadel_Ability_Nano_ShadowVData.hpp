...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ShadowModifier[0x10]; // 0x15c8        
        ...
        char m_PurgeModifier[0x10]; // 0x15d8        
