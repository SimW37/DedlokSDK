...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            uint8_t _pad0ee0[0x10]; // 0xee0
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            source2sdk::client::DoorState_t m_eDoorState; // 0xef0            
            // metadata: MNotSaved
            bool m_modelChanged; // 0xef4            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            bool m_bLocked; // 0xef5            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            bool m_bNoNPCs; // 0xef6            
            uint8_t _pad0ef7[0x1]; // 0xef7
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            Vector m_closedPosition; // 0xef8            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            QAngle m_closedAngles; // 0xf04            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            ...
            char m_hMaster[0x4]; // 0xf10            
            // metadata: MNotSaved
            Vector m_vWhereToSetLightingOrigin; // 0xf14            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_BasePropDoor because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_BasePropDoor) == 0xf20);
    };
};
