...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CRemapFloat m_speedToPitchRemap; // 0x660            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadelModifierProjectilePitchingLoopSoundThinkerVData) == 0x670);
    };
};
