...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            CPiecewiseCurve m_CrashSpeedScaleCurve; // 0x1618            
            ...
            char m_ActiveModifier[0x10]; // 0x1658            
            ...
            char m_BoostModifier[0x10]; // 0x1668            
            ...
            char m_CrashModifier[0x10]; // 0x1678            
            ...
            char m_ImmunityModifier[0x10]; // 0x1688            
            ...
            char m_LandingBonusesModifier[0x10]; // 0x1698            
            ...
            char m_TakeOffParticle[0xe0]; // 0x16a8            
            // m_ImpactParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ImpactParticle;
            char m_ImpactParticle[0xe0]; // 0x1788            
            ...
            char m_AoEPreviewParticle[0xe0]; // 0x1868            
            ...
            char m_HoverParticle[0xe0]; // 0x1948            
            ...
            char m_DivingPreviewParticle[0xe0]; // 0x1a28            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strCrashingSound; // 0x1b08            
            CSoundEventName m_strImpactSound; // 0x1b18            
            // metadata: MPropertyStartGroup "GamePlay"
            float m_flStartupTime; // 0x1b28            
            float m_flForwardBoostSpeed; // 0x1b2c            
            float m_flUpBoostSpeed; // 0x1b30            
            float m_flBoostTurnRate; // 0x1b34            
            float m_flHoverTime; // 0x1b38            
            float m_flMinAimAngle; // 0x1b3c            
            float m_flBoostGain; // 0x1b40            
            float m_flBoostTime; // 0x1b44            
            float m_flLandingTime; // 0x1b48            
            float m_flCrashSpeed; // 0x1b4c            
            float m_flCrashBraceAnimTime; // 0x1b50            
            float m_flHoverInputSpeedMax; // 0x1b54            
            float m_flHoverInputAcceleration; // 0x1b58            
            float m_flHoverSpeedDecay; // 0x1b5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Bull_LeapVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Bull_LeapVData) == 0x1b60);
    };
};
