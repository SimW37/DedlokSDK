...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BoostModifier[0x10]; // 0x1608        
        ...
        char m_CrashModifier[0x10]; // 0x1618        
        ...
        char m_LandingBonusesModifier[0x10]; // 0x1638        
        ...
        char m_TakeOffParticle[0xe0]; // 0x1648        
        ...
        char m_AoEPreviewParticle[0xe0]; // 0x1808        
        ...
        char m_nHoverParticle[0xe0]; // 0x18e8        
