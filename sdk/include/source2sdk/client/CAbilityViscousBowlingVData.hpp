...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_TransformStartFx[0xe0]; // 0x15c8        
        ...
        char m_WallImpactFx[0xe0]; // 0x1788        
        ...
        char m_BallTrailFx[0xe0]; // 0x1868        
        ...
        char m_GroundImpactParticle[0xe0]; // 0x1948        
        ...
        char m_JumpParticle[0xe0]; // 0x1a28        
        ...
        char m_DirectionParticle[0xe0]; // 0x1b08        
        ...
        char m_ImpactModifier[0x10]; // 0x1c68        
        ...
        char m_DamagePreventionModifier[0x10]; // 0x1c78        
        ...
        char m_RollingModifier[0x10]; // 0x1c88        
    ...
    static_assert(sizeof(CAbilityViscousBowlingVData) == 0x1cd0);
};
