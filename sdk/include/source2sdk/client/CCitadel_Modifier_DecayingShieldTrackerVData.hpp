...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_DecayingShieldTrackerVData : public client::CCitadelModifierVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_TechImpactModifier;
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_ProcEffectModifier;
