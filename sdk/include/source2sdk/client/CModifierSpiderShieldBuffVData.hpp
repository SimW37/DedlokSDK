...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CModifierSpiderShieldBuffVData : public client::CCitadelModifierVData
    {
    public:
        ...
        char m_BuffParticle[0xe0]; // 0x658        
        ...
        char m_RadiusParticle[0xe0]; // 0x738        
        ...
        char m_PulseParticle[0xe0]; // 0x818        
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_PulseDebuffModifier;
        char m_PulseDebuffModifier[0x10]; // 0x8f8        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CModifierSpiderShieldBuffVData because it is not a standard-layout class
    static_assert(sizeof(CModifierSpiderShieldBuffVData) == 0x908);
};
