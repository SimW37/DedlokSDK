...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_RadiusParticle[0xe0]; // 0x740        
        ...
        char m_PulseParticle[0xe0]; // 0x820        
