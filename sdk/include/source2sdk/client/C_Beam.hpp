...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flFrameRate; // 0x9a0            
            // metadata: MNetworkEnable
            float m_flHDRColorScale; // 0x9a4            
            source2sdk::entity2::GameTime_t m_flFireTime; // 0x9a8            
            float m_flDamage; // 0x9ac            
            // metadata: MNetworkEnable
            std::uint8_t m_nNumBeamEnts; // 0x9b0            
            uint8_t _pad09b1[0x3]; // 0x9b1
            // metadata: MNotSaved
            std::int32_t m_queryHandleHalo; // 0x9b4            
            uint8_t _pad09b8[0x20]; // 0x9b8
            // metadata: MNetworkEnable
            ...
            char m_hBaseMaterial[0x8]; // 0x9d8            
            // metadata: MNetworkEnable
            ...
            char m_nHaloIndex[0x8]; // 0x9e0            
            // metadata: MNetworkEnable
            source2sdk::client::BeamType_t m_nBeamType; // 0x9e8            
            // metadata: MNetworkEnable
            std::uint32_t m_nBeamFlags; // 0x9ec            
            // metadata: MNetworkEnable
            ...
            char m_hAttachEntity[0x28]; // 0x9f0            
            // metadata: MNetworkEnable
            source2sdk::modellib::AttachmentHandle_t m_nAttachIndex[10]; // 0xa18            
            ...
            // metadata: MNetworkEncodeFlags "2"
            float m_fWidth; // 0xa24            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "10"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "102,300003"
            // metadata: MNetworkEncodeFlags "2"
            float m_fEndWidth; // 0xa28            
            // metadata: MNetworkEnable
            float m_fFadeLength; // 0xa2c            
            // metadata: MNetworkEnable
            float m_fHaloScale; // 0xa30            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "64,000000"
            // metadata: MNetworkEncodeFlags "1"
            float m_fAmplitude; // 0xa34            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "256,000000"
            // metadata: MNetworkEncodeFlags "1"
            float m_fStartFrame; // 0xa38            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "100,000000"
            float m_fSpeed; // 0xa3c            
            // metadata: MNetworkEnable
            ...
            float m_flFrame; // 0xa40            
            // metadata: MNetworkEnable
            source2sdk::client::BeamClipStyle_t m_nClipStyle; // 0xa44            
            // metadata: MNetworkEnable
            bool m_bTurnedOff; // 0xa48            
            uint8_t _pad0a49[0x3]; // 0xa49
            // metadata: MNetworkEnable
            // metadata: MNetworkEncoder "coord"
            VectorWS m_vecEndPos; // 0xa4c            
        ...
        static_assert(sizeof(source2sdk::client::C_Beam) == 0xa60);
    };
};
