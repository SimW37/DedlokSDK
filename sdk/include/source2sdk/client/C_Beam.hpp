...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x848[0x20]; // 0x848
        // metadata: MNetworkEnable
        ...
        char m_hBaseMaterial[0x8]; // 0x868        
        // metadata: MNetworkEnable
        ...
        char m_hAttachEntity[0x28]; // 0x880        
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0x8d9[0x3]; // 0x8d9
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(C_Beam) == 0x8f0);
};
