...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Bookworm_AOEMagic_AreaModifierVData : public client::CCitadelModifierVData
    {
    public:
        ...
        char m_RootModifier[0x10]; // 0x670        
        ...
        char m_AreaWarningEffect[0xe0]; // 0x680        
        ...
        char m_ExplodeEffect[0xe0]; // 0x760        
    ...
    static_assert(sizeof(CCitadel_Modifier_Bookworm_AOEMagic_AreaModifierVData) == 0x880);
};
