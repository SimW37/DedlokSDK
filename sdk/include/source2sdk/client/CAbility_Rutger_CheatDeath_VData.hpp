...
namespace source2sdk::client
{
    ...
    public:
        ...
        // CEmbeddedSubclass<client::CBaseModifier> m_ModifierCheatDeathActivated;
        char m_ModifierCheatDeathActivated[0x10]; // 0x15c8        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbility_Rutger_CheatDeath_VData because it is not a standard-layout class
    static_assert(sizeof(CAbility_Rutger_CheatDeath_VData) == 0x15d8);
};
