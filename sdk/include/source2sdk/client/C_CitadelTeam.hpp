...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::int32_t m_vecBaseLocationX; // 0x69c            
            // metadata: MNetworkEnable
            std::int32_t m_vecBaseLocationY; // 0x6a0            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nBossesAlive; // 0x6ac            
            // metadata: MNetworkEnable
            std::int32_t m_nBossesMax; // 0x6b0            
            // metadata: MNetworkEnable
            source2sdk::client::EFlexSlotTypes_t m_nFlexSlotsUnlocked; // 0x6b4            
            uint8_t _pad06b6[0x2]; // 0x6b6
            // metadata: MNetworkEnable
            std::int32_t m_nBaseGuardianLanesCleared; // 0x6b8            
        ...
        static_assert(sizeof(source2sdk::client::C_CitadelTeam) == 0x728);
    };
};
