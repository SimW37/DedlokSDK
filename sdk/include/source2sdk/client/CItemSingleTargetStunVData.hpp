...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CItemSingleTargetStunVData : public source2sdk::client::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_StunDelayModifier;
            char m_StunDelayModifier[0x10]; // 0x1678            
        ...
        static_assert(sizeof(source2sdk::client::CItemSingleTargetStunVData) == 0x1768);
    };
};
