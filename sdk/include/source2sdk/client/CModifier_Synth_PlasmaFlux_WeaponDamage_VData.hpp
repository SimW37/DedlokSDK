...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Synth_PlasmaFlux_WeaponDamage_VData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CModifier_Synth_PlasmaFlux_WeaponDamage_VData) == 0x740);
    };
};
