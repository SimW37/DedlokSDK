...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecSpecialShots[0x18]; // 0xfd8            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            std::int32_t m_nFastFireBulletsLeft; // 0xff0            
            uint8_t _pad0ff4[0x4]; // 0xff4
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            source2sdk::client::CCitadelAutoScaledTime m_flBlitzEndTime; // 0xff8            
            bool m_bCanApplyTechAmp; // 0x1010            
            bool m_bCanLifesteal; // 0x1011            
            uint8_t _pad1012[0x316];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Synth_Blitz because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbility_Synth_Blitz) == 0x1328);
    };
};
