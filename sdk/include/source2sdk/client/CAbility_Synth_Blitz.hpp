...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_nFastFireBulletsLeft; // 0xdd8            
            uint8_t _pad0ddc[0x4]; // 0xddc
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            source2sdk::client::CCitadelAutoScaledTime m_flBlitzEndTime; // 0xde0            
            bool m_bCanApplyTechAmp; // 0xdf8            
            bool m_bCanLifesteal; // 0xdf9            
            uint8_t _pad0dfa[0x1c6];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Synth_Blitz because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbility_Synth_Blitz) == 0xfc0);
    };
};
