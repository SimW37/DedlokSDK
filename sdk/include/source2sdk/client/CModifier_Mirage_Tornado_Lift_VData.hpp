...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Mirage_Tornado_Lift_VData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CBaseModifier> m_HoldInPlaceModifier;
        ...
        static_assert(sizeof(source2sdk::client::CModifier_Mirage_Tornado_Lift_VData) == 0x750);
    };
};
