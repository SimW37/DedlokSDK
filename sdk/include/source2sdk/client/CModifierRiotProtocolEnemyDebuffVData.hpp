...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifierRiotProtocolEnemyDebuffVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CModifierRiotProtocolEnemyDebuffVData) == 0x740);
    };
};
