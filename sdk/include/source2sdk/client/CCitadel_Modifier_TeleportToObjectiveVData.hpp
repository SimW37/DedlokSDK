...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_TeleportOriginParticle[0xe0]; // 0x658        
        ...
        char m_TeleportDestinationParticle[0xe0]; // 0x738        
    ...
    static_assert(sizeof(CCitadel_Modifier_TeleportToObjectiveVData) == 0x848);
};
