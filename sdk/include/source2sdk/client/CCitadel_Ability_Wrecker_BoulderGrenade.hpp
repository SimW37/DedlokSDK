...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hHitTroopers[0x18]; // 0xd88            
            uint8_t _pad0da0[0x4]; // 0xda0
            source2sdk::client::ParticleIndex_t m_nBallParticle; // 0xda4            
            uint8_t _pad0da8[0x180];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Wrecker_BoulderGrenade because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Wrecker_BoulderGrenade) == 0xf28);
    };
};
