...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::AbilityPropertyInfo_t, m_strImportantProperty) == 0x0);
        static_assert(offsetof(source2sdk::client::AbilityPropertyInfo_t, m_bRequiresAbilityUpgrade) == 0x8);
        static_assert(offsetof(source2sdk::client::AbilityPropertyInfo_t, m_strStatusEffectValue) == 0x10);
        static_assert(offsetof(source2sdk::client::AbilityPropertyInfo_t, m_bShowPropertyValue) == 0x18);
        
        static_assert(sizeof(source2sdk::client::AbilityPropertyInfo_t) == 0x20);
    };
};
