...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flZiplineAirDrag; // 0x15f0            
            float m_flMinButtonHoldTimeToActivate; // 0x15f4            
            float m_flCrouchDropSpeedFraction; // 0x15f8            
            float m_flCrouchDropAirDragSuppressDuration; // 0x15fc            
            float m_flDetachDisallowedTime; // 0x1600            
            float m_flCameraWobbleIntensity; // 0x1604            
            float m_flDismountSpeedMax; // 0x1608            
            // metadata: MPropertyDescription "The DOF settings to apply while riding the zipline."
            source2sdk::client::DOFDesc_t m_DOFWhileZiplining; // 0x160c            
            ...
            char m_ZipLinePreviewParticle[0xe0]; // 0x1620            
            ...
            char m_ZipLineSpeedParticle[0xe0]; // 0x1700            
            ...
            char m_ZipLineTetherParticle[0xe0]; // 0x17e0            
            ...
            char m_ZipLineTetherAttachParticle[0xe0]; // 0x18c0            
            ...
            char m_ZipLineTetherStartParticle[0xe0]; // 0x19a0            
            ...
            char m_ZipLineEnemyKnockdownProtectionParticle[0xe0]; // 0x1a80            
            ...
            char m_ZipLineSelfKnockdownProtectionParticle[0xe0]; // 0x1b60            
            ...
            char m_ZipLineKnockdownProtectionStatusParticle[0xe0]; // 0x1c40            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strZipLineSummonSound; // 0x1d20            
            CSoundEventName m_strZipLineLatchedSound; // 0x1d30            
            CSoundEventName m_strZipLineStartSound; // 0x1d40            
            ...
            char m_RidingZipLineModifier[0x10]; // 0x1d50            
            ...
            char m_KnockedOffSlowModifier[0x10]; // 0x1d60            
            ...
            char m_ZipLineIntroModifier[0x10]; // 0x1d70            
            ...
            char m_ZipLineKnockdownImmuneModifier[0x10]; // 0x1d80            
            ...
            char m_ZipLineSlowModifier[0x10]; // 0x1d90            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceAwaitingTether; // 0x1da0            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceLatched; // 0x1e28            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceAttached; // 0x1eb0            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceClear; // 0x1f38            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ZipLine_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ZipLine_VData) == 0x1fc0);
    };
};
