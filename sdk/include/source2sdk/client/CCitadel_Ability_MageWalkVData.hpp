...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_MageWalkVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            char m_BubbleModifier[0x10]; // 0x15e8            
            ...
            // CEmbeddedSubclass<source2sdk::client::CBaseModifier> m_TurretModifier;
            char m_TurretModifier[0x10]; // 0x15f8            
            ...
            char m_strCastEffect[0xe0]; // 0x1608            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_MageWalkVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_MageWalkVData) == 0x16e8);
    };
};
