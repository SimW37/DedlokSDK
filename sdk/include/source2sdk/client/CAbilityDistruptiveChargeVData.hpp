...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbilityDistruptiveChargeVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CAbilityDistruptiveChargeVData) == 0x16d8);
    };
};
