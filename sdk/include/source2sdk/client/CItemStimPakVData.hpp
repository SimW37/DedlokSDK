...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CItemStimPakVData : public source2sdk::client::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_StimPakModifier;
            char m_StimPakModifier[0x10]; // 0x16a8            
        ...
        static_assert(sizeof(source2sdk::client::CItemStimPakVData) == 0x1798);
    };
};
