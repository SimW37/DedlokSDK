...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BarrageCasterModifier[0x10]; // 0x15f0        
        ...
        char m_AmpModifier[0x10]; // 0x1600        
        ...
        CSoundEventName m_strProjectileLaunchSound; // 0x18c0        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flAttackInterval; // 0x18d0        
        [[maybe_unused]] std::uint8_t pad_0x18d4[0x4];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbility_Synth_Barrage_VData because it is not a standard-layout class
    static_assert(sizeof(CAbility_Synth_Barrage_VData) == 0x18d8);
};
