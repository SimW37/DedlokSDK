...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_BarrageCasterModifier[0x10]; // 0x1620            
            ...
            char m_AmpModifier[0x10]; // 0x1630            
            ...
            char m_ChannelParticle[0xe0]; // 0x1810            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strProjectileLaunchSound; // 0x18f0            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flAttackInterval; // 0x1900            
        ...
        static_assert(sizeof(source2sdk::client::CAbility_Synth_Barrage_VData) == 0x1908);
    };
};
