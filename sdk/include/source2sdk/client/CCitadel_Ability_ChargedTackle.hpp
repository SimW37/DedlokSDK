...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            uint8_t _pad1002[0x2]; // 0x1002
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flTackleStartTime; // 0x1004            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flPrepareStartTime; // 0x1008            
            // metadata: MNetworkEnable
            Vector m_vecTackleDir; // 0x100c            
            Vector m_vecLastPosition; // 0x1018            
            std::int32_t m_nStuckFramesCount; // 0x1024            
            ...
            source2sdk::client::ParticleIndex_t m_nDistancePreview; // 0x1040            
            uint8_t _pad1044[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ChargedTackle because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ChargedTackle) == 0x1048);
    };
};
