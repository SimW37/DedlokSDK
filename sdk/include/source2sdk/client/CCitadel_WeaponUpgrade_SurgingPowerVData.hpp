...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_WeaponUpgrade_SurgingPowerVData : public source2sdk::client::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_ModifierSurgingPower;
            char m_ModifierSurgingPower[0x10]; // 0x1680            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_WeaponUpgrade_SurgingPowerVData) == 0x1770);
    };
};
