...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_StackNotificationModifier[0x10]; // 0x16b0            
            ...
            char m_OnCastModifier[0x10]; // 0x16c0            
            ...
            char m_RegenParticle[0xe0]; // 0x16d0            
            ...
            char m_ProcParticle[0xe0]; // 0x17b0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItem_ResonantHealing_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CItem_ResonantHealing_VData) == 0x1890);
    };
};
