...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_StackNotificationModifier[0x10]; // 0x1680            
            ...
            char m_OnCastModifier[0x10]; // 0x1690            
            ...
            char m_RegenParticle[0xe0]; // 0x16a0            
            ...
            char m_ProcParticle[0xe0]; // 0x1780            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItem_ResonantHealing_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CItem_ResonantHealing_VData) == 0x1860);
    };
};
