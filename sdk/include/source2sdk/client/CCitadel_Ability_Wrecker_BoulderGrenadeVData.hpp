...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Wrecker_BoulderGrenadeVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            ...
            CSoundEventName m_ExplodeSound; // 0x18c8            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Wrecker_BoulderGrenadeVData) == 0x18d8);
    };
};
