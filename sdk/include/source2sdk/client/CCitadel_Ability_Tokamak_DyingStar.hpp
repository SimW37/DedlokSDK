...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nRollFXIndex; // 0xd88            
            // metadata: MNetworkEnable
            bool m_bInFlight; // 0xd8c            
            uint8_t _pad0d8d[0x103];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Tokamak_DyingStar because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Tokamak_DyingStar) == 0xe90);
    };
};
