...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nRollFXIndex; // 0xdc0            
            // metadata: MNetworkEnable
            bool m_bInFlight; // 0xdc4            
            uint8_t _pad0dc5[0x103];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Tokamak_DyingStar because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Tokamak_DyingStar) == 0xec8);
    };
};
