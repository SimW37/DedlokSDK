...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Magician_AnimalHex_HexAreaVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_HexModifier;
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Magician_AnimalHex_HexAreaVData) == 0x870);
    };
};
