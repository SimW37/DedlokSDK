...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Priest_KnockbackVData : public client::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_KnockbackToWallModifier;
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_KnockbackModifier;
