...
namespace source2sdk::client
{
    ...
    {
    public:
        client::ParticleIndex_t m_nLaserParticleIndex; // 0x890        
        Vector m_vecSmoothedVelocity; // 0x894        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(C_Citadel_Projectile_Tier2Boss_RocketBarrage) == 0x8a0);
};
