...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_strAreaEffectEnemy[0xe0]; // 0x6a0        
        ...
        char m_strAreaEffectFriendly[0xe0]; // 0x780        
