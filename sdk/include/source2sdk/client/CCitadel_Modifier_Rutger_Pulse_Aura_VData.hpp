...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Rutger_Pulse_Aura_VData : public client::CCitadelModifierAuraVData
    {
    public:
