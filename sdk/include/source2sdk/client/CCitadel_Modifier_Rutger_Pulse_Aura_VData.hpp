...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Rutger_Pulse_Aura_VData : public source2sdk::client::CCitadelModifierAuraVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Rutger_Pulse_Aura_VData) == 0x790);
    };
};
