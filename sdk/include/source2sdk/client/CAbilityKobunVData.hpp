...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbilityKobunVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
            Vector m_vSummonFollowOffset; // 0x1618            
            ...
            char m_CloneModifier[0x10]; // 0x1628            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityKobunVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityKobunVData) == 0x1638);
    };
};
