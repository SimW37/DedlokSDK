...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_EnemyGrabModifier[0x10]; // 0x658        
        ...
        char m_EnemyThrowModifier[0x10]; // 0x668        
        ...
        char m_EnemyDamageModifier[0x10]; // 0x678        
        ...
        char m_InvincibleModifier[0x10]; // 0x688        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_StartSound; // 0x698        
        CSoundEventName m_AmbientLoopingSound; // 0x6a8        
        CSoundEventName m_GrabSound; // 0x6b8        
        CSoundEventName m_ThrowSound; // 0x6c8        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CModifier_Wrecker_UltimateVData because it is not a standard-layout class
    static_assert(sizeof(CModifier_Wrecker_UltimateVData) == 0x6d8);
};
