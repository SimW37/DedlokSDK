...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_PulseParticle[0xe0]; // 0x1668        
        ...
        char m_TargetParticle[0xe0]; // 0x1748        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strPulseTickSound; // 0x1828        
        // metadata: MPropertyStartGroup "Gameplay"
        int32_t m_iMaxTargets; // 0x1838        
    ...
    static_assert(sizeof(CCitadel_Item_TechDamagePulseVData) == 0x1840);
};
