...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_DragonFireGroundAuraVData : public source2sdk::client::CCitadelModifierAuraVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_DragonFireGroundAuraVData) == 0x898);
    };
};
