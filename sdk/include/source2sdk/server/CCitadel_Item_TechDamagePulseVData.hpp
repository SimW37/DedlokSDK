...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_PulseParticle[0xe0]; // 0x16a8            
            ...
            char m_TargetParticle[0xe0]; // 0x1788            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strPulseTickSound; // 0x1868            
            // metadata: MPropertyStartGroup "Gameplay"
            std::int32_t m_iMaxTargets; // 0x1878            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Item_TechDamagePulseVData) == 0x1880);
    };
};
