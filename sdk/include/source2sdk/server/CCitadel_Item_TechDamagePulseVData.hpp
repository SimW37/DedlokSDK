...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_PulseParticle[0xe0]; // 0x16b0            
            ...
            char m_TargetParticle[0xe0]; // 0x1790            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strPulseTickSound; // 0x1870            
            // metadata: MPropertyStartGroup "Gameplay"
            std::int32_t m_iMaxTargets; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Item_TechDamagePulseVData) == 0x1888);
    };
};
