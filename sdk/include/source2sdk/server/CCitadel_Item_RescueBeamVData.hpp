...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_RescueBeamVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_DispelAndHealModifier;
            char m_DispelAndHealModifier[0x10]; // 0x16b0            
            ...
            char m_PullModifier[0x10]; // 0x16c0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_RescueBeamVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Item_RescueBeamVData) == 0x16d0);
    };
};
