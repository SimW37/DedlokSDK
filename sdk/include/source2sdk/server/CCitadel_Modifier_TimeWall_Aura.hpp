...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xe8[0x70]; // 0xe8
        ...
        char m_vecTimeWarps[0x18]; // 0x158        
        [[maybe_unused]] std::uint8_t pad_0x170[0x18];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Modifier_TimeWall_Aura because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Modifier_TimeWall_Aura) == 0x188);
};
