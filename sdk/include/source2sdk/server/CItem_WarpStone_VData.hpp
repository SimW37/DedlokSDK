...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CasterModifier[0x10]; // 0x1678            
            ...
            char m_CasterDebuffModifier[0x10]; // 0x1688            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strExplodeSound; // 0x1698            
            ...
            char m_CastDelayParticle[0xe0]; // 0x16a8            
            ...
            char m_TeleportTrailParticle[0xe0]; // 0x1788            
            // metadata: MPropertyGroupName "Gameplay"
            float m_flGroundProbeSpeed; // 0x1868            
            float m_flGroundStepDown; // 0x186c            
            float m_flGroundStepUp; // 0x1870            
            std::int32_t m_iMaxGroundIterations; // 0x1874            
            float m_flVelocityScale; // 0x1878            
        ...
        static_assert(sizeof(source2sdk::server::CItem_WarpStone_VData) == 0x1880);
    };
};
