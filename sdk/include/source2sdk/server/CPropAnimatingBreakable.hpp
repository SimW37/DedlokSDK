...
namespace source2sdk::server
{
    ...
    {
    public:
        client::CBreakableStageHelper m_stages; // 0xab8        
        entity2::CEntityIOOutput m_OnTakeDamage; // 0xad0        
        entity2::CEntityIOOutput m_OnFinalBreak; // 0xaf8        
        entity2::CEntityIOOutput m_OnStageAdvanced; // 0xb20        
    ...
    static_assert(sizeof(CPropAnimatingBreakable) == 0xb48);
};
