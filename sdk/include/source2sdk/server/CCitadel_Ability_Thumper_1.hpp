...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vecAimPos; // 0xfa8            
            Vector m_vecAimNormal; // 0xfb4            
            float m_flPushForce; // 0xfc0            
            uint8_t _pad0fc4[0x384];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Thumper_1 because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Thumper_1) == 0x1348);
    };
};
