...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Nano_Pounce : public source2sdk::server::CCitadelBaseAbility
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Nano_Pounce) == 0x1500);
    };
};
