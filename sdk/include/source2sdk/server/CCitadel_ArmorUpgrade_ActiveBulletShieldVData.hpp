...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_ArmorUpgrade_ActiveBulletShieldVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_TempShieldModifier;
            char m_TempShieldModifier[0x10]; // 0x16a8            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_ActiveBulletShieldVData) == 0x16b8);
    };
};
