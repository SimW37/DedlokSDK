...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_TempShieldModifier;
        char m_TempShieldModifier[0x10]; // 0x1668        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_ArmorUpgrade_ActiveBulletShieldVData) == 0x1678);
};
