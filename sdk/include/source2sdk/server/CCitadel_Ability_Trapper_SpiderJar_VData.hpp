...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_SpiderExplodeParticle[0xe0]; // 0x15c8        
        ...
        char m_JarExplodeParticle[0xe0]; // 0x16a8        
