...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_WeaponBuffModifier;
            char m_WeaponBuffModifier[0x10]; // 0x660            
            ...
            char m_AbilityWatcherModifier[0x10]; // 0x670            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifier_Upgrade_ArcaneSurge_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CModifier_Upgrade_ArcaneSurge_VData) == 0x680);
    };
};
