...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CModifier_Synth_PlasmaFlux_WeaponDamage_VData : public server::CCitadelModifierVData
    {
    public:
    ...
    static_assert(sizeof(CModifier_Synth_PlasmaFlux_WeaponDamage_VData) == 0x738);
};
