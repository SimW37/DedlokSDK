...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Synth_PlasmaFlux_WeaponDamage_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CModifier_Synth_PlasmaFlux_WeaponDamage_VData) == 0x740);
    };
};
