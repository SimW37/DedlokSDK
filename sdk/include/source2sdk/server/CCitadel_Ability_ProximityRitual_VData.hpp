...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_PredatoryStatueModel[0xe0]; // 0x1618            
            ...
            char m_CatReappearParticle[0xe0]; // 0x16f8            
            ...
            char m_CatDisappearParticle[0xe0]; // 0x17d8            
            ...
            char m_CatEyesParticle[0xe0]; // 0x18b8            
            ...
            char m_CatSummonParticle[0xe0]; // 0x1998            
            ...
            char m_CatRecallParticle[0xe0]; // 0x1a78            
            ...
            char m_RecallLineParticle[0xe0]; // 0x1b58            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strRecallSound; // 0x1c38            
            CSoundEventName m_strKilledSound; // 0x1c48            
            ...
            char m_PredatoryStatueModifier[0x10]; // 0x1c58            
            ...
            char m_RecentDamageModifier[0x10]; // 0x1c68            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flHeavyMeleeDmg; // 0x1c78            
            float m_flLightMeleeDmg; // 0x1c7c            
            float m_flAbilityDamageScale; // 0x1c80            
            float m_flNPCDamageScale; // 0x1c84            
            float m_flCastDelayMin; // 0x1c88            
            float m_flCastDelayMax; // 0x1c8c            
            float m_flCastDelayMaxDist; // 0x1c90            
            float m_flPostCastCooldown; // 0x1c94            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ProximityRitual_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ProximityRitual_VData) == 0x1c98);
    };
};
