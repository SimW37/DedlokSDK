...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad0b20[0x14]; // 0xb20
            // metadata: MNotSaved
            bool m_bHasTriggerRadius; // 0xb34            
            // metadata: MNotSaved
            bool m_bHasPickupRadius; // 0xb35            
            uint8_t _pad0b36[0x2]; // 0xb36
            // metadata: MNotSaved
            float m_flPickupRadiusSqr; // 0xb38            
            // metadata: MNotSaved
            float m_flTriggerRadiusSqr; // 0xb3c            
            // metadata: MNotSaved
            source2sdk::entity2::GameTime_t m_flLastPickupCheck; // 0xb40            
            // metadata: MNotSaved
            bool m_bPlayerCounterListenerAdded; // 0xb44            
            // metadata: MNotSaved
            bool m_bPlayerInTriggerRadius; // 0xb45            
            ...
            char m_hSpawnParticleEffect[0x8]; // 0xb48            
            // metadata: MNotSaved
            CUtlSymbolLarge m_pAmbientSoundEffect; // 0xb50            
            // metadata: MNotSaved
            bool m_bAutoStartAmbientSound; // 0xb58            
            uint8_t _pad0b59[0x7]; // 0xb59
            // metadata: MNotSaved
            CUtlSymbolLarge m_pSpawnScriptFunction; // 0xb60            
            // metadata: MNotSaved
            ...
            char m_hPickupParticleEffect[0x8]; // 0xb68            
            // metadata: MNotSaved
            CUtlSymbolLarge m_pPickupSoundEffect; // 0xb70            
            // metadata: MNotSaved
            CUtlSymbolLarge m_pPickupScriptFunction; // 0xb78            
            // metadata: MNotSaved
            ...
            char m_hTimeoutParticleEffect[0x8]; // 0xb80            
            // metadata: MNotSaved
            CUtlSymbolLarge m_pTimeoutSoundEffect; // 0xb88            
            // metadata: MNotSaved
            CUtlSymbolLarge m_pTimeoutScriptFunction; // 0xb90            
            // metadata: MNotSaved
            CUtlSymbolLarge m_pPickupFilterName; // 0xb98            
            // metadata: MNotSaved
            ...
            char m_hPickupFilter[0x4]; // 0xba0            
            uint8_t _pad0ba4[0x4]; // 0xba4
            source2sdk::entity2::CEntityIOOutput m_OnPickup; // 0xba8            
            source2sdk::entity2::CEntityIOOutput m_OnTimeout; // 0xbc0            
            source2sdk::entity2::CEntityIOOutput m_OnTriggerStartTouch; // 0xbd8            
            source2sdk::entity2::CEntityIOOutput m_OnTriggerTouch; // 0xbf0            
            source2sdk::entity2::CEntityIOOutput m_OnTriggerEndTouch; // 0xc08            
            // metadata: MNotSaved
            CUtlSymbolLarge m_pAllowPickupScriptFunction; // 0xc20            
            // metadata: MNotSaved
            float m_flPickupRadius; // 0xc28            
            // metadata: MNotSaved
            float m_flTriggerRadius; // 0xc2c            
            // metadata: MNotSaved
            CUtlSymbolLarge m_pTriggerSoundEffect; // 0xc30            
            // metadata: MNotSaved
            bool m_bGlowWhenInTrigger; // 0xc38            
            // metadata: MNotSaved
            Color m_glowColor; // 0xc39            
            // metadata: MNotSaved
            bool m_bUseable; // 0xc3d            
            ...
            char m_hTriggerHelper[0x4]; // 0xc40            
        ...
        static_assert(sizeof(source2sdk::server::CItemGeneric) == 0xc50);
    };
};
