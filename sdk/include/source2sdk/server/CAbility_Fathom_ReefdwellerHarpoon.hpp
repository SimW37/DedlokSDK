...
namespace source2sdk::server
{
    ...
    public:
        ...
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flCloseEnoughStartTime; // 0xbc4        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flStuckStartTime; // 0xbc8        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flReelStartTime; // 0xbcc        
        [[maybe_unused]] std::uint8_t pad_0xbd0[0x140];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbility_Fathom_ReefdwellerHarpoon because it is not a standard-layout class
    static_assert(sizeof(CAbility_Fathom_ReefdwellerHarpoon) == 0xd10);
};
