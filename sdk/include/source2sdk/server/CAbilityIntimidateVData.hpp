...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_EnemyModifier[0x10]; // 0x15e8            
            ...
            char m_AoEPlayerParticle[0xe0]; // 0x1608            
