...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityIntimidateVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_EnemyModifier;
            char m_EnemyModifier[0x10]; // 0x1618            
            ...
            char m_AoEPlayerParticle[0xe0]; // 0x1638            
