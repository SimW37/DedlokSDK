...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DeployParticle[0xe0]; // 0x16b0            
            ...
            char m_RespawnParticle[0xe0]; // 0x1790            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_sDeploySound; // 0x1870            
            CSoundEventName m_sRespawnSound; // 0x1880            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_PersonalRejuvenatorVData) == 0x1890);
    };
};
