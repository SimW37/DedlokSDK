...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_BulletWarningParticle[0xe0]; // 0x15e8            
            ...
            char m_ProcWatcherModifier[0x10]; // 0x16c8            
            ...
            char m_VictimWarningModifier[0x10]; // 0x16d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Gunslinger_SalvoVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Gunslinger_SalvoVData) == 0x16e8);
    };
};
