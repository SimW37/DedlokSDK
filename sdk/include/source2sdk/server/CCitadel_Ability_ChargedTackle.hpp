...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bPreparing; // 0x1410            
            // metadata: MNetworkEnable
            bool m_bTackling; // 0x1411            
            uint8_t _pad1412[0x2]; // 0x1412
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flTackleStartTime; // 0x1414            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flPrepareStartTime; // 0x1418            
            // metadata: MNetworkEnable
            Vector m_vecTackleDir; // 0x141c            
            Vector m_vecLastPosition; // 0x1428            
            std::int32_t m_nStuckFramesCount; // 0x1434            
            // m_vecHitEnemies has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CUtlVector<CHandle<source2sdk::server::CBaseEntity>> m_vecHitEnemies;
            char m_vecHitEnemies[0x18]; // 0x1438            
            source2sdk::client::ParticleIndex_t m_nDistancePreview; // 0x1450            
            uint8_t _pad1454[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ChargedTackle because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ChargedTackle) == 0x1458);
    };
};
