...
namespace source2sdk::server
{
    ...
    public:
        ...
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flTackleStartTime; // 0xde4        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flPrepareStartTime; // 0xde8        
        // metadata: MNetworkEnable
        Vector m_vecTackleDir; // 0xdec        
        Vector m_vecLastPosition; // 0xdf8        
        int32_t m_nStuckFramesCount; // 0xe04        
        // m_vecHitEnemies has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CUtlVector<CHandle<server::CBaseEntity>> m_vecHitEnemies;
        char m_vecHitEnemies[0x18]; // 0xe08        
        client::ParticleIndex_t m_nDistancePreview; // 0xe20        
    ...
    static_assert(sizeof(CCitadel_Ability_ChargedTackle) == 0xe28);
};
