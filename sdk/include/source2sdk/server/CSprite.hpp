...
namespace source2sdk::server
{
    ...
    public:
        ...
        // metadata: MNetworkEnable
        modellib::AttachmentHandle_t m_nAttachment; // 0x7dc        
        ...
        entity2::GameTime_t m_flDieTime; // 0x7e8        
        [[maybe_unused]] std::uint8_t pad_0x7ec[0xc]; // 0x7ec
        // metadata: MNetworkEnable
        uint32_t m_nBrightness; // 0x7f8        
        // metadata: MNetworkEnable
        ...
        entity2::GameTime_t m_flLastTime; // 0x814        
        float m_flMaxFrame; // 0x818        
        float m_flStartScale; // 0x81c        
        float m_flDestScale; // 0x820        
        entity2::GameTime_t m_flScaleTimeStart; // 0x824        
        int32_t m_nStartBrightness; // 0x828        
        int32_t m_nDestBrightness; // 0x82c        
        entity2::GameTime_t m_flBrightnessTimeStart; // 0x830        
        int32_t m_nSpriteWidth; // 0x834        
        int32_t m_nSpriteHeight; // 0x838        
    ...
    static_assert(sizeof(CSprite) == 0x840);
};
