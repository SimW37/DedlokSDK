...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifierAirLiftExplodeTargetVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strSilenceTargetSound; // 0x660            
            ...
            char m_BulletResistModifier[0x10]; // 0x690            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifierAirLiftExplodeTargetVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CModifierAirLiftExplodeTargetVData) == 0x6a0);
    };
};
