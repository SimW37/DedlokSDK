...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xba0[0x28]; // 0xba0
        ...
        entity2::GameTime_t m_flProjectileLaunchTime; // 0xbf4        
        entity2::GameTime_t m_flProjectileExpireTime; // 0xbf8        
