...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_WeaponUpgrade_BansheeSlugs_VData : public server::CitadelItemVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_DebuffPerCasterModifier;
        char m_DebuffPerCasterModifier[0x10]; // 0x1620        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_BansheeSlugs_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_WeaponUpgrade_BansheeSlugs_VData) == 0x1630);
};
