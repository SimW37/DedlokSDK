...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Spellbreaker_VData : public server::CCitadel_Modifier_Intrinsic_BaseVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_Spellbreaker_VData) == 0x740);
};
