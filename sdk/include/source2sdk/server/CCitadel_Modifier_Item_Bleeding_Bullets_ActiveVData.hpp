...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Item_Bleeding_Bullets_ActiveVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_BleedModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Item_Bleeding_Bullets_ActiveVData) == 0x790);
    };
};
