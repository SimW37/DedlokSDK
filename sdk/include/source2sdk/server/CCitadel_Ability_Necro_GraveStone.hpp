...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecDeployedGravestones[0x18]; // 0xf90            
            Vector m_vCastPosition; // 0xfa8            
            QAngle m_qCastAngle; // 0xfb4            
            uint8_t _pad0fc0[0x380];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Necro_GraveStone because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Necro_GraveStone) == 0x1340);
    };
};
