...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Tokamak_DyingStarVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_FlameAuraParticle[0xe0]; // 0x16c8            
            // metadata: MPropertyLeafSuggestionProviderFn
            CGlobalSymbol m_strInFlightAnimGraphParam; // 0x17a8            
            ...
            char m_InFlightModifier[0x10]; // 0x17c0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Tokamak_DyingStarVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Tokamak_DyingStarVData) == 0x17d0);
    };
};
