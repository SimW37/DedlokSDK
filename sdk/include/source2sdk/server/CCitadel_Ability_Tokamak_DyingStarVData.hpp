...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_FlameAuraParticle[0xe0]; // 0x1700            
            // metadata: MPropertyLeafSuggestionProviderFn
            CGlobalSymbol m_strInFlightAnimGraphParam; // 0x17e0            
            ...
            char m_InFlightModifier[0x10]; // 0x17f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Tokamak_DyingStarVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Tokamak_DyingStarVData) == 0x1808);
    };
};
