...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_ReloadSpeed : public source2sdk::server::CCitadelModifier
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_ReloadSpeed) == 0xc8);
    };
};
