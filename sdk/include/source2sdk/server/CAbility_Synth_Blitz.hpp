...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecSpecialShots[0x18]; // 0xd90            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            std::int32_t m_nFastFireBulletsLeft; // 0xda8            
            uint8_t _pad0dac[0x4]; // 0xdac
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            source2sdk::server::CCitadelAutoScaledTime m_flBlitzEndTime; // 0xdb0            
            bool m_bCanApplyTechAmp; // 0xdc8            
            bool m_bCanLifesteal; // 0xdc9            
            uint8_t _pad0dca[0x316];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Synth_Blitz because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbility_Synth_Blitz) == 0x10e0);
    };
};
