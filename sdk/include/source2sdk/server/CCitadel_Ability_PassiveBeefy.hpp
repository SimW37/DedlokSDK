...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_flLastHealTime; // 0xfa8            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            float m_flTotalPendingHeal; // 0xfac            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_PassiveBeefy) == 0x12b0);
    };
};
