...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_WeaponUpgrade_Headhunter_VData : public server::CCitadel_WeaponUpgrade_HeadshotBooster_VData
    {
    public:
