...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hTrooperSpawnPoint[0x4]; // 0x1acc            
            source2sdk::client::LaneSide_t m_LaneSide; // 0x1ad0            
            uint8_t _pad1ad1[0x3]; // 0x1ad1
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            source2sdk::entity2::GameTime_t m_flFadeOutStart; // 0x1ad4            
            // metadata: MNetworkEnable
            // metadata: MNotSaved
            source2sdk::entity2::GameTime_t m_flFadeOutEnd; // 0x1ad8            
        ...
        static_assert(sizeof(source2sdk::server::CNPC_TrooperBoss) == 0x1ae0);
    };
};
