...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hFamiliar[0x4]; // 0x2208            
            uint8_t _pad220c[0x4];
            
            // Datamap fields:
            // CCitadelFamiliarClone_MovementServices m_pMovementServices; // 0xbd0
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadelFamiliarClonePlayerPawn because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadelFamiliarClonePlayerPawn) == 0x2210);
    };
};
