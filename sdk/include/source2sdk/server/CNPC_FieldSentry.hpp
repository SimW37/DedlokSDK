...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xc50[0xc]; // 0xc50
        // metadata: MNetworkEnable
        float m_flAimPitch; // 0xc5c        
        entity2::GameTime_t m_flNextAttackTime; // 0xc60        
        ...
        [[maybe_unused]] std::uint8_t pad_0xc78[0xa]; // 0xc78
        bool m_bHadEnemy; // 0xc82        
        bool m_bLockedOn; // 0xc83        
        [[maybe_unused]] std::uint8_t pad_0xc84[0x10]; // 0xc84
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(CNPC_FieldSentry) == 0xc98);
};
