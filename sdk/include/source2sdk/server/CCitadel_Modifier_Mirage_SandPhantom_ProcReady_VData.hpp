...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Mirage_SandPhantom_ProcReady_VData : public server::CCitadelModifierVData
    {
    public:
        ...
        char m_ProcReadyParticle[0xe0]; // 0x658        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strProcReadySound; // 0x738        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Modifier_Mirage_SandPhantom_ProcReady_VData) == 0x748);
};
