...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Mirage_SandPhantom_ProcReady_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            CSoundEventName m_strProcReadySound; // 0x740            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Mirage_SandPhantom_ProcReady_VData) == 0x750);
    };
};
