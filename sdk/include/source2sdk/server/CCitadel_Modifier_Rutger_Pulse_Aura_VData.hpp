...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Rutger_Pulse_Aura_VData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
            ...
            char m_empWaveParticle[0xe0]; // 0x6b0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_Rutger_Pulse_Aura_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Rutger_Pulse_Aura_VData) == 0x790);
    };
};
