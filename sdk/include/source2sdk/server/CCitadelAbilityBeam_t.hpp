...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CCitadelAbilityBeam_t, m_bEnforceLOSToShootPosition) == 0x4e8);
        
        static_assert(sizeof(source2sdk::server::CCitadelAbilityBeam_t) == 0x4f0);
    };
};
