...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_UtilityUpgrade_HealthNova_VData : public server::CitadelItemVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_HealingModifier;
        char m_HealingModifier[0x10]; // 0x1668        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_UtilityUpgrade_HealthNova_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_UtilityUpgrade_HealthNova_VData) == 0x1678);
};
