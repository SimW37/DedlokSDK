...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_UtilityUpgrade_HealthNova_VData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            char m_HealingModifier[0x10]; // 0x1678            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_UtilityUpgrade_HealthNova_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_UtilityUpgrade_HealthNova_VData) == 0x1688);
    };
};
