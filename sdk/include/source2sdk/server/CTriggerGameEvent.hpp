...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CUtlString m_strStartTouchEventName; // 0x8d8            
            // metadata: MNetworkEnable
            CUtlString m_strEndTouchEventName; // 0x8e0            
            // metadata: MNetworkEnable
            CUtlString m_strTriggerID; // 0x8e8            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerGameEvent) == 0x8f0);
    };
};
