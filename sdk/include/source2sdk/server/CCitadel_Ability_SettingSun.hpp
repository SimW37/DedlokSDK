...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bProjectileActive; // 0xf90            
            uint8_t _pad0f91[0x387]; // 0xf91
            ...
            char m_TargetPreviews[0x18]; // 0x1318            
            uint8_t _pad1330[0x108]; // 0x1330
            bool m_bWasSelected; // 0x1438            
            uint8_t _pad1439[0x7];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_SettingSun because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_SettingSun) == 0x1440);
    };
};
