...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_MetalSkinVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_BuffStartParticle[0xe0]; // 0x660            
            ...
            char m_BuffEndParticle[0xe0]; // 0x740            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strHitProcSound; // 0x820            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_MetalSkinVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_MetalSkinVData) == 0x830);
    };
};
