...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_SummonParticle[0xe0]; // 0x15c8        
        ...
        char m_AutoThrowModifier[0x10]; // 0x1870        
    ...
    static_assert(sizeof(CAbilityWreckingBallVData) == 0x1890);
};
