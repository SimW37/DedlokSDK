...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SummonParticle[0xe0]; // 0x15e8            
            ...
            char m_SummonReadyParticle[0xe0]; // 0x16c8            
            CUtlString m_SummonParticleAttachment; // 0x17a8            
            // m_ExplodeParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ExplodeParticle;
            char m_ExplodeParticle[0xe0]; // 0x17b0            
            ...
            char m_AutoThrowModifier[0x10]; // 0x1890            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_HoldingBallLoop; // 0x18a0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityWreckingBallVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityWreckingBallVData) == 0x18b0);
    };
};
