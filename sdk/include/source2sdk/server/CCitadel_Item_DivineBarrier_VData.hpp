...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Item_DivineBarrier_VData : public server::CitadelItemVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_DivineBarrierModifier;
        char m_DivineBarrierModifier[0x10]; // 0x1668        
    ...
    static_assert(sizeof(CCitadel_Item_DivineBarrier_VData) == 0x1758);
};
