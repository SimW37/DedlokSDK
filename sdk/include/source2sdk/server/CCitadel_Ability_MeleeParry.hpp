...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nActiveFX; // 0xb98            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flParryStartTime; // 0xb9c            
            // metadata: MNetworkEnable
            bool m_bAttackParried; // 0xba0            
            uint8_t _pad0ba1[0x3]; // 0xba1
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flParrySuccessTime; // 0xba4            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_MeleeParry) == 0xc68);
    };
};
