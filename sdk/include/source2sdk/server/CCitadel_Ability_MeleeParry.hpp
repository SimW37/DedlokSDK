...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nActiveFX; // 0xf90            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flParryStartTime; // 0xf94            
            // metadata: MNetworkEnable
            bool m_bAttackParried; // 0xf98            
            uint8_t _pad0f99[0x3]; // 0xf99
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flParrySuccessEndTime; // 0xf9c            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_MeleeParry) == 0x1120);
    };
};
