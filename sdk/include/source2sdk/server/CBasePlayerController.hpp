...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            uint8_t _pad05e6[0x14a]; // 0x5e6
            source2sdk::client::ChatIgnoreType_t m_iIgnoreGlobalChat; // 0x730            
            float m_flLastPlayerTalkTime; // 0x734            
            float m_flLastEntitySteadyState; // 0x738            
            std::int32_t m_nAvailableEntitySteadyState; // 0x73c            
            bool m_bHasAnySteadyStateEnts; // 0x740            
            uint8_t _pad0741[0xf]; // 0x741
            // metadata: MNetworkEnable
        ...
        static_assert(sizeof(source2sdk::server::CBasePlayerController) == 0x7e0);
    };
};
