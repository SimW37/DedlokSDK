...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CUtlSymbolLarge m_iszStartForwardSound; // 0x7f8            
            CUtlSymbolLarge m_iszLoopForwardSound; // 0x800            
            CUtlSymbolLarge m_iszStopForwardSound; // 0x808            
            CUtlSymbolLarge m_iszStartReverseSound; // 0x810            
            CUtlSymbolLarge m_iszLoopReverseSound; // 0x818            
            CUtlSymbolLarge m_iszStopReverseSound; // 0x820            
            CUtlSymbolLarge m_iszArriveAtDestinationSound; // 0x828            
            ...
            source2sdk::server::CFuncMover_OrientationUpdate_t m_eOrientationUpdate; // 0x864            
            source2sdk::entity2::GameTime_t m_flTimeStartOrientationChange; // 0x868            
            float m_flTimeToBlendToNewOrientation; // 0x86c            
            float m_flDurationBlendToNewOrientationRan; // 0x870            
            ...
            char m_OnNodePassed[0x20]; // 0x878            
            CUtlSymbolLarge m_iszOrientationMatchEntityName; // 0x898            
            ...
            char m_hOrientationMatchEntity[0x4]; // 0x8a0            
            float m_flTimeToTraverseToNextNode; // 0x8a4            
            Vector m_vLerpToNewPosStartInPathEntitySpace; // 0x8a8            
            Vector m_vLerpToNewPosEndInPathEntitySpace; // 0x8b4            
            float m_flLerpToPositionT; // 0x8c0            
            float m_flLerpToPositionDeltaT; // 0x8c4            
            source2sdk::entity2::CEntityIOOutput m_OnLerpToPositionComplete; // 0x8c8            
            bool m_bIsPaused; // 0x8e0            
            uint8_t _pad08e1[0x3]; // 0x8e1
            source2sdk::server::CFuncMover_TransitionToPathNodeAction_t m_eTransitionedToPathNodeAction; // 0x8e4            
