...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DetonateParticle[0xe0]; // 0x1678            
            ...
            char m_DisruptModifier[0x10]; // 0x1758            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flWaveSpeed; // 0x1768            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Item_ModDisruptorVData) == 0x1770);
    };
};
