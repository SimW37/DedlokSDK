...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DetonateParticle[0xe0]; // 0x16a8            
            ...
            char m_DisruptModifier[0x10]; // 0x1788            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flWaveSpeed; // 0x1798            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Item_ModDisruptorVData) == 0x17a0);
    };
};
