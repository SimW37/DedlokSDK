...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_flDispatchTime; // 0x30        
        ...
        client::CRR_Response m_response; // 0x48        
        bool m_bResponseValid; // 0x230        
        [[maybe_unused]] std::uint8_t pad_0x231[0x7];
    };
    #pragma pack(pop)
    
    static_assert(offsetof(CResponseQueue__CDeferredResponse, m_contexts) == 0x8);
    static_assert(offsetof(CResponseQueue__CDeferredResponse, m_flDispatchTime) == 0x30);
    static_assert(offsetof(CResponseQueue__CDeferredResponse, m_hIssuer) == 0x34);
    static_assert(offsetof(CResponseQueue__CDeferredResponse, m_recipientBitVec) == 0x40);
    static_assert(offsetof(CResponseQueue__CDeferredResponse, m_response) == 0x48);
    static_assert(offsetof(CResponseQueue__CDeferredResponse, m_bResponseValid) == 0x230);
    
    static_assert(sizeof(CResponseQueue__CDeferredResponse) == 0x238);
};
