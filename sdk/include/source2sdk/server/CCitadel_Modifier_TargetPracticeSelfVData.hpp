...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_TargetPracticeSelfVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            CSoundEventName m_strWeaponShootSound; // 0x740            
            CSoundEventName m_strBulletWhizSound; // 0x750            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_TargetPracticeSelfVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_TargetPracticeSelfVData) == 0x760);
    };
};
