...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Mirage_FireScarabs_HealthLoss_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CModifier_Mirage_FireScarabs_HealthLoss_VData) == 0x750);
    };
};
