...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CCitadelAutoScaledTime m_flDashEndTime; // 0xfa8            
            // metadata: MNetworkEnable
            bool m_bIsSpeedBursting; // 0xfc0            
            uint8_t _pad0fc1[0x30f];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_FlameDash because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_FlameDash) == 0x12d0);
    };
};
