...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad0f90[0xa00]; // 0xf90
            source2sdk::entity2::GameTime_t m_flActivatePressTime; // 0x1990            
            bool m_bThinking; // 0x1994            
            bool m_bMoveCollidedPushUp; // 0x1995            
            uint8_t _pad1996[0x2]; // 0x1996
            source2sdk::client::EAttachState_t m_eCommittedAttachState; // 0x1998            
            uint8_t _pad199c[0x2c]; // 0x199c
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flTimeStartZipping; // 0x19c8            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flTimeForKnockdownProtection; // 0x19cc            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            source2sdk::entity2::GameTime_t m_flTimeStopZipping; // 0x19d0            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            float m_flCasterSpeed; // 0x19d4            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            source2sdk::client::CNetworkVelocityVector m_vecInitialVel; // 0x19d8            
            uint8_t _pad1a00[0x8]; // 0x1a00
            // metadata: MNetworkEnable
            Vector m_vecAttachPoint; // 0x1a08            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            ...
            char m_pNextNode[0x4]; // 0x1a18            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            source2sdk::entity2::GameTime_t m_flTimeEnterState; // 0x1a1c            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flLatchTime; // 0x1a20            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            source2sdk::entity2::GameTime_t m_flDamagedTime; // 0x1a24            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "AttachStateChanged"
            source2sdk::client::EAttachState_t m_eAttachState; // 0x1a28            
            // metadata: MNetworkEnable
            std::int32_t m_iAttachedZipLineLane; // 0x1a2c            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            bool m_bDroppedFromZipline; // 0x1a30            
            source2sdk::modellib::AttachmentHandle_t m_hAttachZipLine; // 0x1a31            
            uint8_t _pad1a32[0x2]; // 0x1a32
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            Vector m_vAttachZipLineOffset; // 0x1a34            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            float m_flZiplineAirDrag; // 0x1a40            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            Vector m_vPendulumVelocity; // 0x1a44            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            Vector m_vPendulumPosition; // 0x1a50            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            Vector m_vVelocityHistory1; // 0x1a5c            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            Vector m_vVelocityHistory2; // 0x1a68            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            // metadata: MNetworkChangeCallback "DesiredLaneChanged"
            std::int32_t m_iDesiredLane; // 0x1a74            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ZipLine because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ZipLine) == 0x1a78);
    };
};
