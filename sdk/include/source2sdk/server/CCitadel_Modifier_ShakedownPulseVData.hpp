...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_ShakedownPulseVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ShakeParticle;
            char m_ShakeParticle[0xe0]; // 0x670            
