...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_sIdolDropOffSound; // 0x16c8            
            ...
            char m_DropoffTimerModifier[0x10]; // 0x16d8            
            ...
            char m_HoldingIdolModifier[0x10]; // 0x16e8            
            ...
            char m_NoPickupModifier[0x10]; // 0x1718            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flInstantGoldPercentage; // 0x1728            
            std::int32_t m_iComebackBounty; // 0x172c            
            float m_flCasterBonusPercent; // 0x1730            
            float m_flRevealTime; // 0x1734            
            float m_flDamageTickRate; // 0x1738            
            float m_flMaxHealthDamage; // 0x173c            
            float m_flTimeToDamage; // 0x1740            
            float m_flNoPickupTime; // 0x1744            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_GoldenIdolVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_GoldenIdolVData) == 0x1748);
    };
};
