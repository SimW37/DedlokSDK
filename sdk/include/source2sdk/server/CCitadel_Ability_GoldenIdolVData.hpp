...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_DropoffTimerModifier[0x10]; // 0x16b8        
        ...
        char m_HoldingIdolModifier[0x10]; // 0x16c8        
        ...
        char m_NoPickupModifier[0x10]; // 0x16f8        
    ...
    static_assert(sizeof(CCitadel_Ability_GoldenIdolVData) == 0x1728);
};
