...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_sIdolDropOffSound; // 0x1700            
            ...
            char m_DropoffTimerModifier[0x10]; // 0x1710            
            ...
            char m_HoldingIdolModifier[0x10]; // 0x1720            
            ...
            char m_NoPickupModifier[0x10]; // 0x1750            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flInstantGoldPercentage; // 0x1760            
            std::int32_t m_iComebackBounty; // 0x1764            
            float m_flCasterBonusPercent; // 0x1768            
            float m_flRevealTime; // 0x176c            
            float m_flDamageTickRate; // 0x1770            
            float m_flMaxHealthDamage; // 0x1774            
            float m_flTimeToDamage; // 0x1778            
            float m_flNoPickupTime; // 0x177c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_GoldenIdolVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_GoldenIdolVData) == 0x1780);
    };
};
