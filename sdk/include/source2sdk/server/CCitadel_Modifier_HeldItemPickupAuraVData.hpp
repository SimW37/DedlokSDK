...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_HeldItemPickupAuraVData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
            ...
            char m_strFilterAbilityName[0x10]; // 0x6b0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_HeldItemPickupAuraVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_HeldItemPickupAuraVData) == 0x6c0);
    };
};
