...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_flStartTime; // 0xda0        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
        entity2::GameTime_t m_flLandedTime; // 0xda4        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
        ...
        client::ParticleIndex_t m_nStoneFormEffect; // 0xdb0        
    ...
    static_assert(sizeof(CCitadel_Ability_Tengu_StoneForm) == 0xdd0);
};
