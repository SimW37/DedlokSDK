...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_WeaponUpgrade_HeadshotDamage_VData : public source2sdk::server::CitadelItemVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_WeaponUpgrade_HeadshotDamage_VData) == 0x16a0);
    };
};
