...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ESwingState_t m_eSwingState; // 0xb98            
            uint8_t _pad0b99[0x3]; // 0xb99
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_SwingStartTime; // 0xb9c            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_SwingEndTime; // 0xba0            
            // metadata: MNetworkEnable
            Vector m_vecSwingPoint; // 0xba4            
            Vector m_vecCurrentPosition; // 0xbb0            
            // metadata: MNetworkEnable
            float m_flIdealSpringLength; // 0xbbc            
            uint8_t _pad0bc0[0xc8];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_SkyRunner_SwingLine because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_SkyRunner_SwingLine) == 0xc88);
    };
};
