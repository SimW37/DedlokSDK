...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad11b8[0x718]; // 0x11b8
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tTetherAttachTime; // 0x18d0            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tTetherBreakTime; // 0x18d4            
            // metadata: MNetworkEnable
            bool m_bHasTetherTarget; // 0x18d8            
            uint8_t _pad18d9[0xf];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Necro_PrimaryWeapon because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Necro_PrimaryWeapon) == 0x18e8);
    };
};
