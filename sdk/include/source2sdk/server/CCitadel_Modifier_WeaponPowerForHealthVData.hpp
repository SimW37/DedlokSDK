...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_WeaponPowerForHealthVData : public server::CCitadelModifierVData
    {
    public:
