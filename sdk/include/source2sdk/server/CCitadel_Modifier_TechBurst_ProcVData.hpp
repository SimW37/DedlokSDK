...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_TechBurst_ProcVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            bool m_bIgnoreResists; // 0x690            
            ...
            // CEmbeddedSubclass<source2sdk::server::CBaseModifier> m_ProcNotificationModifier;
            char m_ProcNotificationModifier[0x10]; // 0x778            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_TechBurst_ProcVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_TechBurst_ProcVData) == 0x788);
    };
};
