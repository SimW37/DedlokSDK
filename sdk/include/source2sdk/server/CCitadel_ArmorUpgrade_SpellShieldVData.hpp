...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_ArmorUpgrade_SpellShieldVData : public server::CitadelItemVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_SpellShieldBuffModifier;
        char m_SpellShieldBuffModifier[0x10]; // 0x1668        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_ArmorUpgrade_SpellShieldVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_ArmorUpgrade_SpellShieldVData) == 0x1678);
};
