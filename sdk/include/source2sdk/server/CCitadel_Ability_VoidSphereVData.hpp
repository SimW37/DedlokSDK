...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_strCastEffect[0xe0]; // 0x15f8            
            ...
            char m_strAllyPositionPreview[0xe0]; // 0x16d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_VoidSphereVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_VoidSphereVData) == 0x17b8);
    };
};
