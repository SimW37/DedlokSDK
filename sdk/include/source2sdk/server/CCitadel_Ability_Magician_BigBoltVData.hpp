...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Magician_BigBoltVData : public server::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_BoltHitModifier;
    ...
    static_assert(sizeof(CCitadel_Ability_Magician_BigBoltVData) == 0x17f0);
};
