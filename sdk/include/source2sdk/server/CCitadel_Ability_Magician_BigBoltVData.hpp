...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ChargeParticle[0xe0]; // 0x15c8        
        ...
        char m_ShootDelayParticle[0xe0]; // 0x16a8        
        ...
        char m_CasterModifier[0x10]; // 0x1788        
        ...
        char m_BoltHitModifier[0x10]; // 0x1798        
    ...
    static_assert(sizeof(CCitadel_Ability_Magician_BigBoltVData) == 0x17c8);
};
