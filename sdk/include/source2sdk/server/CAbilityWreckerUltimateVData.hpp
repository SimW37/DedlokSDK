...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityWreckerUltimateVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_ActiveModifier[0x10]; // 0x17a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityWreckerUltimateVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityWreckerUltimateVData) == 0x17b8);
    };
};
