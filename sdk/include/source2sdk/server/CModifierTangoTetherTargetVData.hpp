...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CModifierTangoTetherTargetVData : public server::CCitadelModifierVData
    {
    public:
