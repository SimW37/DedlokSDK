...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_strVictimTetheredSound; // 0x748            
            ...
            char m_GraspVictimParticle[0xe0]; // 0x758            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifier_Synth_Grasp_Victim_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CModifier_Synth_Grasp_Victim_VData) == 0x838);
    };
};
