...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Synth_Grasp_Victim_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strVictimTetheredSound; // 0x660            
            ...
            char m_GraspVictimParticle[0xe0]; // 0x670            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifier_Synth_Grasp_Victim_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CModifier_Synth_Grasp_Victim_VData) == 0x750);
    };
};
