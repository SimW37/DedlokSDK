...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ExplodeBaseParticle[0xe0]; // 0x1618            
            ...
            char m_ExplodeFriendlyParticle[0xe0]; // 0x16f8            
            ...
            char m_ExplodeEnemyParticle[0xe0]; // 0x17d8            
            ...
            char m_ModifierDragEnemy[0x10]; // 0x18c8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flOnHitDetonateTimer; // 0x18d8            
            float m_flTraceTravelRadius; // 0x18dc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityPerchedPredatorVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityPerchedPredatorVData) == 0x18e0);
    };
};
