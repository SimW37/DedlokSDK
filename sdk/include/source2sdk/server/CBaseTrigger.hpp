...
namespace source2sdk::server
{
    ...
    {
    public:
        entity2::CEntityIOOutput m_OnStartTouch; // 0x850        
        entity2::CEntityIOOutput m_OnStartTouchAll; // 0x878        
        entity2::CEntityIOOutput m_OnEndTouch; // 0x8a0        
        entity2::CEntityIOOutput m_OnEndTouchAll; // 0x8c8        
        entity2::CEntityIOOutput m_OnTouching; // 0x8f0        
        entity2::CEntityIOOutput m_OnTouchingEachEntity; // 0x918        
        entity2::CEntityIOOutput m_OnNotTouching; // 0x940        
        ...
        [[maybe_unused]] std::uint8_t pad_0x98d[0x3];
