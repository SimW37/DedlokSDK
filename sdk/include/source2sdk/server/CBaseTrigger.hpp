...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hTouchingEntities[0x18]; // 0x8a0            
            ...
            bool m_bDisabled; // 0x8c4            
            uint8_t _pad08c5[0xb]; // 0x8c5
            bool m_bUseAsyncQueries; // 0x8d0            
            uint8_t _pad08d1[0x7];
        ...
        static_assert(sizeof(source2sdk::server::CBaseTrigger) == 0x8d8);
    };
};
