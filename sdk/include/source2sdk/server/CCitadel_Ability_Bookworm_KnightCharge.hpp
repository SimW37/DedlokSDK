...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CUtlVector<CHandle<source2sdk::server::CBaseEntity>> m_vecKnightChargedEnemies;
            char m_vecKnightChargedEnemies[0x18]; // 0xbb8            
            uint8_t _pad0bd0[0x380];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Bookworm_KnightCharge because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Bookworm_KnightCharge) == 0xf50);
    };
};
