...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_PillarVData : public server::CCitadel_Modifier_StunnedVData
    {
    public:
        ...
        char m_DebuffParticle[0xe0]; // 0x738        
        ...
        char m_BuffStartParticle[0xe0]; // 0x818        
        ...
        char m_BuffEndParticle[0xe0]; // 0x8f8        
