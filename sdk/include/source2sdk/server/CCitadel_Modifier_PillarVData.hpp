...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_PillarVData : public source2sdk::server::CCitadel_Modifier_StunnedVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_PillarVData) == 0x9f0);
    };
};
