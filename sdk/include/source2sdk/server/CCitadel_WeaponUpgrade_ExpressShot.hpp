...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_iShotsToCreate; // 0x1218            
            // metadata: MNetworkEnable
            bool m_bIsInExpressShot; // 0x121c            
            uint8_t _pad121d[0x3]; // 0x121d
            source2sdk::entity2::GameTime_t m_tNextShotTime; // 0x1220            
            uint8_t _pad1224[0x1c]; // 0x1224
            bool m_bIsPrimaryProc; // 0x1240            
            uint8_t _pad1241[0x7];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_ExpressShot because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_WeaponUpgrade_ExpressShot) == 0x1248);
    };
};
