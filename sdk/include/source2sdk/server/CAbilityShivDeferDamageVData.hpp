...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityShivDeferDamageVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_ActiveCastParticle[0xe0]; // 0x15e8            
            // metadata: MPropertyStartGroup "+Defer Properties"
            float m_flDeferredDamageApplicationInterval; // 0x16c8            
        ...
        static_assert(sizeof(source2sdk::server::CAbilityShivDeferDamageVData) == 0x16d0);
    };
};
