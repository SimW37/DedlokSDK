...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ActiveCastParticle[0xe0]; // 0x15f0            
            // metadata: MPropertyStartGroup "+Defer Properties"
            float m_flDeferredDamageApplicationInterval; // 0x16d0            
        ...
        static_assert(sizeof(source2sdk::server::CAbilityShivDeferDamageVData) == 0x16d8);
    };
};
