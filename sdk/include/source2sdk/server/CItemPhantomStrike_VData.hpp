...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DebuffModifier[0x10]; // 0x1680            
            ...
            char m_PullDownModifier[0x10]; // 0x1690            
            ...
            char m_CasterModifier[0x10]; // 0x16a0            
            ...
            char m_BuffParticle[0xe0]; // 0x1880            
            // metadata: MPropertyGroupName "Gameplay"
            float m_flTeleportDistance; // 0x1960            
            float m_flVelocityScale; // 0x1964            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemPhantomStrike_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CItemPhantomStrike_VData) == 0x1968);
    };
};
