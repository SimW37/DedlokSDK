...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_PullDownModifier[0x10]; // 0x16b8            
            ...
            char m_CasterModifier[0x10]; // 0x16c8            
            ...
            char m_CastParticle[0xe0]; // 0x16e8            
            // m_ImpactParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ImpactParticle;
            char m_ImpactParticle[0xe0]; // 0x17c8            
            ...
            char m_BuffParticle[0xe0]; // 0x18a8            
            // metadata: MPropertyGroupName "Gameplay"
            float m_flTeleportDistance; // 0x1988            
            float m_flVelocityScale; // 0x198c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemPhantomStrike_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CItemPhantomStrike_VData) == 0x1990);
    };
};
