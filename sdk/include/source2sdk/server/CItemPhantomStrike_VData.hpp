...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CItemPhantomStrike_VData : public source2sdk::server::CitadelItemVData
        {
        public:
            // metadata: MPropertyStartGroup "Modifiers"
            // m_DebuffModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_DebuffModifier;
            char m_DebuffModifier[0x10]; // 0x1678            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_PullDownModifier;
            char m_PullDownModifier[0x10]; // 0x1688            
            ...
            char m_CasterModifier[0x10]; // 0x1698            
            ...
            char m_ImpactParticle[0xe0]; // 0x1798            
            ...
            char m_BuffParticle[0xe0]; // 0x1878            
            // metadata: MPropertyGroupName "Gameplay"
            float m_flTeleportDistance; // 0x1958            
            float m_flVelocityScale; // 0x195c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemPhantomStrike_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CItemPhantomStrike_VData) == 0x1960);
    };
};
