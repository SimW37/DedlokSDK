...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_nHeroAbilityUpgradeBits) == 0x90);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_vecUpgrades) == 0xa0);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_vecBonusCounterAbilities) == 0xb8);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_vecBonusCounterValues) == 0xd0);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_vecBonusCounterModifiers) == 0xe8);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_vecModifierBonusCounterValues) == 0x100);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_tHeldItem) == 0x118);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_vecImbuements) == 0x120);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_vecDynamicAbilityValues) == 0x188);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_vecStatViewerModifierValues) == 0x1f0);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_vecStolenAbilities) == 0x258);
        
        static_assert(sizeof(source2sdk::server::PlayerDataGlobal_t) == 0x2c0);
    };
};
