...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad1120[0x1a0]; // 0x1120
            // metadata: MNetworkEnable
            source2sdk::server::CCitadelAbilityBeam_t m_beam00; // 0x12c0            
            // metadata: MNetworkEnable
            source2sdk::server::CCitadelAbilityBeam_t m_beam01; // 0x2280            
            // metadata: MNetworkEnable
            source2sdk::server::CCitadelAbilityBeam_t m_beam02; // 0x3240            
            // metadata: MNetworkEnable
            source2sdk::server::CCitadelAbilityBeam_t m_beam03; // 0x4200            
            // metadata: MNetworkEnable
            source2sdk::server::CCitadelAbilityBeam_t m_beam04; // 0x51c0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_PrismBlast because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Item_PrismBlast) == 0x6180);
    };
};
