...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CItemSingleTargetStunVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_StunDelayModifier;
            char m_StunDelayModifier[0x10]; // 0x16a8            
        ...
        static_assert(sizeof(source2sdk::server::CItemSingleTargetStunVData) == 0x1798);
    };
};
