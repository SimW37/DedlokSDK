...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_PassiveBeefyVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_HealParticle[0xe0]; // 0x1620            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_PassiveBeefyVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_PassiveBeefyVData) == 0x1700);
    };
};
