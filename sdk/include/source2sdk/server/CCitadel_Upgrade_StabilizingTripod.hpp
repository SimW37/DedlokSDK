...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vDeployPosition; // 0xbb8            
            QAngle m_vDeployAngles; // 0xbc4            
            uint8_t _pad0bd0[0x200];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Upgrade_StabilizingTripod because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Upgrade_StabilizingTripod) == 0xdd0);
    };
};
