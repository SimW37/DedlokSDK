...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceImpact; // 0x1620            
            ...
            char m_ModifierTossAirControlLockout[0x10]; // 0x16a8            
            ...
            char m_ModifierWeaponPowerIncrease[0x10]; // 0x16b8            
            ...
            char m_ModifierChargeDragEnemy[0x10]; // 0x16c8            
            ...
            char m_ModifierBullCharging[0x10]; // 0x16d8            
            ...
            char m_WallImpactParticle[0xe0]; // 0x16f8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strWallSlamSound; // 0x17d8            
            // metadata: MPropertyStartGroup "GamePlay"
            float m_flWallStunLookAheadDist; // 0x17e8            
            float m_flEndChargeVelocityScale; // 0x17ec            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityBullChargeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityBullChargeVData) == 0x17f0);
    };
};
