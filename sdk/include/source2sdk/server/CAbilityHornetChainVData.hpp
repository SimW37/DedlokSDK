...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityHornetChainVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            CSoundEventName m_strExplodeSound; // 0x16f8            
            ...
            char m_ChainModifier[0x10]; // 0x1708            
            // metadata: MPropertyGroupName "Modifiers"
            ...
            char m_DisarmModifier[0x10]; // 0x1718            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityHornetChainVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityHornetChainVData) == 0x1728);
    };
};
