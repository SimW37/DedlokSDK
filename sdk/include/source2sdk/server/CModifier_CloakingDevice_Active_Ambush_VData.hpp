...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifier_CloakingDevice_Active_Ambush_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_InvisRevealedParticle[0xe0]; // 0x660            
            ...
            char m_AmbushParticle[0xe0]; // 0x740            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strActivateAmbushSound; // 0x820            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CModifier_CloakingDevice_Active_Ambush_VData) == 0x830);
    };
};
