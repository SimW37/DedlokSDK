...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_HalloweenMaskVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            std::int32_t m_nNumMasks; // 0x660            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_HalloweenMaskVData) == 0x748);
    };
};
