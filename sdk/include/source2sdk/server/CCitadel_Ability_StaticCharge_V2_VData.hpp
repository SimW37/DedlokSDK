...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_StaticCharge_V2_VData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_StaticChargeModifier;
            char m_StaticChargeModifier[0x10]; // 0x16f8            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_StaticChargeWorldModifier;
            char m_StaticChargeWorldModifier[0x10]; // 0x1708            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flWorldTraceRadius; // 0x1718            
            float m_flUnitTraceRadius; // 0x171c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_StaticCharge_V2_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_StaticCharge_V2_VData) == 0x1720);
    };
};
