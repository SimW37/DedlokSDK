...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flSpinRate; // 0x2c            
            float m_flBobHeight; // 0x30            
            float m_flBobFrequency; // 0x34            
            float m_flSpinSpeed; // 0x38            
            ...
            char m_PunchPickupModifier[0x10]; // 0x40            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadelItemPunchableNeutralGoldVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadelItemPunchableNeutralGoldVData) == 0x50);
    };
};
