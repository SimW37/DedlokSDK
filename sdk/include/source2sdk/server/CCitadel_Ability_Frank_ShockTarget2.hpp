...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecHitTargets[0x18]; // 0x1698            
            uint8_t _pad16b0[0x8]; // 0x16b0
            // metadata: MNetworkEnable
            bool m_bIsFullyCharged; // 0x16b8            
            uint8_t _pad16b9[0x7]; // 0x16b9
            source2sdk::server::CModifierHandleBase m_hFullyChargedFXModifier; // 0x16c0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Frank_ShockTarget2 because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Frank_ShockTarget2) == 0x16d8);
    };
};
