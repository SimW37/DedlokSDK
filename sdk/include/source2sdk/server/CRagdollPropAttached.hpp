...
namespace source2sdk::server
{
    ...
    public:
        ...
        uint32_t m_boneIndexAttached; // 0xc88        
        // metadata: MNetworkEnable
        uint32_t m_ragdollAttachedObjectIndex; // 0xc8c        
        // metadata: MNetworkEnable
