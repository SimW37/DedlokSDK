...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CAttributeContainer m_AttributeManager; // 0xae0            
            ...
            char m_hOldProvidee[0x4]; // 0xc38            
            std::int32_t m_iOldOwnerClass; // 0xc3c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CEconEntity because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CEconEntity) == 0xc40);
    };
};
