...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifierContainmentVictimVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_AreaParticle[0xe0]; // 0x660            
            ...
            char m_ChainedParticle[0xe0]; // 0x740            
            ...
            char m_DebuffParticle[0xe0]; // 0x820            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifierContainmentVictimVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CModifierContainmentVictimVData) == 0x900);
    };
};
