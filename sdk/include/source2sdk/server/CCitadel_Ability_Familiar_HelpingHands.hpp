...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecHelpers[0x18]; // 0xf98            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tChoreUseCooldownEndTime; // 0xfb0            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tSoonestHelperCooldownEndTime; // 0xfb4            
            // metadata: MNetworkEnable
            char m_nAvailableHelperCount; // 0xfb8            
            uint8_t _pad0fb9[0x387];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Familiar_HelpingHands because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Familiar_HelpingHands) == 0x1340);
    };
};
