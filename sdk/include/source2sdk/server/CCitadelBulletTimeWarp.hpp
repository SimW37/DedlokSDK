...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flBulletTimeScale; // 0x7d0            
            // metadata: MNetworkEnable
            float m_flProjectileTimeScale; // 0x7d4            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flExpireTime; // 0x7d8            
            // metadata: MNetworkEnable
            float m_flStopDuration; // 0x7dc            
            uint8_t _pad07e0[0x210];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadelBulletTimeWarp because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadelBulletTimeWarp) == 0x9f0);
    };
};
