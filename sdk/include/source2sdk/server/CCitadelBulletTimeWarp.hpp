...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flBulletTimeScale; // 0x778            
            // metadata: MNetworkEnable
            float m_flProjectileTimeScale; // 0x77c            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flExpireTime; // 0x780            
            // metadata: MNetworkEnable
            float m_flStopDuration; // 0x784            
            // metadata: MNetworkEnable
            float m_flBulletTimeScaleFriendly; // 0x788            
            // metadata: MNetworkEnable
            float m_flBonusBulletBaseDamageFriendly; // 0x78c            
            uint8_t _pad0790[0x210];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadelBulletTimeWarp because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadelBulletTimeWarp) == 0x9a0);
    };
};
