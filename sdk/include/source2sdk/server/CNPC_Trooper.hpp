...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t m_iLane; // 0x19a8        
        int32_t m_iLaneSlot; // 0x19ac        
        [[maybe_unused]] std::uint8_t pad_0x19b0[0x24]; // 0x19b0
        ...
        [[maybe_unused]] std::uint8_t pad_0x19dc[0x1c]; // 0x19dc
        ...
        [[maybe_unused]] std::uint8_t pad_0x1a10[0x8]; // 0x1a10
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0x1a20[0x88];
    ...
    static_assert(sizeof(CNPC_Trooper) == 0x1aa8);
};
