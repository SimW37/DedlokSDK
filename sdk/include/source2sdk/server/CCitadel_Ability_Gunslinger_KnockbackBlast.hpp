...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            Vector m_vecKnockbackDirection; // 0xf90            
            ...
            char m_vecKnockbackedUnits[0x18]; // 0xfa0            
            uint8_t _pad0fb8[0x380];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Gunslinger_KnockbackBlast because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Gunslinger_KnockbackBlast) == 0x1338);
    };
};
