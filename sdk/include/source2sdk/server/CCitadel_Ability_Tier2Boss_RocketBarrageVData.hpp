...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_ExplosionSound; // 0x16d0            
            CSoundEventName m_RocketFireSound; // 0x16e0            
            ...
            char m_AuraModifier[0x10]; // 0x16f0            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Tier2Boss_RocketBarrageVData) == 0x1700);
    };
};
