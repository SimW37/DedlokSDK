...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hHookVictim[0x4]; // 0xf90            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            Vector m_vecHookTargetStartPos; // 0xf94            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flCancelHookTime; // 0xfa0            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flBeginReelHookTime; // 0xfa4            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flBulletShouldExpireTime; // 0xfa8            
            uint8_t _pad0fac[0x8]; // 0xfac
            float m_flMaxHookTravelTime; // 0xfb4            
            float m_flLastUppercutRestoreTime; // 0xfb8            
            uint8_t _pad0fbc[0x504];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Hook because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Hook) == 0x14c0);
    };
};
