...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadelModifierAirLiftExplodeAuraVData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadelModifierAirLiftExplodeAuraVData) == 0x890);
    };
};
