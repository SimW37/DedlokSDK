...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Gunslinger_DemonCarbineVData : public server::CCitadelModifierVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_Gunslinger_DemonCarbineVData) == 0x840);
};
