...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_SilenceModifier[0x10]; // 0x15d8        
        ...
        char m_WebWallParticle[0xe0]; // 0x15e8        
        ...
        char m_WebWallDestroyedParticle[0xe0]; // 0x16c8        
        ...
        char m_WebWallHitParticle[0xe0]; // 0x17a8        
    ...
    static_assert(sizeof(CCitadel_Ability_Trapper_WebWallVData) == 0x18a8);
};
