...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bModifierStatesDirty) == 0x1a7);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bPredictedOwner) == 0x1a8);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bAllowModifiersOnDeadEntities) == 0x1a9);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_iLockRefCount) == 0x1aa);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_hHandle) == 0x1ac);
