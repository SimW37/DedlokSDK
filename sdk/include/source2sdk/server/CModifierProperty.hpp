...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bParentWantsModifierStateChangeCallback; // 0x278            
        ...
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bModifierStatesDirty) == 0x1d3);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bPredictedOwner) == 0x1d4);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bAllowModifiersOnDeadEntities) == 0x1d5);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_iLockRefCount) == 0x1d6);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_hHandle) == 0x1d8);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_nBroadcastEventListenerMask) == 0x1dc);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_nCachedHighestParticleIndex) == 0x1e0);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_pNotifyOwnerEvents) == 0x1e8);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_nDisabledGroups) == 0x1f0);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bvEnabledStateMask) == 0x1f4);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bvDisabledStateMask) == 0x21c);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bvEnabledPredictedStateMask) == 0x244);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bParentWantsModifierStateChangeCallback) == 0x278);
        
        static_assert(sizeof(source2sdk::server::CModifierProperty) == 0x280);
    };
};
