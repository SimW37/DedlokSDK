...
namespace source2sdk::server
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x198[0x2]; // 0x198
        client::ModifierPropRuntimeHandle_t m_hHandle; // 0x19a        
    ...
    static_assert(offsetof(CModifierProperty, m_hHandle) == 0x19a);
