...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_UltimateBurst_ProcVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            char m_LightningParticle[0xe0]; // 0x690            
            ...
            char m_DelayedEffectModifier[0x10]; // 0x770            
            ...
            CSoundEventName m_strLightningSound; // 0x790            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_UltimateBurst_ProcVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_UltimateBurst_ProcVData) == 0x7a0);
    };
};
