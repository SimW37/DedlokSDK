...
namespace source2sdk::server
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CCitadel_Modifier_MageWalk : public server::CCitadelModifier
    {
    public:
