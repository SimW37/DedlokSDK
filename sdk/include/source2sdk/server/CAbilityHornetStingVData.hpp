...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityHornetStingVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_HitParticle[0xe0]; // 0x15f8            
            ...
            char m_RicochetTracerParticle[0xe0]; // 0x16d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityHornetStingVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityHornetStingVData) == 0x17b8);
    };
};
