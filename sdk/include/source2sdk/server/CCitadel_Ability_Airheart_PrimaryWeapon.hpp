...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecStuckTargets[0x18]; // 0x11b8            
            ...
            char m_vecBombsInWorld[0x18]; // 0x11d0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Airheart_PrimaryWeapon) == 0x1368);
    };
};
