...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_HauntWatcherVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_HauntDamageModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_HauntWatcherVData) == 0x6c0);
    };
};
