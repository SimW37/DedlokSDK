...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CItemSilenceGlyphVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            char m_ResistReductionModifier[0x10]; // 0x1690            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strHitConfirmSound; // 0x16a0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemSilenceGlyphVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CItemSilenceGlyphVData) == 0x16b0);
    };
};
