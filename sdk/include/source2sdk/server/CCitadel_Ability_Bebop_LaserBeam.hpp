...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nTotalDamage; // 0x14a0            
            source2sdk::entity2::GameTime_t m_flNextDamageTime; // 0x14a4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Bebop_LaserBeam because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Bebop_LaserBeam) == 0x14a8);
    };
};
