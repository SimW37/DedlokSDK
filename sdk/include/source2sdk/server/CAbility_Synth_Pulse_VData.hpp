...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_AoEParticle[0xe0]; // 0x1608            
            ...
            char m_EffectParticle[0xe0]; // 0x16e8            
            ...
            char m_ChannelParticle[0xe0]; // 0x17c8            
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceInSatchel; // 0x1a78            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Synth_Pulse_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbility_Synth_Pulse_VData) == 0x1b00);
    };
};
