...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Magician_AnimalCurseVData : public server::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_CurseModifier;
        char m_CurseModifier[0x10]; // 0x15c8        
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_AirDampingModifier;
        char m_AirDampingModifier[0x10]; // 0x15d8        
        ...
        char m_ProjectileImpactParticle[0xe0]; // 0x1608        
        ...
        char m_TargetWarningParticle[0xe0]; // 0x16e8        
