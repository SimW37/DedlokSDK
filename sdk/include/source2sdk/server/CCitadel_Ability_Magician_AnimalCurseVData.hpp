...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CurseModifier[0x10]; // 0x1620            
            ...
            char m_AirDampingModifier[0x10]; // 0x1630            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_TargetWarningSound; // 0x1640            
            CSoundEventName m_ProjectileHitConfirm; // 0x1650            
            ...
            char m_ProjectileImpactParticle[0xe0]; // 0x1660            
            ...
            char m_TargetWarningParticle[0xe0]; // 0x1740            
            ...
            char m_ProjectileExplodeParticle[0xe0]; // 0x1820            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Magician_AnimalCurseVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Magician_AnimalCurseVData) == 0x1900);
    };
};
