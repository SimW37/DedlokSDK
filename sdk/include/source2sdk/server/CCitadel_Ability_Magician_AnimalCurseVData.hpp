...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Magician_AnimalCurseVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_CurseModifier[0x10]; // 0x1618            
            ...
            char m_AirDampingModifier[0x10]; // 0x1628            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_TargetWarningSound; // 0x1638            
            CSoundEventName m_ProjectileHitConfirm; // 0x1648            
            ...
            char m_ProjectileImpactParticle[0xe0]; // 0x1658            
            ...
            char m_TargetWarningParticle[0xe0]; // 0x1738            
            ...
            char m_ProjectileExplodeParticle[0xe0]; // 0x1818            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Magician_AnimalCurseVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Magician_AnimalCurseVData) == 0x18f8);
    };
};
