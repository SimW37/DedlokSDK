...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bAllowAnyone; // 0x778            
            bool m_bAllowTinyCharacters; // 0x779            
            uint8_t _pad077a[0x2]; // 0x77a
            float m_flTriggerDistanceMeters; // 0x77c            
            ...
            char m_hTrigger[0x4]; // 0x780            
            uint8_t _pad0784[0x4]; // 0x784
            source2sdk::entity2::CEntityIOOutput m_eventOnOpen; // 0x788            
            source2sdk::entity2::CEntityIOOutput m_eventOnClose; // 0x7a0            
            uint8_t _pad07b8[0x8];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadelPassthroughFakeWall because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadelPassthroughFakeWall) == 0x7c0);
    };
};
