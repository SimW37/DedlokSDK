...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_MageWalkVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            float m_flPreTeleportDuration; // 0x900            
            uint8_t _pad0904[0x4]; // 0x904
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strAmbientLoopingLocalPlayerSound; // 0x908            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_MageWalkVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_MageWalkVData) == 0x918);
    };
};
