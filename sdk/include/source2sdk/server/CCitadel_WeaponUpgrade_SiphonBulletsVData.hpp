...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_PermanentHealthLoss;
        char m_PermanentHealthLoss[0x10]; // 0x1668        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_SiphonBulletsVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_WeaponUpgrade_SiphonBulletsVData) == 0x1678);
};
