...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_WeaponUpgrade_SiphonBulletsVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_PermanentHealthLoss;
            char m_PermanentHealthLoss[0x10]; // 0x16b0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_SiphonBulletsVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_WeaponUpgrade_SiphonBulletsVData) == 0x16c0);
    };
};
