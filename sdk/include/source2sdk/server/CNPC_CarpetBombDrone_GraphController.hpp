...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CNPC_CarpetBombDrone_GraphController : public source2sdk::server::CAI_CitadelNPC_GraphController
        {
        public:
        ...
        // Cannot assert offsets of fields in CNPC_CarpetBombDrone_GraphController because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CNPC_CarpetBombDrone_GraphController) == 0xfb8);
    };
};
