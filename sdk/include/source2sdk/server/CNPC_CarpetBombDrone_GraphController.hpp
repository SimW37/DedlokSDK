...
namespace source2sdk::server
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CNPC_CarpetBombDrone_GraphController : public server::CAI_CitadelNPC_GraphController
    {
    public:
    ...
    static_assert(sizeof(CNPC_CarpetBombDrone_GraphController) == 0xfb8);
};
