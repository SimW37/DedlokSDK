...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CasterModifier[0x10]; // 0x1818            
            ...
            char m_VictimModifier[0x10]; // 0x1828            
            ...
            char m_BulletShieldModifier[0x10]; // 0x1838            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Synth_Grasp_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbility_Synth_Grasp_VData) == 0x1848);
    };
};
