...
namespace source2sdk::server
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x9e1[0x7]; // 0x9e1
        ...
        char m_hRagdollSource[0x4]; // 0xa18        
        ...
        char m_hDamageEntity[0x4]; // 0xa24        
        ...
        char m_ragdollMaxs[0x18]; // 0xa88        
        bool m_bShouldDeleteActivationRecord; // 0xaa0        
        [[maybe_unused]] std::uint8_t pad_0xaa1[0x5f]; // 0xaa1
        bool m_bValidatePoweredRagdollPose; // 0xb00        
        [[maybe_unused]] std::uint8_t pad_0xb01[0x3f];
    ...
    static_assert(sizeof(CRagdollProp) == 0xb40);
};
