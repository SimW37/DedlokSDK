...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_EnchantedHolsters_Watcher_VData : public server::CCitadel_Modifier_Intrinsic_BaseVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_EnchantedHolsters_Watcher_VData) == 0x680);
};
