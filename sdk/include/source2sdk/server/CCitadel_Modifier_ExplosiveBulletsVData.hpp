...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_ExplosiveBulletsVData : public source2sdk::server::CCitadel_Modifier_BaseBulletPreRollProcVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_ExplosiveBulletsVData) == 0x880);
    };
};
