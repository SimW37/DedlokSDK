...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_iAudibleList; // 0x50            
            ...
            source2sdk::entity2::GameTime_t m_TimeLastLookHighPriority; // 0xe8            
            source2sdk::entity2::GameTime_t m_TimeLastLookNPCs; // 0xec            
            source2sdk::entity2::GameTime_t m_TimeLastLookMisc; // 0xf0            
            std::int32_t m_iSensingFlags; // 0xf4            
            source2sdk::server::CSound m_CachedTaskSound; // 0xf8            
            float m_flHearingSensitivity; // 0x12c            
            std::int32_t m_nSoundInterests; // 0x130            
        ...
        static_assert(sizeof(source2sdk::server::CAI_Senses) == 0x138);
    };
};
