...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_BulletArmorShredder_ProcVData : public server::CCitadel_Modifier_BaseEventProcVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_BulletArmorShredder_ProcVData) == 0x6a0);
};
