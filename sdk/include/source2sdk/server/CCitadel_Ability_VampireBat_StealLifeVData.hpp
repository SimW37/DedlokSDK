...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CastLifeLeechParticle[0xe0]; // 0x17e8            
            ...
            char m_DamageTargetParticle[0xe0]; // 0x18c8            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_VampireBat_StealLifeVData) == 0x19d8);
    };
};
