...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_VampireBat_StealLifeVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_CastLifeLeechParticle[0xe0]; // 0x1708            
            ...
            char m_DamageTargetParticle[0xe0]; // 0x17e8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strSlashSound; // 0x18c8            
            CSoundEventName m_strHitConfirmSound; // 0x18d8            
            CSoundEventName m_strKillConfirmSound; // 0x18e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_VampireBat_StealLifeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_VampireBat_StealLifeVData) == 0x18f8);
    };
};
