...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_tTetherEndTime; // 0xfa8            
            uint8_t _pad0fac[0x14]; // 0xfac
            // metadata: MNetworkEnable
            bool m_bTetheringActive; // 0xfc0            
            uint8_t _pad0fc1[0x287];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_PunkGoat_Tether because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_PunkGoat_Tether) == 0x1248);
    };
};
