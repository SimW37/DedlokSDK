...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_ReinforcingCasingsVData : public source2sdk::server::CCitadel_Modifier_Intrinsic_BaseVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_ReinforcingCasingsVData) == 0x670);
    };
};
