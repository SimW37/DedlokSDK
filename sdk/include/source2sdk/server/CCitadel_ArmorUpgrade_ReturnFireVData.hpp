...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_ArmorUpgrade_ReturnFireVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ReactiveArmorModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_ReturnFireVData) == 0x1688);
    };
};
