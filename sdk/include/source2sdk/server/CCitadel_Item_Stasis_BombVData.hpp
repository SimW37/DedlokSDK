...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_Stasis_BombVData : public source2sdk::server::CCitadel_Item_BubbleVData
        {
        public:
            ...
            char m_AuraModifier[0x10]; // 0x17a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_Stasis_BombVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Item_Stasis_BombVData) == 0x17b8);
    };
};
