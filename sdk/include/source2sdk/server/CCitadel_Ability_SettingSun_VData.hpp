...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_BeamTargetParticle[0xe0]; // 0x15e8            
            ...
            char m_UnitTargetParticle[0xe0]; // 0x16c8            
            ...
            char m_SettingSunThinkerModifier[0x10]; // 0x17a8            
            float m_flSSCameraPreviewOffset; // 0x17b8            
            float m_flSSCameraPreviewSpeed; // 0x17bc            
            float m_flSSCameraPreviewDistance; // 0x17c0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_SettingSun_VData) == 0x17c8);
    };
};
