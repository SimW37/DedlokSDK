...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_SettingSun_VData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_BeamTargetParticle[0xe0]; // 0x15f0            
            ...
            char m_UnitTargetParticle[0xe0]; // 0x16d0            
            ...
            // CEmbeddedSubclass<source2sdk::server::CBaseModifier> m_SettingSunThinkerModifier;
            char m_SettingSunThinkerModifier[0x10]; // 0x17b0            
            float m_flSSCameraPreviewOffset; // 0x17c0            
            float m_flSSCameraPreviewSpeed; // 0x17c4            
            float m_flSSCameraPreviewDistance; // 0x17c8            
            uint8_t _pad17cc[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_SettingSun_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_SettingSun_VData) == 0x17d0);
    };
};
