...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_BeamTargetParticle[0xe0]; // 0x1620            
            ...
            char m_UnitTargetParticle[0xe0]; // 0x1700            
            ...
            char m_SettingSunThinkerModifier[0x10]; // 0x17e0            
            float m_flSSCameraPreviewOffset; // 0x17f0            
            float m_flSSCameraPreviewSpeed; // 0x17f4            
            float m_flSSCameraPreviewDistance; // 0x17f8            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_SettingSun_VData) == 0x1800);
    };
};
