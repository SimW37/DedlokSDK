...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_BeamTargetParticle[0xe0]; // 0x15c8        
        ...
        char m_UnitTargetParticle[0xe0]; // 0x16a8        
        ...
        char m_SettingSunThinkerModifier[0x10]; // 0x1788        
    ...
    static_assert(sizeof(CCitadel_Ability_SettingSun_VData) == 0x17a8);
};
