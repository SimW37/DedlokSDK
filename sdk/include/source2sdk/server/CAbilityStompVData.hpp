...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityStompVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            CSoundEventName m_strCastDelayLocalPlayerSound; // 0x1710            
            ...
            char m_BulletResistModifier[0x10]; // 0x1730            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityStompVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityStompVData) == 0x1740);
    };
};
