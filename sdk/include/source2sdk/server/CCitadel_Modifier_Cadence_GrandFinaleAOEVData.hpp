...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Cadence_GrandFinaleAOEVData : public server::CCitadelModifierAuraVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_Cadence_GrandFinaleAOEVData) == 0x780);
};
