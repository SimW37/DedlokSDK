...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifier_WarpStone_Caster_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_playerBuffSelf[0xe0]; // 0x660            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifier_WarpStone_Caster_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CModifier_WarpStone_Caster_VData) == 0x740);
    };
};
