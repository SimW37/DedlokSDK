...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ParticleAOEHeal[0xe0]; // 0x978            
            ...
            source2sdk::client::TimeScalingValue_t m_flHealMaxHealthPercent; // 0xa58            
            // metadata: MPropertyFriendlyName "Instant heal"
            // metadata: MPropertyDescription "Fixed amount to heal instantly on pickup"
            source2sdk::client::TimeScalingValue_t m_flHealFixed; // 0xa68            
            ...
            source2sdk::client::TimeScalingValue_t m_flMissingPctHeal; // 0xa78            
            ...
            source2sdk::client::TimeScalingValue_t m_flRegenMaxHealthPercent; // 0xa88            
            // metadata: MPropertyFriendlyName "Regen"
            // metadata: MPropertyDescription "Amount of health to regen over time"
            source2sdk::client::TimeScalingValue_t m_flRegenFixed; // 0xa98            
            ...
            char m_RegenModifier[0x10]; // 0xad0            
            ...
            source2sdk::client::CITADEL_UNIT_TARGET_TYPE m_AOETargetTypes; // 0xae4            
            // metadata: MPropertySuppressExpr "m_flAOERadius == 0"
            // metadata: MPropertyFriendlyName "Targeting Flags"
            source2sdk::client::CITADEL_UNIT_TARGET_FLAGS m_AOETargetFlags; // 0xae8            
            // metadata: MPropertySuppressExpr "m_flAOERadius == 0"
            // metadata: MPropertyFriendlyName "LOS Method"
            source2sdk::client::ELOSCheck m_AOELOSCheckType; // 0xaec            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_BreakablePropHealthPickupVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_BreakablePropHealthPickupVData) == 0xaf0);
    };
};
