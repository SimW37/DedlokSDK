...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Operative_Blindside_VData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_EnemyDebuffModifier[0x10]; // 0x15e8            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Operative_Blindside_VData) == 0x16e8);
    };
};
