...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Bookworm_KnightBarrierVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_BarrierModifier[0x10]; // 0x1620            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Bookworm_KnightBarrierVData) == 0x1630);
    };
};
