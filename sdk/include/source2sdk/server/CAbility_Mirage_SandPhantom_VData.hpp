...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbility_Mirage_SandPhantom_VData : public source2sdk::server::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CAbility_Mirage_SandPhantom_VData) == 0x1610);
    };
};
