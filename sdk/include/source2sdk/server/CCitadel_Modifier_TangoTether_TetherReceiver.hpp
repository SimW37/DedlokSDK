...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0xc0            
            uint8_t _pad00c4[0x54];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_TangoTether_TetherReceiver) == 0x118);
    };
};
