...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_AllySmokeAOEModifier[0x10]; // 0x1618            
            ...
            char m_EnemySmokeAOEModifier[0x10]; // 0x1628            
            ...
            char m_PurgeParticle[0xe0]; // 0x1638            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityTokamakBreachVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityTokamakBreachVData) == 0x1718);
    };
};
