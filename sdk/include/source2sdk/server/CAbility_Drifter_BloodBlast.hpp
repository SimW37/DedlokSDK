...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_SandEffect; // 0x1790            
            ...
            char m_vecHitTargets[0x18]; // 0x1798            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Drifter_BloodBlast because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbility_Drifter_BloodBlast) == 0x17b0);
    };
};
