...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hDamageTakenParticle) == 0x38);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGroundDamageTakenParticle) == 0x118);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hDeathParticle) == 0x1f8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hLowHealthParticle) == 0x2d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strSelectionImage) == 0x3b8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strIconImageSmall) == 0x3c8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strIconHeroCard) == 0x3d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMinimapImage) == 0x3e8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strTopBarImage) == 0x3f8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strTopBarVertical) == 0x408);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hRespawnParticle) == 0x418);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorUI) == 0x4f8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowFriendly) == 0x4fc);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowEnemy) == 0x500);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowTeam1) == 0x504);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowTeam2) == 0x508);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strModelName) == 0x510);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nModelSkin) == 0x5f0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strWIPModelName) == 0x5f8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMainOnlyModelName) == 0x6d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_iAddedTime) == 0x7b8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strUIPortraitMap) == 0x7c0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strUIShoppingMap) == 0x7c8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_heroStatsUI) == 0x7d0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_heroStatsDisplay) == 0x800);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_ShopStatDisplay) == 0x890);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strDeathSound) == 0x938);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLastHitSound) == 0x948);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterSelectedSound) == 0x958);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterRemovedSound) == 0x968);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strVoteRevealSound) == 0x978);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLowHealthSound) == 0x988);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHeroSpecificLowHealthSound) == 0x998);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMovementLoop) == 0x9a8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strPostGameVictorySound) == 0x9b8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strPostGameDefeatSound) == 0x9c8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGameSoundEventScript) == 0x9d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGeneratedVOEventScript) == 0xab8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flStealthSpeedMetersPerSecond) == 0xb98);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flCollisionRadius) == 0xb9c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flCollisionHeight) == 0xba0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flStepHeight) == 0xba4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bInDevelopment) == 0xba8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bAssignedPlayersOnly) == 0xba9);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNewPlayerRecommended) == 0xbaa);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bLaneTestingRecommended) == 0xbab);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNeedsTesting) == 0xbac);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bLimitedTesting) == 0xbad);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bDisabled) == 0xbae);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bPlayerSelectable) == 0xbaf);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bPrereleaseOnly) == 0xbb0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nComplexity) == 0xbb4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nAllyBotDifficulty) == 0xbb8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nEnemyBotDifficulty) == 0xbbc);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinLowHealthPercentage) == 0xbc0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxLowHealthPercentage) == 0xbc4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinMidHealthPercentage) == 0xbc8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxMidHealthPercentage) == 0xbcc);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinHealthForThreshold) == 0xbd0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxHealthForThreshold) == 0xbd4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithHeroDuration) == 0xbd8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithNonHeroDuration) == 0xbdc);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStartingStats) == 0xbe0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapScalingStats) == 0xc08);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_groundDashPositionCurve) == 0xc30);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapModCostBonuses) == 0xc70);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapBoundAbilities) == 0xcb0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapWIPAbilities) == 0xcd8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapItemSlotInfo) == 0xd00);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapRecommendedUpgradeHints) == 0xd28);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedUpgrades) == 0xd78);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedUpgradeTags) == 0xda8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedAbilityOrder) == 0xe28);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eAbilityResourceType) == 0xe58);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strGunTag) == 0xe60);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_vecHeroTags) == 0xe68);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eHeroType) == 0xe80);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterBackgroundLayout) == 0xe88);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHideoutRichPresence) == 0xe90);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStandardLevelUpUpgrades) == 0xeb0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapLevelInfo) == 0xed8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapPurchaseBonuses) == 0xf00);
        
        static_assert(sizeof(source2sdk::server::CitadelHeroData_t) == 0xf28);
    };
};
