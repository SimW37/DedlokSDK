...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nModelSkin; // 0x6c8            
            ...
            std::uint64_t m_iAddedTime; // 0x890            
            // metadata: MPropertyAttributeEditor "AssetBrowse( vmap )"
            CUtlString m_strUIPortraitMap; // 0x898            
            // metadata: MPropertyAttributeEditor "AssetBrowse( vmap )"
            CUtlString m_strUIShoppingMap; // 0x8a0            
            source2sdk::client::HeroStatsUI_t m_heroStatsUI; // 0x8a8            
            source2sdk::client::HeroStatsDisplay_t m_heroStatsDisplay; // 0x8d8            
            source2sdk::client::CitadelStatsDisplay_t m_ShopStatDisplay; // 0x968            
            ...
            std::int32_t m_nComplexity; // 0xc5c            
            ...
            char m_mapStartingStats[0x28]; // 0xc88            
            ...
            char m_mapScalingStats[0x28]; // 0xcb0            
            CPiecewiseCurve m_groundDashPositionCurve; // 0xcd8            
            ...
            char m_mapModCostBonuses[0x28]; // 0xd18            
            uint8_t _pad0d40[0x18]; // 0xd40
            ...
            char m_mapBoundAbilities[0x28]; // 0xd58            
            ...
            char m_mapWIPAbilities[0x28]; // 0xd80            
            ...
            char m_mapItemSlotInfo[0x28]; // 0xda8            
            ...
            char m_mapRecommendedUpgradeHints[0x28]; // 0xdd0            
            uint8_t _pad0df8[0x28]; // 0xdf8
            ...
            char m_RecommendedUpgrades[0x18]; // 0xe20            
            uint8_t _pad0e38[0x18]; // 0xe38
            ...
            char m_RecommendedUpgradeTags[0x18]; // 0xe50            
            uint8_t _pad0e68[0x70]; // 0xe68
            ...
            char m_RecommendedAbilityOrder[0x18]; // 0xed8            
            uint8_t _pad0ef0[0x18]; // 0xef0
            source2sdk::client::EAbilityResourceType m_eAbilityResourceType; // 0xf08            
            ...
            char m_mapStandardLevelUpUpgrades[0x28]; // 0xf28            
            ...
            char m_mapLevelInfo[0x28]; // 0xf50            
            ...
            char m_mapPurchaseBonuses[0x28]; // 0xf78            
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_sAG2VariationName) == 0x30);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hDamageTakenParticle) == 0x110);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGroundDamageTakenParticle) == 0x1f0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hDeathParticle) == 0x2d0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hLowHealthParticle) == 0x3b0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strSelectionImage) == 0x490);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strIconImageSmall) == 0x4a0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strIconHeroCard) == 0x4b0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMinimapImage) == 0x4c0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strTopBarImage) == 0x4d0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strTopBarVertical) == 0x4e0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hRespawnParticle) == 0x4f0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorUI) == 0x5d0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowFriendly) == 0x5d4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowEnemy) == 0x5d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowTeam1) == 0x5dc);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowTeam2) == 0x5e0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strModelName) == 0x5e8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nModelSkin) == 0x6c8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strWIPModelName) == 0x6d0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMainOnlyModelName) == 0x7b0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_iAddedTime) == 0x890);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strUIPortraitMap) == 0x898);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strUIShoppingMap) == 0x8a0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_heroStatsUI) == 0x8a8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_heroStatsDisplay) == 0x8d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_ShopStatDisplay) == 0x968);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strDeathSound) == 0xa10);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLastHitSound) == 0xa20);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterSelectedSound) == 0xa30);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterRemovedSound) == 0xa40);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLowHealthSound) == 0xa50);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHeroSpecificLowHealthSound) == 0xa60);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMovementLoop) == 0xa70);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGameSoundEventScript) == 0xa80);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGeneratedVOEventScript) == 0xb60);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flStealthSpeedMetersPerSecond) == 0xc40);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flCollisionRadius) == 0xc44);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flCollisionHeight) == 0xc48);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flStepHeight) == 0xc4c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bInDevelopment) == 0xc50);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bAssignedPlayersOnly) == 0xc51);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNewPlayerRecommended) == 0xc52);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bLaneTestingRecommended) == 0xc53);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNeedsTesting) == 0xc54);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bLimitedTesting) == 0xc55);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bDisabled) == 0xc56);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bPlayerSelectable) == 0xc57);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bAvailableInHeroLabs) == 0xc58);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nComplexity) == 0xc5c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nAllyBotDifficulty) == 0xc60);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nEnemyBotDifficulty) == 0xc64);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinLowHealthPercentage) == 0xc68);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxLowHealthPercentage) == 0xc6c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinMidHealthPercentage) == 0xc70);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxMidHealthPercentage) == 0xc74);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinHealthForThreshold) == 0xc78);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxHealthForThreshold) == 0xc7c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithHeroDuration) == 0xc80);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithNonHeroDuration) == 0xc84);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStartingStats) == 0xc88);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapScalingStats) == 0xcb0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_groundDashPositionCurve) == 0xcd8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapModCostBonuses) == 0xd18);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapBoundAbilities) == 0xd58);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapWIPAbilities) == 0xd80);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapItemSlotInfo) == 0xda8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapRecommendedUpgradeHints) == 0xdd0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedUpgrades) == 0xe20);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedUpgradeTags) == 0xe50);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedAbilityOrder) == 0xed8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eAbilityResourceType) == 0xf08);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStandardLevelUpUpgrades) == 0xf28);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapLevelInfo) == 0xf50);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapPurchaseBonuses) == 0xf78);
        
        static_assert(sizeof(source2sdk::server::CitadelHeroData_t) == 0xfa0);
    };
};
