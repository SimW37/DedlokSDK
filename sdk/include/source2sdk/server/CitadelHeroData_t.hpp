...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_sAG2VariationName) == 0x38);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hDamageTakenParticle) == 0x118);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGroundDamageTakenParticle) == 0x1f8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hDeathParticle) == 0x2d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hLowHealthParticle) == 0x3b8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strSelectionImage) == 0x498);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strIconImageSmall) == 0x4a8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strIconHeroCard) == 0x4b8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMinimapImage) == 0x4c8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strTopBarImage) == 0x4d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strTopBarVertical) == 0x4e8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hRespawnParticle) == 0x4f8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorUI) == 0x5d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowFriendly) == 0x5dc);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowEnemy) == 0x5e0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowTeam1) == 0x5e4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorGlowTeam2) == 0x5e8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strModelName) == 0x5f0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nModelSkin) == 0x6d0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strWIPModelName) == 0x6d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMainOnlyModelName) == 0x7b8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_iAddedTime) == 0x898);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strUIPortraitMap) == 0x8a0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strUIShoppingMap) == 0x8a8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_heroStatsUI) == 0x8b0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_heroStatsDisplay) == 0x8e0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_ShopStatDisplay) == 0x970);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strDeathSound) == 0xa18);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLastHitSound) == 0xa28);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterSelectedSound) == 0xa38);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterRemovedSound) == 0xa48);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLowHealthSound) == 0xa58);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHeroSpecificLowHealthSound) == 0xa68);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMovementLoop) == 0xa78);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strPostGameVictorySound) == 0xa88);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strPostGameDefeatSound) == 0xa98);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGameSoundEventScript) == 0xaa8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGeneratedVOEventScript) == 0xb88);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flStealthSpeedMetersPerSecond) == 0xc68);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flCollisionRadius) == 0xc6c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flCollisionHeight) == 0xc70);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flStepHeight) == 0xc74);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bInDevelopment) == 0xc78);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bAssignedPlayersOnly) == 0xc79);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNewPlayerRecommended) == 0xc7a);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bLaneTestingRecommended) == 0xc7b);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNeedsTesting) == 0xc7c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bLimitedTesting) == 0xc7d);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bDisabled) == 0xc7e);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bPlayerSelectable) == 0xc7f);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bPrereleaseOnly) == 0xc80);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nComplexity) == 0xc84);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nAllyBotDifficulty) == 0xc88);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nEnemyBotDifficulty) == 0xc8c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinLowHealthPercentage) == 0xc90);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxLowHealthPercentage) == 0xc94);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinMidHealthPercentage) == 0xc98);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxMidHealthPercentage) == 0xc9c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinHealthForThreshold) == 0xca0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxHealthForThreshold) == 0xca4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithHeroDuration) == 0xca8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithNonHeroDuration) == 0xcac);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStartingStats) == 0xcb0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapScalingStats) == 0xcd8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_groundDashPositionCurve) == 0xd00);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapModCostBonuses) == 0xd40);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapBoundAbilities) == 0xd80);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapWIPAbilities) == 0xda8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapItemSlotInfo) == 0xdd0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapRecommendedUpgradeHints) == 0xdf8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedUpgrades) == 0xe48);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedUpgradeTags) == 0xe78);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedAbilityOrder) == 0xef8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eAbilityResourceType) == 0xf28);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strGunTag) == 0xf30);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_vecHeroTags) == 0xf38);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eHeroType) == 0xf50);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterBackgroundLayout) == 0xf58);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHideoutRichPresence) == 0xf60);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStandardLevelUpUpgrades) == 0xf80);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapLevelInfo) == 0xfa8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapPurchaseBonuses) == 0xfd0);
        
        static_assert(sizeof(source2sdk::server::CitadelHeroData_t) == 0xff8);
    };
};
