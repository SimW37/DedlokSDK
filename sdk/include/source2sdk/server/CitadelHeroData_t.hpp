...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_strVoteRevealSound; // 0x9b0            
            CSoundEventName m_strLowHealthSound; // 0x9c0            
            CSoundEventName m_strHeroSpecificLowHealthSound; // 0x9d0            
            CSoundEventName m_strMovementLoop; // 0x9e0            
            CSoundEventName m_strPostGameVictorySound; // 0x9f0            
            CSoundEventName m_strPostGameDefeatSound; // 0xa00            
            ...
            char m_hGameSoundEventScript[0xe0]; // 0xa10            
            ...
            char m_hGeneratedVOEventScript[0xe0]; // 0xaf0            
            float m_flStealthSpeedMetersPerSecond; // 0xbd0            
            // metadata: MPropertyStartGroup
            bool m_bInDevelopment; // 0xbd4            
            bool m_bAssignedPlayersOnly; // 0xbd5            
            bool m_bNewPlayerRecommended; // 0xbd6            
            bool m_bLaneTestingRecommended; // 0xbd7            
            bool m_bNeedsTesting; // 0xbd8            
            bool m_bLimitedTesting; // 0xbd9            
            bool m_bDisabled; // 0xbda            
            bool m_bPlayerSelectable; // 0xbdb            
            bool m_bPrereleaseOnly; // 0xbdc            
            uint8_t _pad0bdd[0x3]; // 0xbdd
            std::int32_t m_nComplexity; // 0xbe0            
            ...
            char m_mapStartingStats[0x28]; // 0xc18            
            ...
            char m_mapScalingStats[0x28]; // 0xc40            
            CPiecewiseCurve m_groundDashPositionCurve; // 0xc68            
            ...
            char m_mapModCostBonuses[0x28]; // 0xca8            
            ...
            char m_mapBoundAbilities[0x28]; // 0xce8            
            ...
            char m_mapWIPAbilities[0x28]; // 0xd10            
            ...
            char m_mapItemSlotInfo[0x28]; // 0xd38            
            uint8_t _pad0d60[0x50]; // 0xd60
            source2sdk::client::EAbilityResourceType m_eAbilityResourceType; // 0xdb0            
            uint8_t _pad0db4[0x4]; // 0xdb4
            CUtlString m_strGunTag; // 0xdb8            
            ...
            char m_vecHeroTags[0x18]; // 0xdc0            
            source2sdk::client::EHeroType m_eHeroType; // 0xdd8            
            uint8_t _pad0ddc[0x4]; // 0xddc
            CUtlString m_strRosterBackgroundLayout; // 0xde0            
            CUtlString m_strHideoutRichPresence; // 0xde8            
            ...
            char m_mapItemDraftCounterWeights[0x28]; // 0xdf0            
            uint8_t _pad0e18[0x18]; // 0xe18
            ...
            char m_mapStandardLevelUpUpgrades[0x28]; // 0xe30            
            ...
            char m_mapLevelInfo[0x28]; // 0xe58            
            ...
            char m_mapPurchaseBonuses[0x28]; // 0xe80            
            // metadata: MPropertyMapKeyLeafChoiceProviderFn
            ...
            char m_mapItemDraftBucketing[0x28]; // 0xea8            
            uint8_t _pad0ed0[0x28];
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_vecAnimGraphDefaultValueOverrides) == 0x8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_HeroID) == 0x28);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHeroSortName) == 0x30);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHeroSearchName) == 0x38);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hDamageTakenParticle) == 0x40);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGroundDamageTakenParticle) == 0x120);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hDeathParticle) == 0x200);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hLowHealthParticle) == 0x2e0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strIconImageSmall) == 0x3c0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strIconHeroCard) == 0x3d0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strIconHeroCardCritical) == 0x3e0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strIconHeroCardGloat) == 0x3f0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMinimapImage) == 0x400);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strTopBarVertical) == 0x410);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLogoImageEnglish) == 0x420);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLogoImageLocalized) == 0x430);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hRespawnParticle) == 0x440);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_colorUI) == 0x520);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strModelName) == 0x528);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nModelSkin) == 0x608);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strWIPModelName) == 0x610);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMainOnlyModelName) == 0x6f0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bUseMainOnlyModelForExperimental) == 0x7d0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strUIPortraitMap) == 0x7d8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strUIShoppingMap) == 0x7e0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strUITeamRevealMap) == 0x7e8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strUIPostgamePortraitMap) == 0x7f0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_heroStatsUI) == 0x7f8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_heroStatsDisplay) == 0x828);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_ShopStatDisplay) == 0x8b8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strDeathVOSound) == 0x960);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strDeathSound) == 0x970);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLastHitSound) == 0x980);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterSelectedSound) == 0x990);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterRemovedSound) == 0x9a0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strVoteRevealSound) == 0x9b0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLowHealthSound) == 0x9c0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHeroSpecificLowHealthSound) == 0x9d0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMovementLoop) == 0x9e0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strPostGameVictorySound) == 0x9f0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strPostGameDefeatSound) == 0xa00);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGameSoundEventScript) == 0xa10);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGeneratedVOEventScript) == 0xaf0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flStealthSpeedMetersPerSecond) == 0xbd0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bInDevelopment) == 0xbd4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bAssignedPlayersOnly) == 0xbd5);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNewPlayerRecommended) == 0xbd6);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bLaneTestingRecommended) == 0xbd7);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNeedsTesting) == 0xbd8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bLimitedTesting) == 0xbd9);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bDisabled) == 0xbda);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bPlayerSelectable) == 0xbdb);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bPrereleaseOnly) == 0xbdc);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nComplexity) == 0xbe0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nAllyBotDifficulty) == 0xbe4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nEnemyBotDifficulty) == 0xbe8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinLowHealthPercentage) == 0xbec);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxLowHealthPercentage) == 0xbf0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinMidHealthPercentage) == 0xbf4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxMidHealthPercentage) == 0xbf8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinHealthForThreshold) == 0xbfc);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxHealthForThreshold) == 0xc00);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithHeroDuration) == 0xc04);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithNonHeroDuration) == 0xc08);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithNeutralDuration) == 0xc0c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNAGunFalloffRange) == 0xc10);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStartingStats) == 0xc18);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapScalingStats) == 0xc40);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_groundDashPositionCurve) == 0xc68);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapModCostBonuses) == 0xca8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapBoundAbilities) == 0xce8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapWIPAbilities) == 0xd10);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapItemSlotInfo) == 0xd38);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eAbilityResourceType) == 0xdb0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strGunTag) == 0xdb8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_vecHeroTags) == 0xdc0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eHeroType) == 0xdd8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterBackgroundLayout) == 0xde0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHideoutRichPresence) == 0xde8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapItemDraftCounterWeights) == 0xdf0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStandardLevelUpUpgrades) == 0xe30);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapLevelInfo) == 0xe58);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapPurchaseBonuses) == 0xe80);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapItemDraftBucketing) == 0xea8);
        
        static_assert(sizeof(source2sdk::server::CitadelHeroData_t) == 0xef8);
    };
};
