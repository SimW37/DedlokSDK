...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad0b98[0x14]; // 0xb98
            source2sdk::client::ParticleIndex_t m_nBallParticle; // 0xbac            
            source2sdk::client::ParticleIndex_t m_nCastCompleteParticle; // 0xbb0            
            ...
            char m_vecTargetsHit[0x18]; // 0xbb8            
            uint8_t _pad0bd0[0x100]; // 0xbd0
            // metadata: MNetworkEnable
            bool m_bHoldingBall; // 0xcd0            
            uint8_t _pad0cd1[0x7];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_WreckingBall because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_WreckingBall) == 0xcd8);
    };
};
