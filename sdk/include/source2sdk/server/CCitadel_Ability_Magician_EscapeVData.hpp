...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Magician_EscapeVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_EscapedModifier;
            char m_EscapedModifier[0x10]; // 0x1620            
            ...
            char m_PoofParticle[0xe0]; // 0x1630            
            ...
            char m_TetherParticle[0xe0]; // 0x1710            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strEscaped; // 0x17f0            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceTeleport; // 0x1800            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Magician_EscapeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Magician_EscapeVData) == 0x1888);
    };
};
