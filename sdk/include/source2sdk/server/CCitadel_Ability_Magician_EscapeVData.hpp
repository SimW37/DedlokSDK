...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_EscapedModifier[0x10]; // 0x1618            
            ...
            char m_PoofParticle[0xe0]; // 0x1628            
            ...
            char m_TetherParticle[0xe0]; // 0x1708            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strEscaped; // 0x17e8            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Magician_EscapeVData) == 0x1880);
    };
};
