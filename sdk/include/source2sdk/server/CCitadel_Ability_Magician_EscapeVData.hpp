...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_EscapedModifier[0x10]; // 0x15e8            
            ...
            char m_PoofParticle[0xe0]; // 0x15f8            
            ...
            char m_TetherParticle[0xe0]; // 0x16d8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strEscaped; // 0x17b8            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceTeleport; // 0x17c8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Magician_EscapeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Magician_EscapeVData) == 0x1850);
    };
};
