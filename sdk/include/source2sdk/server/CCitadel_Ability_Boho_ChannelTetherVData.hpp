...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Boho_ChannelTetherVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ImmobilizeModifier;
            char m_ImmobilizeModifier[0x10]; // 0x1638            
            ...
            char m_StartAoEParticle[0xe0]; // 0x1648            
            ...
            char m_ExitAoEParticle[0xe0]; // 0x1728            
            ...
            char m_EffectParticle[0xe0]; // 0x1808            
            ...
            char m_HitParticle[0xe0]; // 0x18e8            
            ...
            char m_RadiusParticle[0xe0]; // 0x19c8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strExpireSound; // 0x1aa8            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Boho_ChannelTetherVData) == 0x1b50);
    };
};
