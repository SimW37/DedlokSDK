...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_WeaponUpgrade_SpellslingerHeadshots_VData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_HeadshotDebuffModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_WeaponUpgrade_SpellslingerHeadshots_VData) == 0x1798);
    };
};
