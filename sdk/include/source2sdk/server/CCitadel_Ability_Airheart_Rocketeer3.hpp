...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nJetpackFireFX; // 0x1490            
            uint8_t _pad1494[0x28]; // 0x1494
            Vector m_vDebugVelocityIntentModelSpace; // 0x14bc            
            float m_flDebugCoeffFactor; // 0x14c8            
            // metadata: MNetworkEnable
            bool m_bJetpackActive; // 0x14cc            
            uint8_t _pad14cd[0x3]; // 0x14cd
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tJetpackInputDownTime; // 0x14d0            
            // metadata: MNetworkEnable
            Vector m_vPreservedVelocity; // 0x14d4            
            // metadata: MNetworkEnable
            bool m_bHasLeftGround; // 0x14e0            
            // metadata: MNetworkEnable
            bool m_bOutOfFuelAndHaventTouchedGround; // 0x14e1            
            // metadata: MNetworkEnable
            source2sdk::client::EJetpackMode_t m_eMode; // 0x14e2            
            uint8_t _pad14e3[0x1]; // 0x14e3
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tModeBeginTime; // 0x14e4            
            // metadata: MNetworkEnable
            Vector m_vJetpackInput; // 0x14e8            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tLastWallAttachTime; // 0x14f4            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tLastGroundedTime; // 0x14f8            
            // metadata: MNetworkEnable
            bool m_bQueueWallAttachJump; // 0x14fc            
            uint8_t _pad14fd[0x3]; // 0x14fd
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tOverdriveBeginTime; // 0x1500            
            // metadata: MNetworkEnable
            Vector m_vIntentSpaceMPCVelocity; // 0x1504            
            // metadata: MNetworkEnable
            Vector m_vIntentSpaceMPCOrigin; // 0x1510            
            // metadata: MNetworkEnable
            float m_flIntentSpeedVerticalActual; // 0x151c            
            // metadata: MNetworkEnable
            float m_flIntentMultiplier; // 0x1520            
            uint8_t _pad1524[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Airheart_Rocketeer3 because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Airheart_Rocketeer3) == 0x1528);
    };
};
