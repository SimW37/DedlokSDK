...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifier_WreckerScrapBlastDebuffVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CModifier_WreckerScrapBlastDebuffVData) == 0x740);
    };
};
