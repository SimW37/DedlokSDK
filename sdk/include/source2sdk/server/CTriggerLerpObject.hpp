...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::modellib::AttachmentHandle_t m_hLerpTargetAttachment; // 0x9a8            
            ...
            source2sdk::entity2::CEntityIOOutput m_OnLerpStarted; // 0x9e8            
            source2sdk::entity2::CEntityIOOutput m_OnLerpFinished; // 0xa10            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerLerpObject) == 0xa38);
    };
};
