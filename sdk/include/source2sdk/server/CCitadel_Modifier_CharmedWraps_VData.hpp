...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_CharmedWraps_VData : public server::CCitadel_Modifier_BaseEventProcVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_CharmedWraps_VData) == 0x848);
};
