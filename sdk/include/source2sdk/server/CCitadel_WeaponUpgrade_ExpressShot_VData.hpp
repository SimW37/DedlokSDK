...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ReadyParticle[0xe0]; // 0x1680            
            ...
            char m_TracerAdditionParticle[0xe0]; // 0x1760            
            // metadata: MPropertyGroupName "Gameplay"
            float flShotDelay; // 0x1840            
            uint8_t _pad1844[0x4]; // 0x1844
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strOffCooldownSound; // 0x1848            
            ...
            char m_ProcNotificationModifier[0x10]; // 0x1858            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_ExpressShot_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_WeaponUpgrade_ExpressShot_VData) == 0x1868);
    };
};
