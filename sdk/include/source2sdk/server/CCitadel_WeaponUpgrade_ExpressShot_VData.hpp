...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ReadyParticle[0xe0]; // 0x1678            
            ...
            char m_TracerAdditionParticle[0xe0]; // 0x1758            
            // metadata: MPropertyGroupName "Gameplay"
            float flShotDelay; // 0x1838            
            uint8_t _pad183c[0x4]; // 0x183c
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strOffCooldownSound; // 0x1840            
            ...
            char m_ProcNotificationModifier[0x10]; // 0x1850            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_ExpressShot_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_WeaponUpgrade_ExpressShot_VData) == 0x1860);
    };
};
