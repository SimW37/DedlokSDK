...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_ThermalDetonator_ThinkerVData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_ThermalDetonator_ThinkerVData) == 0x870);
    };
};
