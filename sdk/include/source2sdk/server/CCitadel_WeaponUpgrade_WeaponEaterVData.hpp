...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_WeaponUpgrade_WeaponEaterVData : public server::CitadelItemVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_WeaponEaterTracker;
        char m_WeaponEaterTracker[0x10]; // 0x1668        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_WeaponEaterVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_WeaponUpgrade_WeaponEaterVData) == 0x1678);
};
