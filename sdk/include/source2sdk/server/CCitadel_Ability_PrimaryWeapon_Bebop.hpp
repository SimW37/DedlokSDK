...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad0d70[0x2e8]; // 0xd70
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartWindUpTime; // 0x1058            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartFiringTime; // 0x105c            
            // metadata: MNetworkEnable
            bool m_bFiring; // 0x1060            
            uint8_t _pad1061[0x157];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_PrimaryWeapon_Bebop because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_PrimaryWeapon_Bebop) == 0x11b8);
    };
};
