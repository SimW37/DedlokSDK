...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CModifierVandalOverflowVData : public server::CCitadel_Modifier_StunnedVData
    {
    public:
        ...
        char m_LiftParticle[0xe0]; // 0x738        
    ...
    static_assert(sizeof(CModifierVandalOverflowVData) == 0x828);
};
