...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifierVandalOverflowVData : public source2sdk::server::CCitadel_Modifier_StunnedVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CModifierVandalOverflowVData) == 0x830);
    };
};
