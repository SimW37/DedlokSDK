...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vecOffsetDir; // 0x1c0            
            float m_flTackleRadius; // 0x1cc            
            float m_flPullTargetSpeed; // 0x1d0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_ChargePullEnemy) == 0x1d8);
    };
};
