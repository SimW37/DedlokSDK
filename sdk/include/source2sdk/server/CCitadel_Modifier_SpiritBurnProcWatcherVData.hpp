...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_SpiritBurnProcWatcherVData : public server::CCitadel_Modifier_BaseEventProcVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CBaseModifier> m_SpiritBurnDamageTracker;
