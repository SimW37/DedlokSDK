...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Frank_PainAuraVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        // Cannot assert offsets of fields in CCitadel_Modifier_Frank_PainAuraVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Frank_PainAuraVData) == 0x750);
    };
};
