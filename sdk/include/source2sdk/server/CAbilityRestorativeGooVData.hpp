...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_RestorativeGooParticle[0xe0]; // 0x15f0            
            ...
            char m_RestorativeGooModifier[0x10]; // 0x16d0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityRestorativeGooVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityRestorativeGooVData) == 0x16e0);
    };
};
