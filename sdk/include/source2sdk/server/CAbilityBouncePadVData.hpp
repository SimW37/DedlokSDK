...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityBouncePadVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_BounceModifier;
            char m_BounceModifier[0x10]; // 0x1620            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_AllyBounceModifier;
            char m_AllyBounceModifier[0x10]; // 0x1630            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SpeedOnLandModifier;
            char m_SpeedOnLandModifier[0x10]; // 0x1640            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_NoBounceModifier;
            char m_NoBounceModifier[0x10]; // 0x1650            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityBouncePadVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityBouncePadVData) == 0x1660);
    };
};
