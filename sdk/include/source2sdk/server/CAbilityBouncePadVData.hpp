...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_BounceModifier[0x10]; // 0x15e8            
            ...
            char m_AllyBounceModifier[0x10]; // 0x15f8            
            ...
            char m_SpeedOnLandModifier[0x10]; // 0x1608            
            ...
            char m_NoBounceModifier[0x10]; // 0x1618            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityBouncePadVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityBouncePadVData) == 0x1628);
    };
};
