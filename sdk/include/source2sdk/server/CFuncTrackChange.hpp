...
namespace source2sdk::server
{
    ...
    {
    public:
        server::CPathTrack* m_trackTop; // 0x898        
        server::CPathTrack* m_trackBottom; // 0x8a0        
        server::CFuncTrackTrain* m_train; // 0x8a8        
        CUtlSymbolLarge m_trackTopName; // 0x8b0        
        CUtlSymbolLarge m_trackBottomName; // 0x8b8        
        CUtlSymbolLarge m_trainName; // 0x8c0        
        server::TRAIN_CODE m_code; // 0x8c8        
        int32_t m_targetState; // 0x8cc        
        int32_t m_use; // 0x8d0        
    ...
    static_assert(sizeof(CFuncTrackChange) == 0x8d8);
};
