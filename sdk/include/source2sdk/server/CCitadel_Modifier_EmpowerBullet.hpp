...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_EmpowerBullet : public source2sdk::server::CCitadel_Modifier_BaseBulletPreRollProc
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_EmpowerBullet) == 0x220);
    };
};
