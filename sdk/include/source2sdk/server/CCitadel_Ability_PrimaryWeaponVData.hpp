...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad15f0[0x8]; // 0x15f0
            // metadata: MPropertyDescription "The DOF settings to apply while zoomed in."
            source2sdk::client::DOFDesc_t m_DOFWhileZoomed; // 0x15f8            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_PrimaryWeaponVData) == 0x1648);
    };
};
