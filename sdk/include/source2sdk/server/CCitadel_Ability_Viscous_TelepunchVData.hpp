...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_PortalParticle[0xe0]; // 0x1620            
            ...
            char m_PunchParticle[0xe0]; // 0x17e0            
            ...
            char m_WallPunchParticle[0xe0]; // 0x18c0            
            ...
            char m_CeilingPunchParticle[0xe0]; // 0x19a0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_EnemyPortalSound; // 0x1a80            
            CSoundEventName m_SelfPortalSound; // 0x1a90            
            CSoundEventName m_WindupSound; // 0x1aa0            
            CSoundEventName m_PunchSound; // 0x1ab0            
            ...
            char m_PunchRollSlowModifier[0x10]; // 0x1ac0            
            ...
            float m_flEnemyPortalTelegraphTime; // 0x1ae0            
            float m_flSelfPortalTelegraphTime; // 0x1ae4            
            float m_flWindupTime; // 0x1ae8            
            float m_flAttackTime; // 0x1aec            
            float m_flGroundTraceOnPlayerHitDistance; // 0x1af0            
            float m_flPlayerCheckSphereRadius; // 0x1af4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Viscous_TelepunchVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Viscous_TelepunchVData) == 0x1af8);
    };
};
