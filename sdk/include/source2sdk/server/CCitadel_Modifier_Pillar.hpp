...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_Pillar : public source2sdk::server::CCitadel_Modifier_Stunned
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Pillar) == 0x110);
    };
};
