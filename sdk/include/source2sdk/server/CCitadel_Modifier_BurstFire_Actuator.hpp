...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nHitCounter; // 0xc4            
            std::int32_t m_nTotalBurstFireShots; // 0xc8            
            std::int32_t m_nInitialzedClipSize; // 0xcc            
            std::int32_t m_nBonusPitch; // 0xd0            
            bool m_bInitialized; // 0xd4            
            uint8_t _pad00d5[0x3]; // 0xd5
            std::int32_t m_nIncreasedBurstShotCount; // 0xd8            
