...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_KillableModifier[0x10]; // 0x1610        
        ...
        char m_AttackParticle[0xe0]; // 0x1620        
        ...
        char m_FlashParticle[0xe0]; // 0x17e0        
        ...
        char m_KillingBlowCastParticle[0xe0]; // 0x18c0        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_ChargeUpSound; // 0x19a0        
        CSoundEventName m_OnKillSound; // 0x19b0        
        // metadata: MPropertyStartGroup "+Killing Blow Params"
        float m_flPreArrivalAttackStartTime; // 0x19c0        
        float m_flKillableGlowRange; // 0x19c4        
        float m_flGlowMinTime; // 0x19c8        
        [[maybe_unused]] std::uint8_t pad_0x19cc[0x4];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Shiv_KillingBlowVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Shiv_KillingBlowVData) == 0x19d0);
};
