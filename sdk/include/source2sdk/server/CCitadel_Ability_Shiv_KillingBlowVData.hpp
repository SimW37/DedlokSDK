...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_KillableModifier[0x10]; // 0x1638            
            ...
            char m_KillingBlowCastParticle[0xe0]; // 0x18e8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_ChargeUpSound; // 0x19c8            
            CSoundEventName m_OnKillSound; // 0x19d8            
            // metadata: MPropertyStartGroup "+Killing Blow Params"
            float m_flPreArrivalAttackStartTime; // 0x19e8            
            float m_flKillableGlowRange; // 0x19ec            
            float m_flGlowMinTime; // 0x19f0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Shiv_KillingBlowVData) == 0x19f8);
    };
};
