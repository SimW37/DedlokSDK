...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadelSpectateDirectedCamera : public source2sdk::server::CBaseEntity
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadelSpectateDirectedCamera) == 0x4f8);
    };
};
