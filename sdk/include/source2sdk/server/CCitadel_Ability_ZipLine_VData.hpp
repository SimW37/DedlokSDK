...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flZiplineAirDrag; // 0x1618            
            float m_flMinButtonHoldTimeToActivate; // 0x161c            
            float m_flCrouchDropSpeedFraction; // 0x1620            
            float m_flCrouchDropAirDragSuppressDuration; // 0x1624            
            float m_flDetachDisallowedTime; // 0x1628            
            float m_flCameraWobbleIntensity; // 0x162c            
            float m_flDismountSpeedMax; // 0x1630            
            float m_flZiplineKnockdownUpImpulse; // 0x1634            
            // metadata: MPropertyDescription "The DOF settings to apply while riding the zipline."
            source2sdk::client::DOFDesc_t m_DOFWhileZiplining; // 0x1638            
            ...
            char m_ZipLinePreviewParticle[0xe0]; // 0x1648            
            ...
            char m_ZipLineSpeedParticle[0xe0]; // 0x1728            
            ...
            char m_ZipLineTetherParticle[0xe0]; // 0x1808            
            ...
            char m_ZipLineTetherAttachParticle[0xe0]; // 0x18e8            
            ...
            char m_ZipLineTetherStartParticle[0xe0]; // 0x19c8            
            ...
            char m_ZipLineEnemyKnockdownProtectionParticle[0xe0]; // 0x1aa8            
            ...
            char m_ZipLineSelfKnockdownProtectionParticle[0xe0]; // 0x1b88            
            ...
            char m_ZipLineKnockdownProtectionStatusParticle[0xe0]; // 0x1c68            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strZipLineSummonSound; // 0x1d48            
            CSoundEventName m_strZipLineStartSound; // 0x1d58            
            ...
            char m_RidingZipLineModifier[0x10]; // 0x1d68            
            ...
            char m_KnockedOffSlowModifier[0x10]; // 0x1d78            
            ...
            char m_ZipLineIntroModifier[0x10]; // 0x1d88            
            ...
            char m_ZipLineKnockdownImmuneModifier[0x10]; // 0x1d98            
            ...
            char m_ZipLineSlowModifier[0x10]; // 0x1da8            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceAwaitingTether; // 0x1db8            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceLatched; // 0x1e40            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceAttached; // 0x1ec8            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceClear; // 0x1f50            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ZipLine_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ZipLine_VData) == 0x1fd8);
    };
};
