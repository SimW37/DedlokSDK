...
namespace source2sdk::server
{
    ...
    public:
        ...
        client::DOFDesc_t m_DOFWhileZiplining; // 0x15e0        
        ...
        char m_ZipLinePreviewParticle[0xe0]; // 0x15f0        
        ...
        char m_ZipLineSpeedParticle[0xe0]; // 0x16d0        
        ...
        char m_ZipLineTetherParticle[0xe0]; // 0x17b0        
        ...
        char m_ZipLineTetherAttachParticle[0xe0]; // 0x1890        
        ...
        char m_ZipLineTetherStartParticle[0xe0]; // 0x1970        
        ...
        char m_ZipLineEnemyKnockdownProtectionParticle[0xe0]; // 0x1a50        
        ...
        char m_ZipLineSelfKnockdownProtectionParticle[0xe0]; // 0x1b30        
        ...
        char m_ZipLineKnockdownProtectionStatusParticle[0xe0]; // 0x1c10        
        ...
        char m_RidingZipLineModifier[0x10]; // 0x1d20        
        ...
        char m_KnockedOffSlowModifier[0x10]; // 0x1d30        
        ...
        char m_ZipLineIntroModifier[0x10]; // 0x1d40        
        ...
        char m_ZipLineKnockdownImmuneModifier[0x10]; // 0x1d50        
        ...
        char m_ZipLineSlowModifier[0x10]; // 0x1d60        
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSequenceAwaitingTether; // 0x1d70        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceLatched; // 0x1df8        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceAttached; // 0x1e80        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceClear; // 0x1f08        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_ZipLine_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_ZipLine_VData) == 0x1f90);
};
