...
namespace source2sdk::server
{
    ...
    public:
        ...
        client::DOFDesc_t m_DOFWhileZiplining; // 0x160c        
        ...
        client::CitadelCameraOperationsSequence_t m_cameraSequenceAwaitingTether; // 0x1da0        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceLatched; // 0x1e28        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceAttached; // 0x1eb0        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceClear; // 0x1f38        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_ZipLine_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_ZipLine_VData) == 0x1fc0);
};
