...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flZiplineAirDrag; // 0x1620            
            float m_flMinButtonHoldTimeToActivate; // 0x1624            
            float m_flCrouchDropSpeedFraction; // 0x1628            
            float m_flCrouchDropAirDragSuppressDuration; // 0x162c            
            float m_flDetachDisallowedTime; // 0x1630            
            float m_flCameraWobbleIntensity; // 0x1634            
            float m_flDismountSpeedMax; // 0x1638            
            float m_flZiplineKnockdownUpImpulse; // 0x163c            
            // metadata: MPropertyDescription "The DOF settings to apply while riding the zipline."
            source2sdk::client::DOFDesc_t m_DOFWhileZiplining; // 0x1640            
            ...
            char m_ZipLinePreviewParticle[0xe0]; // 0x1650            
            ...
            char m_ZipLineSpeedParticle[0xe0]; // 0x1730            
            ...
            char m_ZipLineTetherParticle[0xe0]; // 0x1810            
            ...
            char m_ZipLineTetherAttachParticle[0xe0]; // 0x18f0            
            ...
            char m_ZipLineTetherStartParticle[0xe0]; // 0x19d0            
            ...
            char m_ZipLineEnemyKnockdownProtectionParticle[0xe0]; // 0x1ab0            
            ...
            char m_ZipLineSelfKnockdownProtectionParticle[0xe0]; // 0x1b90            
            ...
            char m_ZipLineKnockdownProtectionStatusParticle[0xe0]; // 0x1c70            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strZipLineSummonSound; // 0x1d50            
            CSoundEventName m_strZipLineLatchedSound; // 0x1d60            
            CSoundEventName m_strZipLineStartSound; // 0x1d70            
            ...
            char m_RidingZipLineModifier[0x10]; // 0x1d80            
            ...
            char m_KnockedOffSlowModifier[0x10]; // 0x1d90            
            ...
            char m_ZipLineIntroModifier[0x10]; // 0x1da0            
            ...
            char m_ZipLineKnockdownImmuneModifier[0x10]; // 0x1db0            
            ...
            char m_ZipLineSlowModifier[0x10]; // 0x1dc0            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceAwaitingTether; // 0x1dd0            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceLatched; // 0x1e58            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceAttached; // 0x1ee0            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceClear; // 0x1f68            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ZipLine_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ZipLine_VData) == 0x1ff0);
    };
};
