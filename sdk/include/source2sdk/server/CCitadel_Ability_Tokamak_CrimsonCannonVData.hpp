...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ChargeParticle[0xe0]; // 0x16f8            
            ...
            char m_CasterOnlyTargetParticle[0xe0]; // 0x17d8            
            ...
            char m_EnemyTargetedParticle[0xe0]; // 0x18b8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strEnemyBeenTargetedSound; // 0x1998            
            CSoundEventName m_strCasterTargetSelectedSound; // 0x19a8            
            CSoundEventName m_strFireSound; // 0x19b8            
            CSoundEventName m_strImpactSound; // 0x19c8            
            CSoundEventName m_strBlockedSound; // 0x19d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Tokamak_CrimsonCannonVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Tokamak_CrimsonCannonVData) == 0x19e8);
    };
};
