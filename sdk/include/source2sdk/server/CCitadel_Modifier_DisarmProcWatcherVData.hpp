...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_DisarmProcWatcherVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_DisarmProcModifier;
            char m_DisarmProcModifier[0x10]; // 0x6a0            
            ...
            char m_ImmunityModifier[0x10]; // 0x6b0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_DisarmProcWatcherVData) == 0x7a0);
    };
};
