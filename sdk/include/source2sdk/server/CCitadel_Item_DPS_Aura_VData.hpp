...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_DPS_Aura_VData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            char m_AOECastParticle[0xe0]; // 0x1678            
            ...
            char m_ActiveModifier[0x10]; // 0x1758            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_DPS_Aura_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Item_DPS_Aura_VData) == 0x1768);
    };
};
