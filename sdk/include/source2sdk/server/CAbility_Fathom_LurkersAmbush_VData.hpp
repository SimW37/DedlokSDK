...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ChargeUpParticle[0xe0]; // 0x1618            
            ...
            char m_InvisModifier[0x10]; // 0x16f8            
            ...
            char m_RegenModifier[0x10]; // 0x1708            
            ...
            CSoundEventName m_strSwapStarted; // 0x1728            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Fathom_LurkersAmbush_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbility_Fathom_LurkersAmbush_VData) == 0x1738);
    };
};
