...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nSprintParticle; // 0xf90            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnSprintingChanged"
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            bool m_bSprinting; // 0xf94            
            uint8_t _pad0f95[0x3]; // 0xf95
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            source2sdk::entity2::GameTime_t m_flSprintStartTime; // 0xf98            
            bool m_bInCombat; // 0xf9c            
            uint8_t _pad0f9d[0x3];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Sprint because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Sprint) == 0xfa0);
    };
};
