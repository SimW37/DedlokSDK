...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecPuddleModifiers[0x18]; // 0xb98            
            uint8_t _pad0bb0[0x240]; // 0xbb0
            source2sdk::entity2::GameTime_t m_LastDetonateTime; // 0xdf0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_GooGrenade) == 0xdf8);
    };
};
