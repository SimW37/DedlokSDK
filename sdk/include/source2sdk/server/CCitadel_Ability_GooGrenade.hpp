...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecPuddleModifiers[0x18]; // 0xf90            
            uint8_t _pad0fa8[0x500]; // 0xfa8
            source2sdk::entity2::GameTime_t m_LastDetonateTime; // 0x14a8            
            uint8_t _pad14ac[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_GooGrenade because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_GooGrenade) == 0x14b0);
    };
};
