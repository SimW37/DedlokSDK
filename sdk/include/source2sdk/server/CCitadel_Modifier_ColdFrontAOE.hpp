...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_ColdFrontAOE : public source2sdk::server::CCitadelModifier
        {
        public:
