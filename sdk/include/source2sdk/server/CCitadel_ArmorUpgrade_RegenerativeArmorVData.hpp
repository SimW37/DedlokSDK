...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_ArmorUpgrade_RegenerativeArmorVData : public server::CitadelItemVData
    {
    public:
        ...
        char m_RegenModifier[0x10]; // 0x1610        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_ArmorUpgrade_RegenerativeArmorVData) == 0x1620);
};
