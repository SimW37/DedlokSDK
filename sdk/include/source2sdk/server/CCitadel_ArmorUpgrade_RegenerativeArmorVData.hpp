...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_ArmorUpgrade_RegenerativeArmorVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            char m_RegenModifier[0x10]; // 0x16a8            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_RegenerativeArmorVData) == 0x16b8);
    };
};
