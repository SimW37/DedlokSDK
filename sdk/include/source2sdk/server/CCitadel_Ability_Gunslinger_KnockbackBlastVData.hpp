...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Gunslinger_KnockbackBlastVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Gunslinger_KnockbackBlastVData) == 0x1800);
    };
};
