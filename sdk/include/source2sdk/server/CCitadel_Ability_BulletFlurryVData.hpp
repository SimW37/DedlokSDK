...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_BulletFlurryVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_ChannelParticle[0xe0]; // 0x1618            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_BulletFlurryModifier;
            char m_BulletFlurryModifier[0x10]; // 0x16f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_BulletFlurryVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_BulletFlurryVData) == 0x1708);
    };
};
