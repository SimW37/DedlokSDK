...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_HollowPoint_ProcVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ParticleModifier;
            char m_ParticleModifier[0x10]; // 0x740            
        ...
        // Cannot assert offsets of fields in CCitadel_Modifier_HollowPoint_ProcVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_HollowPoint_ProcVData) == 0x760);
    };
};
