...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CItemMetalSkinVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_MetalSkinModifier;
            char m_MetalSkinModifier[0x10]; // 0x16a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemMetalSkinVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CItemMetalSkinVData) == 0x16b8);
    };
};
