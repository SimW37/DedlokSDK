...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Mirage_FireScarabs_WatcherVData : public source2sdk::server::CCitadel_Modifier_StatStealBaseVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Mirage_FireScarabs_WatcherVData) == 0x690);
    };
};
