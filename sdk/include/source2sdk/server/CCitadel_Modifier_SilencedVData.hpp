...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_SilencedVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_EmpPlayerParticle[0xe0]; // 0x740            
            ...
            char m_EmpStatusParticle[0xe0]; // 0x820            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_SilencedVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_SilencedVData) == 0x900);
    };
};
