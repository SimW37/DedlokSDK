...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vImpulseDirection; // 0xf90            
            // metadata: MNetworkEnable
            Vector m_vVelocity; // 0xf9c            
            // metadata: MNetworkEnable
            Vector m_vThrustingVelocity; // 0xfa8            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tStateEnterTime; // 0xfb4            
            // metadata: MNetworkEnable
            source2sdk::client::ERocketeerState m_eState; // 0xfb8            
            uint8_t _pad0fb9[0x7];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Airheart_Rocketeer4 because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Airheart_Rocketeer4) == 0xfc0);
    };
};
