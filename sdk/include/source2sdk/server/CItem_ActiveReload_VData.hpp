...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_SuccessModifier[0x10]; // 0x1610        
        ...
        char m_SuccessParticle[0xe0]; // 0x1650        
        ...
        char m_FailureParticle[0xe0]; // 0x1730        
    ...
    static_assert(sizeof(CItem_ActiveReload_VData) == 0x1818);
};
