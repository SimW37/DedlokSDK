...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SuccessModifier[0x10]; // 0x1678            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strSuccessSound; // 0x1688            
            CSoundEventName m_strFailureSound; // 0x1698            
            CSoundEventName m_strWindowEnteredSound; // 0x16a8            
            ...
            char m_SuccessParticle[0xe0]; // 0x16b8            
            ...
            char m_FailureParticle[0xe0]; // 0x1798            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flGraceTime; // 0x1878            
        ...
        static_assert(sizeof(source2sdk::server::CItem_ActiveReload_VData) == 0x1880);
    };
};
