...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CItem_ActiveReload_VData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SuccessModifier;
            char m_SuccessModifier[0x10]; // 0x1680            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strSuccessSound; // 0x1690            
            CSoundEventName m_strFailureSound; // 0x16a0            
            CSoundEventName m_strWindowEnteredSound; // 0x16b0            
            ...
            char m_SuccessParticle[0xe0]; // 0x16c0            
            ...
            char m_FailureParticle[0xe0]; // 0x17a0            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flGraceTime; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::server::CItem_ActiveReload_VData) == 0x1888);
    };
};
