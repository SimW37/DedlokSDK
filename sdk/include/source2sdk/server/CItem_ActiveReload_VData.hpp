...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SuccessModifier[0x10]; // 0x16a8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strSuccessSound; // 0x16b8            
            CSoundEventName m_strFailureSound; // 0x16c8            
            CSoundEventName m_strWindowEnteredSound; // 0x16d8            
            ...
            char m_SuccessParticle[0xe0]; // 0x16e8            
            ...
            char m_FailureParticle[0xe0]; // 0x17c8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flGraceTime; // 0x18a8            
        ...
        static_assert(sizeof(source2sdk::server::CItem_ActiveReload_VData) == 0x18b0);
    };
};
