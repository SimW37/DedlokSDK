...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Item_Discord_AuraVData : public server::CCitadelModifierAuraVData
    {
    public:
        ...
        char m_strAreaEffectEnemy[0xe0]; // 0x6b0        
        ...
        char m_strAreaEffectFriendly[0xe0]; // 0x790        
        ...
        char m_strAreaEffectSelf[0xe0]; // 0x870        
