...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_OverdriveClipModifier;
        char m_OverdriveClipModifier[0x10]; // 0x1668        
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_ReloadModifier;
        char m_ReloadModifier[0x10]; // 0x1678        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Upgrade_OverdriveClip_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Upgrade_OverdriveClip_VData) == 0x1688);
};
