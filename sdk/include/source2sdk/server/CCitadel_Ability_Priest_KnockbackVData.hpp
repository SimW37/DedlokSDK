...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Priest_KnockbackVData : public server::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_KnockbackToWallModifier;
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_KnockbackModifier;
        ...
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_InitialImpactParticle;
    ...
    static_assert(sizeof(CCitadel_Ability_Priest_KnockbackVData) == 0x18e8);
};
