...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_ArmorUpgrade_CloakingDeviceActive_VData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_AmbushModifier;
            char m_AmbushModifier[0x10]; // 0x16a8            
            ...
            char m_InvisModifier[0x10]; // 0x16b8            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_CloakingDeviceActive_VData) == 0x16c8);
    };
};
