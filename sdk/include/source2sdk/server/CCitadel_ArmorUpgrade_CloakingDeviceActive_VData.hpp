...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_AmbushModifier;
        char m_AmbushModifier[0x10]; // 0x1668        
        ...
        char m_InvisModifier[0x10]; // 0x1678        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_ArmorUpgrade_CloakingDeviceActive_VData) == 0x1688);
};
