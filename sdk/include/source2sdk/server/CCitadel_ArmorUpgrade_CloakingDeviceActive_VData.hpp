...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_AmbushModifier[0x10]; // 0x16b0            
            ...
            char m_InvisModifier[0x10]; // 0x16c0            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_CloakingDeviceActive_VData) == 0x16d0);
    };
};
