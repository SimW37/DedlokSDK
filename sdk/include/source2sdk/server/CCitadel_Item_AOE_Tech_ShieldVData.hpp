...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_AOE_Tech_ShieldVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_DurationModifier;
            char m_DurationModifier[0x10]; // 0x1678            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_AOE_Tech_ShieldVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Item_AOE_Tech_ShieldVData) == 0x1688);
    };
};
