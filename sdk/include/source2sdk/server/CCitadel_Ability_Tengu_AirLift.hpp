...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hGrabTarget[0x4]; // 0xfa8            
            source2sdk::client::ParticleIndex_t m_nHoldBombEffect; // 0xfac            
            uint8_t _pad0fb0[0x708]; // 0xfb0
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            source2sdk::client::EFlightState m_eFlightState; // 0x16b8            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            bool m_bIsGrabbing; // 0x16b9            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            bool m_bIsHoldingBomb; // 0x16ba            
            uint8_t _pad16bb[0x1]; // 0x16bb
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            float m_flCurrentSpeed; // 0x16bc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Tengu_AirLift because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Tengu_AirLift) == 0x16c0);
    };
};
