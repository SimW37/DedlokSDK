...
namespace source2sdk::server
{
    ...
    {
    public:
        client::ShotID_t m_tLastShotID; // 0xba0        
        [[maybe_unused]] std::uint8_t pad_0xba4[0x2c4]; // 0xba4
        int32_t m_nProjectilesScheduled; // 0xe68        
        client::ParticleIndex_t m_ChannelParticle; // 0xe6c        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
        entity2::GameTime_t m_flNextShootTime; // 0xe70        
    ...
    static_assert(sizeof(CAbility_Synth_Barrage) == 0xe78);
};
