...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CItemStimPakVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_StimPakModifier;
        ...
        static_assert(sizeof(source2sdk::server::CItemStimPakVData) == 0x1798);
    };
};
