...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifierAirRaidVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            // metadata: MPropertyStartGroup "Modifiers"
            // m_SlowModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SlowModifier;
            char m_SlowModifier[0x10]; // 0x690            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strWeaponShootSound; // 0x6a0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifierAirRaidVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CModifierAirRaidVData) == 0x6b0);
    };
};
