...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flAlphaScale; // 0xd48            
            // metadata: MNetworkEnable
            float m_flRadiusScale; // 0xd4c            
            // metadata: MNetworkEnable
            float m_flSelfIllumScale; // 0xd50            
            // metadata: MNetworkEnable
            Color m_ColorTint; // 0xd54            
            // metadata: MNetworkEnable
            ...
            char m_hTextureOverride[0x8]; // 0xd58            
        ...
        static_assert(sizeof(source2sdk::server::CEnvParticleGlow) == 0xd60);
    };
};
