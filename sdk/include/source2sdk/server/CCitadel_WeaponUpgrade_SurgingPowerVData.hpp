...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_WeaponUpgrade_SurgingPowerVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ModifierSurgingPower;
            char m_ModifierSurgingPower[0x10]; // 0x16b0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_WeaponUpgrade_SurgingPowerVData) == 0x17a0);
    };
};
