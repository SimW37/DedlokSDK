...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Upgrade_WeaponPowerForHealthVData : public source2sdk::server::CitadelItemVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Upgrade_WeaponPowerForHealthVData) == 0x1690);
    };
};
