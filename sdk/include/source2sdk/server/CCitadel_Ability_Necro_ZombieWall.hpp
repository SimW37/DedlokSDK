...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_tWallDeployFinishTime; // 0xf94            
            uint8_t _pad0f98[0x30]; // 0xf98
            ...
            char m_vecHitUnits[0x18]; // 0xfc8            
            uint8_t _pad0fe0[0x600];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Necro_ZombieWall because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Necro_ZombieWall) == 0x15e0);
    };
};
