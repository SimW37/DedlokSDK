...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityDustStormVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_DustStormAura;
            char m_DustStormAura[0x10]; // 0x15e8            
            ...
            char m_GrenadeTrailModifier[0x10]; // 0x15f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityDustStormVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityDustStormVData) == 0x1608);
    };
};
