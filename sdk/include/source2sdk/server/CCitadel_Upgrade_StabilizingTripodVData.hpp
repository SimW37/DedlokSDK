...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Upgrade_StabilizingTripodVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SelfDebuffModifier;
            char m_SelfDebuffModifier[0x10]; // 0x1680            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Upgrade_StabilizingTripodVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Upgrade_StabilizingTripodVData) == 0x1690);
    };
};
