...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_UtilityUpgrade_DebuffImmunityVData : public server::CitadelItemVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_DebuffImmunityModifier;
        char m_DebuffImmunityModifier[0x10]; // 0x1668        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_UtilityUpgrade_DebuffImmunityVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_UtilityUpgrade_DebuffImmunityVData) == 0x1678);
};
