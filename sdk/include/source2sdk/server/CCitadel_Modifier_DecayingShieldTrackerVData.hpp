...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_DecayingShieldTrackerVData : public server::CCitadelModifierVData
    {
    public:
        ...
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_WeaponImpactParticle;
        ...
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_TechImpactParticle;
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_TechImpactModifier;
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_ProcEffectModifier;
    ...
    static_assert(sizeof(CCitadel_Modifier_DecayingShieldTrackerVData) == 0x948);
};
