...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ShadowModifier[0x10]; // 0x1618            
            ...
            char m_PurgeModifier[0x10]; // 0x1628            
            ...
            char m_EnemyAura[0x10]; // 0x1638            
            // metadata: MPropertyGroupName "GamePlay"
            float m_flAuraRadius; // 0x1648            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Nano_ShadowVData) == 0x1650);
    };
};
