...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::CEntityIOOutput m_OnTouchedByEntity; // 0x8f0            
        ...
        static_assert(sizeof(source2sdk::server::CEnvBeam) == 0x918);
    };
};
