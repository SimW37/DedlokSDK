...
namespace source2sdk::server
{
    ...
    public:
        ...
        physicslib::JointMotion_t m_nLinearMotionX; // 0x560        
        physicslib::JointMotion_t m_nLinearMotionY; // 0x564        
        physicslib::JointMotion_t m_nLinearMotionZ; // 0x568        
        ...
        entity2::GameTime_t m_flBreakAfterTimeStartTimeX; // 0x59c        
        entity2::GameTime_t m_flBreakAfterTimeStartTimeY; // 0x5a0        
        entity2::GameTime_t m_flBreakAfterTimeStartTimeZ; // 0x5a4        
        ...
        entity2::GameTime_t m_flNotifyForceLastTimeX; // 0x5cc        
        entity2::GameTime_t m_flNotifyForceLastTimeY; // 0x5d0        
        entity2::GameTime_t m_flNotifyForceLastTimeZ; // 0x5d4        
        ...
        physicslib::JointMotion_t m_nAngularMotionY; // 0x5e0        
        physicslib::JointMotion_t m_nAngularMotionZ; // 0x5e4        
        ...
        entity2::CEntityIOOutput m_NotifyForceReachedX; // 0x610        
        entity2::CEntityIOOutput m_NotifyForceReachedY; // 0x638        
        entity2::CEntityIOOutput m_NotifyForceReachedZ; // 0x660        
    ...
    static_assert(sizeof(CGenericConstraint) == 0x688);
};
