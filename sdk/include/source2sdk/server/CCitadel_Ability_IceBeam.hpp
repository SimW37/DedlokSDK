...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad0b98[0x204]; // 0xb98
            source2sdk::entity2::GameTime_t m_flNextDamageTick; // 0xd9c            
            // metadata: MNetworkEnable
            source2sdk::server::CCitadelAbilityBeam_t m_beam; // 0xda0            
            uint8_t _pad15e0[0x38]; // 0x15e0
            ...
            char m_vecEntitiesHit[0x18]; // 0x1618            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_IceBeam because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_IceBeam) == 0x1630);
    };
};
