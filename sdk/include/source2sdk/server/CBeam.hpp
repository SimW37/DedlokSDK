...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_flFireTime; // 0x7d8        
        float m_flDamage; // 0x7dc        
        // metadata: MNetworkEnable
        uint8_t m_nNumBeamEnts; // 0x7e0        
        ...
        // metadata: MNetworkEnable
        client::BeamType_t m_nBeamType; // 0x7f8        
        // metadata: MNetworkEnable
        uint32_t m_nBeamFlags; // 0x7fc        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        modellib::AttachmentHandle_t m_nAttachIndex[10]; // 0x828        
        ...
        // metadata: MNetworkEnable
        client::BeamClipStyle_t m_nClipStyle; // 0x854        
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(CBeam) == 0x870);
};
