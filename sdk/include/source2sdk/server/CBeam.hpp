...
namespace source2sdk::server
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x779[0x7]; // 0x779
        // metadata: MNetworkEnable
        ...
        char m_hBaseMaterial[0x8]; // 0x780        
        // metadata: MNetworkEnable
        ...
        char m_hAttachEntity[0x28]; // 0x798        
        // metadata: MNetworkEnable
