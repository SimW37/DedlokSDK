...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t m_flNextRandomPositionTime; // 0x858            
            uint8_t _pad085c[0x394];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Projectile_SpiderProjectile because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Projectile_SpiderProjectile) == 0xbf0);
    };
};
