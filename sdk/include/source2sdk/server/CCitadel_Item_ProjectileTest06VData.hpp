...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_ProjectileTest06VData : public source2sdk::server::CCitadel_Item_ProjectileTestVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Item_ProjectileTest06VData) == 0x16c8);
    };
};
