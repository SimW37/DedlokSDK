...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_TechCleaveModifier;
        char m_TechCleaveModifier[0x10]; // 0x1610        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_sCleaveProcSound; // 0x1620        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Item_TechCleaveVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Item_TechCleaveVData) == 0x1630);
};
