...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Gunslinger_DemonCarbineVData : public server::CitadelAbilityVData
    {
    public:
        float m_flShotTimeScaleLingerDuration; // 0x15c8        
        ...
        char m_ChargingModifier[0x10]; // 0x15d0        
        // m_DebuffModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CEmbeddedSubclass<server::CCitadelModifier> m_DebuffModifier;
        char m_DebuffModifier[0x10]; // 0x15e0        
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraDemonCarbineShotFired; // 0x15f0        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Ability_Gunslinger_DemonCarbineVData) == 0x1678);
};
