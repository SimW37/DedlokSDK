...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_AoEPreviewParticle[0xe0]; // 0x1618            
            ...
            char m_StormCloudModifier[0x10]; // 0x16f8            
            ...
            char m_LightningStrikeAOEModifier[0x10]; // 0x1708            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strLightningStrikeCast; // 0x1718            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flOscillateFrequency; // 0x1728            
            float m_flOscillateSpeed; // 0x172c            
            float m_flOscillateSpeedStart; // 0x1730            
            float m_flOscillateStartOffset; // 0x1734            
            float m_flAirDrag; // 0x1738            
            float m_flFlightAirDrag; // 0x173c            
            float m_flFlightLateralMoveSpeed; // 0x1740            
            float m_flVerticalMoveSpeedPercent; // 0x1744            
            float m_flAirAcceleration; // 0x1748            
        ...
        static_assert(sizeof(source2sdk::server::CAbilityStormCloudVData) == 0x1750);
    };
};
