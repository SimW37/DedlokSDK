...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_pBeamModifier[0x18]; // 0xb98            
            uint8_t _pad0bb0[0x40]; // 0xbb0
            source2sdk::modellib::AttachmentHandle_t m_hAttackPosHigh; // 0xbf0            
            source2sdk::modellib::AttachmentHandle_t m_hAttackPosLow; // 0xbf1            
            source2sdk::modellib::AttachmentHandle_t m_hAttackPosLeft; // 0xbf2            
            source2sdk::modellib::AttachmentHandle_t m_hAttackPosRight; // 0xbf3            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Tier2Boss_LaserBeam) == 0xbf8);
    };
};
