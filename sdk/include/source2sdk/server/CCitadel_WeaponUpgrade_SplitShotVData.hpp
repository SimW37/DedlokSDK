...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_WeaponUpgrade_SplitShotVData : public server::CitadelItemVData
    {
    public:
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strWeaponShootSound; // 0x1668        
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_BuffIndicatorModifier;
        char m_BuffIndicatorModifier[0x10]; // 0x1678        
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_WeaponDamageBuff;
        char m_WeaponDamageBuff[0x10]; // 0x1688        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_SplitShotVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_WeaponUpgrade_SplitShotVData) == 0x1698);
};
