...
namespace source2sdk::server
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x51[0x97]; // 0x51
        client::CSimpleSimTimer m_FullDirectTimer; // 0xe8        
        [[maybe_unused]] std::uint8_t pad_0xf0[0x10];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAI_LocalNavigator because it is not a standard-layout class
    static_assert(sizeof(CAI_LocalNavigator) == 0x100);
};
