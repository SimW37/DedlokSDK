...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_ComboBreakerVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ComboBreakerModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Item_ComboBreakerVData) == 0x16c8);
    };
};
