...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Thumper_2_AuraVData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Thumper_2_AuraVData) == 0x890);
    };
};
