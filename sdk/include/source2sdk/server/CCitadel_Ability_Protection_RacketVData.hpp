...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Protection_RacketVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_CastOtherParticle[0xe0]; // 0x15e8            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ArmorModifier;
            char m_ArmorModifier[0x10]; // 0x16c8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Protection_RacketVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Protection_RacketVData) == 0x16d8);
    };
};
