...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CAbilityThumper3VData : public server::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_DroneModifier;
    ...
    static_assert(sizeof(CAbilityThumper3VData) == 0x1600);
};
