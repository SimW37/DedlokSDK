...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hTargetComboModifier[0x18]; // 0xb98            
            source2sdk::entity2::GameTime_t m_flLastAttackTime; // 0xbb0            
            std::int32_t m_nAttackNum; // 0xbb4            
            uint8_t _pad0bb8[0xc0]; // 0xbb8
            // metadata: MNetworkEnable
            std::int32_t m_iBonusHealth; // 0xc78            
            // metadata: MNetworkEnable
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0xc7c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_UltCombo because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_UltCombo) == 0xc80);
    };
};
