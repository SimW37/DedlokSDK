...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_flLastAttackTime; // 0xbb8        
        int32_t m_nAttackNum; // 0xbbc        
        [[maybe_unused]] std::uint8_t pad_0xbc0[0xc0]; // 0xbc0
        // metadata: MNetworkEnable
        int32_t m_iBonusHealth; // 0xc80        
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(CCitadel_Ability_UltCombo) == 0xc88);
};
