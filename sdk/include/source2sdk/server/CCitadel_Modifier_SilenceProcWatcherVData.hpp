...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_SilenceProcWatcherVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_TechDamageReductionModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_SilenceProcWatcherVData) == 0x7b8);
    };
};
