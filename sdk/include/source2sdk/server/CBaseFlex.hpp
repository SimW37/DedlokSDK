...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_flexWeight[0x18]; // 0xa80            
            // metadata: MNetworkEnable
            // metadata: MNetworkEncoder "coord"
            VectorWS m_vLookTargetPosition; // 0xa98            
            uint8_t _pad0aa4[0x24]; // 0xaa4
            source2sdk::entity2::GameTime_t m_flLastFlexAnimationTime; // 0xac8            
        ...
        static_assert(sizeof(source2sdk::server::CBaseFlex) == 0xad0);
    };
};
