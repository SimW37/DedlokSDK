...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_flexWeight[0x18]; // 0xab8            
            // metadata: MNetworkEnable
            // metadata: MNetworkEncoder "coord"
            Vector m_vLookTargetPosition; // 0xad0            
            // metadata: MNetworkEnable
            bool m_blinktoggle; // 0xadc            
            uint8_t _pad0add[0x53]; // 0xadd
            source2sdk::entity2::GameTime_t m_flAllowResponsesEndTime; // 0xb30            
            source2sdk::entity2::GameTime_t m_flLastFlexAnimationTime; // 0xb34            
            source2sdk::client::SceneEventId_t m_nNextSceneEventId; // 0xb38            
            bool m_bUpdateLayerPriorities; // 0xb3c            
            uint8_t _pad0b3d[0xb];
        ...
        static_assert(sizeof(source2sdk::server::CBaseFlex) == 0xb48);
    };
};
