...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_TrophyCollectorVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            char m_EarnedParticle[0xe0]; // 0x1680            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_GoldModifier;
            char m_GoldModifier[0x10]; // 0x1760            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strEarnedSound; // 0x1770            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_TrophyCollectorVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Item_TrophyCollectorVData) == 0x1780);
    };
};
