...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_SilencerProcActiveVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_SilencerActiveParticle;
            char m_SilencerActiveParticle[0xe0]; // 0x770            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SilenceActiveModifier;
            char m_SilenceActiveModifier[0x10]; // 0x850            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_SilencerProcActiveVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_SilencerProcActiveVData) == 0x860);
    };
};
