...
namespace source2sdk::server
{
    ...
    public:
        ...
        // metadata: MNetworkEnable
        int32_t m_nBonusTechPower; // 0xbb4        
        ...
        [[maybe_unused]] std::uint8_t pad_0xbbc[0xc]; // 0xbbc
        entity2::GameTime_t m_flCastTime; // 0xbc8        
        bool m_bNeedsExplosion; // 0xbcc        
        [[maybe_unused]] std::uint8_t pad_0xbcd[0x3]; // 0xbcd
