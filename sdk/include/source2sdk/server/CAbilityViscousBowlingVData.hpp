...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_TransformStartFx[0xe0]; // 0x1618            
            ...
            char m_WallImpactFx[0xe0]; // 0x17d8            
            ...
            char m_BallTrailFx[0xe0]; // 0x18b8            
            ...
            char m_GroundImpactParticle[0xe0]; // 0x1998            
            ...
            char m_JumpParticle[0xe0]; // 0x1a78            
            ...
            char m_DirectionParticle[0xe0]; // 0x1b58            
            // metadata: MPropertyLeafSuggestionProviderFn
            CGlobalSymbol m_strPopGraphParamter; // 0x1c38            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_BallJumpSound; // 0x1c40            
            CSoundEventName m_EnterBallSound; // 0x1c50            
            CSoundEventName m_BallLoopSound; // 0x1c60            
            CSoundEventName m_ExitBallSound; // 0x1c70            
            CSoundEventName m_WallImpactSound; // 0x1c80            
            CSoundEventName m_PlayerImpactSound; // 0x1c90            
            ...
            char m_ImpactModifier[0x10]; // 0x1ca0            
            ...
            char m_DamagePreventionModifier[0x10]; // 0x1cb0            
            ...
            char m_RollingModifier[0x10]; // 0x1cc0            
            // metadata: MPropertyStartGroup "+Ball Parameters"
            float m_flTransformToBallTime; // 0x1cd0            
            float m_flTransformFromBallTime; // 0x1cd4            
            float m_flAirTurnRatio; // 0x1cd8            
            float m_flWallTurnRatioMax; // 0x1cdc            
            float m_flWallTurnRatioMin; // 0x1ce0            
            float m_flTurnRatio; // 0x1ce4            
            float m_flDefaultBallSpeed; // 0x1ce8            
            float m_flFastBallSpeed; // 0x1cec            
            float m_flSpeedAccel; // 0x1cf0            
            float m_flSpeedDeccel; // 0x1cf4            
            float m_flElasticity; // 0x1cf8            
            float m_flWallCheckGroundOffset; // 0x1cfc            
            float m_flWallPauseTime; // 0x1d00            
            float m_flWallAngleMin; // 0x1d04            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityViscousBowlingVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityViscousBowlingVData) == 0x1d08);
    };
};
