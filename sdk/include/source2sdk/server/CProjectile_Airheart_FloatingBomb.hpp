...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            Vector vVelocity; // 0x858            
            source2sdk::entity2::GameTime_t m_tSpawnTime; // 0x864            
            uint8_t _pad0868[0x280];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CProjectile_Airheart_FloatingBomb because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CProjectile_Airheart_FloatingBomb) == 0xae8);
    };
};
