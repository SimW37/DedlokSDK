...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Bookworm_AOEMagicVData : public server::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_AreaModifier;
        char m_AreaModifier[0x10]; // 0x15f0        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Bookworm_AOEMagicVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Bookworm_AOEMagicVData) == 0x1600);
};
