...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_BarrageCasterModifier[0x10]; // 0x15e8            
            ...
            char m_AmpModifier[0x10]; // 0x15f8            
            ...
            CSoundEventName m_strProjectileLaunchSound; // 0x18b8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flAttackInterval; // 0x18c8            
        ...
        static_assert(sizeof(source2sdk::server::CAbility_Synth_Barrage_VData) == 0x18d0);
    };
};
