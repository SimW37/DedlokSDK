...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bActivated; // 0xf98            
            uint8_t _pad0f99[0x3]; // 0xf99
            source2sdk::client::ParticleIndex_t m_nFxIndex; // 0xf9c            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_PersonalRejuvenator) == 0x1120);
    };
};
