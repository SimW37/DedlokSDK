...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hAbility[0x4]; // 0xc00            
            // metadata: MNetworkEnable
            std::int32_t m_iGravestoneState; // 0xc04            
            float m_flLifetime; // 0xc08            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_GraveStone_Blocker) == 0xc10);
    };
};
