...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_ColdFrontAOE_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_TargetModifier[0x10]; // 0x660            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_ColdFrontAOE_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_ColdFrontAOE_VData) == 0x670);
    };
};
