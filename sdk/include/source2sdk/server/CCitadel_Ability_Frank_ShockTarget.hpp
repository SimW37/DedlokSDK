...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad0b98[0x2c0]; // 0xb98
            // metadata: MNetworkEnable
            float m_flBonusDamage; // 0xe58            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_NextBonusDamageDecayTime; // 0xe5c            
            uint8_t _pad0e60[0x8];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Frank_ShockTarget because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Frank_ShockTarget) == 0xe68);
    };
};
