...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bReviveIsActive; // 0xf92            
            uint8_t _pad0f93[0x1]; // 0xf93
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_TimeOfDeath; // 0xf94            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_TimeOfRevive; // 0xf98            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            float m_flTotalPendingHeal; // 0xf9c            
            uint8_t _pad0fa0[0x610];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Frank_Revive because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Frank_Revive) == 0x15b0);
    };
};
