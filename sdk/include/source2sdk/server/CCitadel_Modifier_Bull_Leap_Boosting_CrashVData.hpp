...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Bull_Leap_Boosting_CrashVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_DragModifier[0x10]; // 0x660            
            ...
            char m_CrashTrailParticle[0xe0]; // 0x670            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flCollideRadius; // 0x750            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Bull_Leap_Boosting_CrashVData) == 0x758);
    };
};
