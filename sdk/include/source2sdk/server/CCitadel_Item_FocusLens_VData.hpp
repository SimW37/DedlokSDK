...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Item_FocusLens_VData : public server::CCitadel_Item_TrackingProjectileApplyModifierVData
    {
    public:
        ...
        char m_SilenceModifier[0x10]; // 0x1768        
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_DamageModifier;
        char m_DamageModifier[0x10]; // 0x1778        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Item_FocusLens_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Item_FocusLens_VData) == 0x1788);
};
