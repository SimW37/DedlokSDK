...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbility_Fencer_Riposte_Attack_VData : public source2sdk::server::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CAbility_Fencer_Riposte_Attack_VData) == 0x1de0);
    };
};
