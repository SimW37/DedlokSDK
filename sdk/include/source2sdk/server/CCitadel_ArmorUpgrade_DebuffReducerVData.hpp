...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_ArmorUpgrade_DebuffReducerVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            char m_DebuffReducedParticle[0xe0]; // 0x1680            
            ...
            char m_PurgeCastParticle[0xe0]; // 0x1760            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_MoveSpeedModifier;
            char m_MoveSpeedModifier[0x10]; // 0x1840            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_ArmorUpgrade_DebuffReducerVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_DebuffReducerVData) == 0x1850);
    };
};
