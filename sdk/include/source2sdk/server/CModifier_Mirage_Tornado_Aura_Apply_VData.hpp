...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Mirage_Tornado_Aura_Apply_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_TossModifier;
        ...
        static_assert(sizeof(source2sdk::server::CModifier_Mirage_Tornado_Aura_Apply_VData) == 0x690);
    };
};
