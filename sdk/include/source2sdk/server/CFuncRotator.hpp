...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hRotatorTarget[0x4]; // 0x778            
            bool m_bIsRotating; // 0x77c            
            bool m_bIsReversing; // 0x77d            
            uint8_t _pad077e[0x2]; // 0x77e
            float m_flTimeToReachMaxSpeed; // 0x780            
            float m_flTimeToReachZeroSpeed; // 0x784            
            float m_flDistanceAlongArcTraveled; // 0x788            
            float m_flTimeToWaitOscillate; // 0x78c            
            source2sdk::entity2::GameTime_t m_flTimeRotationStart; // 0x790            
