...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flSightRange; // 0x1338            
            float m_flPlayerInitialSightRange; // 0x133c            
            ...
            char m_strWIPModelName[0xe0]; // 0x1340            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_BeamHitSound; // 0x1420            
            CSoundEventName m_BeamAnnounceSound; // 0x1430            
            CSoundEventName m_BarrageAnnounceSound; // 0x1440            
            CSoundEventName m_MeleeAnnounceSound; // 0x1450            
            // metadata: MPropertyStartGroup "Electric Beam (Laser)"
            bool m_bBeamTurnToFire; // 0x1460            
            uint8_t _pad1461[0x7]; // 0x1461
            ...
            char m_StompImpactEffect[0xe0]; // 0x1468            
            ...
            char m_StompWarningEffect[0xe0]; // 0x1548            
            float m_flTossSpeed; // 0x1628            
            float m_flStompDamage; // 0x162c            
            float m_flStompDamageMaxHealthPercent; // 0x1630            
            float m_flStompDamageTrooperRate; // 0x1634            
            float m_flStompTossUpMagnitude; // 0x1638            
            float m_flStunDuration; // 0x163c            
            float m_flStompAttemptRadius; // 0x1640            
            float m_flStompImpactRadius; // 0x1644            
            float m_flStompImpactHeight; // 0x1648            
            float m_flStompParryRadius; // 0x164c            
            float m_flStompParryImpulse; // 0x1650            
            float m_flStompParryImpulseInAir; // 0x1654            
            float m_flStompParryDamageMult; // 0x1658            
            float m_flSweepRadius; // 0x165c            
            float m_flSweepSpeed; // 0x1660            
            float m_flSweepZScale; // 0x1664            
            float m_flSweepMaxAngle; // 0x1668            
            float m_flSweepMaxRange; // 0x166c            
            float m_flSweepAdjustSpeed; // 0x1670            
            uint8_t _pad1674[0x4]; // 0x1674
            CSoundEventName m_StompAnnounceSound; // 0x1678            
            CSoundEventName m_StompParriedSound; // 0x1688            
            CSoundEventName m_StompImpactSound; // 0x1698            
            // metadata: MPropertyStartGroup "Gun"
            float m_flBurstDuration; // 0x16a8            
            float m_flBurstCooldown; // 0x16ac            
            // metadata: MPropertyStartGroup "Melee"
            float m_flMeleeDuration; // 0x16b0            
            float m_flMeleeHitTime; // 0x16b4            
            float m_flMeleeAttackRadius; // 0x16b8            
            float m_flMeleeDamage; // 0x16bc            
            float m_flMeleeDamageHealthPct; // 0x16c0            
            float m_flMeleeTrooperStunTime; // 0x16c4            
            ...
            char m_BackdoorProtectionModifier[0x10]; // 0x16c8            
            float m_flBackDoorProtectionRange; // 0x16d8            
            ...
            char m_InvulModifier[0x10]; // 0x16e0            
            float m_flInvulModifierRange; // 0x16f0            
            ...
            char m_RangedArmorModifier[0x10]; // 0x16f8            
            ...
            char m_FriendlyAuraModifier[0x10]; // 0x1708            
            ...
            char m_NearbyEnemyResist[0x10]; // 0x1718            
            ...
            char m_StatTrackerAuraModifier[0x10]; // 0x1728            
            ...
            char m_EmpoweredModifierLevel1[0x10]; // 0x1738            
            ...
            char m_EmpoweredModifierLevel2[0x10]; // 0x1748            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_StaggerWatcherModifier;
            char m_StaggerWatcherModifier[0x10]; // 0x1758            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flMaxStaggerBuildup; // 0x1768            
            float m_flStaggerDuration; // 0x176c            
            float m_flStaggerMeleeMult; // 0x1770            
            float m_flStaggerDamageMult; // 0x1774            
            float m_flAoeWaveHealthThreshold; // 0x1778            
            uint8_t _pad177c[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CNPC_Boss_Tier2VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CNPC_Boss_Tier2VData) == 0x1780);
    };
};
