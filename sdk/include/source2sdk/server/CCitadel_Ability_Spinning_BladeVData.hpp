...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CatchIndicator[0xe0]; // 0x1628            
            ...
            char m_CatchParticle[0xe0]; // 0x1708            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strThrowSound; // 0x17e8            
            CSoundEventName m_strReturnSound; // 0x17f8            
            CSoundEventName m_strCatchSound; // 0x1808            
            CSoundEventName m_strFailSound; // 0x1818            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Spinning_BladeVData) == 0x1838);
    };
};
