...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::ShotID_t m_nLastShotID; // 0xf98            
            source2sdk::client::ShotID_t m_nLastHitShotID; // 0xf9c            
            std::int32_t m_nWpnBatchCount; // 0xfa0            
            uint8_t _pad0fa4[0x6c]; // 0xfa4
            source2sdk::client::ShotID_t m_nLastBulletHitShotID; // 0x1010            
            std::int32_t m_nLastBulletHitCount; // 0x1014            
            ...
            char m_eLastBulletHitEnt[0x4]; // 0x1018            
            // metadata: MNetworkEnable
            bool m_bSplitShotActive; // 0x101c            
            uint8_t _pad101d[0x303];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_SplitShot because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_WeaponUpgrade_SplitShot) == 0x1320);
    };
};
