...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::ShotID_t m_nLastShotID; // 0xba0            
            source2sdk::client::ShotID_t m_nLastHitShotID; // 0xba4            
            std::int32_t m_nWpnBatchCount; // 0xba8            
            uint8_t _pad0bac[0x6c]; // 0xbac
            source2sdk::client::ShotID_t m_nLastBulletHitShotID; // 0xc18            
            std::int32_t m_nLastBulletHitCount; // 0xc1c            
            ...
            char m_eLastBulletHitEnt[0x4]; // 0xc20            
            // metadata: MNetworkEnable
            bool m_bSplitShotActive; // 0xc24            
            uint8_t _pad0c25[0x183];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_SplitShot because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_WeaponUpgrade_SplitShot) == 0xda8);
    };
};
