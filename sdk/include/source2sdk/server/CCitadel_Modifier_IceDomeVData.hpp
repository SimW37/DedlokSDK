...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_IceDomeVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_BlockerModel[0xe0]; // 0x660            
            ...
            char m_DomeParticle[0xe0]; // 0x740            
            ...
            char m_FriendlyAuraModifier[0x10]; // 0x820            
            ...
            char m_EnemyAuraModifier[0x10]; // 0x830            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strDomeEndSound; // 0x840            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strTargetLoopingSound; // 0x850            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_IceDomeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_IceDomeVData) == 0x860);
    };
};
