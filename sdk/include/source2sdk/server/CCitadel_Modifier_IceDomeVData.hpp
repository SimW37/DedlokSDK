...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_BlockerModel[0xe0]; // 0x658        
        ...
        char m_DomeParticle[0xe0]; // 0x738        
        ...
        char m_FriendlyAuraModifier[0x10]; // 0x818        
        ...
        char m_EnemyAuraModifier[0x10]; // 0x828        
    ...
    static_assert(sizeof(CCitadel_Modifier_IceDomeVData) == 0x858);
};
