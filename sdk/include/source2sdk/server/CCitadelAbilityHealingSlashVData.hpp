...
namespace source2sdk::server
{
    ...
    public:
        ...
        client::CRemapFloat m_remapAngleToTime; // 0x15d8        
        ...
        char m_ImpactParticle[0xe0]; // 0x15f8        
        ...
        char m_HealingSlashParticle[0xe0]; // 0x16d8        
        ...
        char m_HealingSlashSwordGlow[0xe0]; // 0x17b8        
    ...
    static_assert(sizeof(CCitadelAbilityHealingSlashVData) == 0x1988);
};
