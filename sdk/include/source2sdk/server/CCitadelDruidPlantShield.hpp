...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            VectorWS m_vStartPos; // 0xbe4            
            VectorWS m_vEndPos; // 0xbf0            
            source2sdk::entity2::GameTime_t m_flStartGrowTime; // 0xbfc            
            source2sdk::entity2::GameTime_t m_flEndGrowTime; // 0xc00            
        ...
        static_assert(sizeof(source2sdk::server::CCitadelDruidPlantShield) == 0xc10);
    };
};
