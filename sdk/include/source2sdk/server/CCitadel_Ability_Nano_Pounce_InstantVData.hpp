...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_FlashParticle[0xe0]; // 0x16f8            
            ...
            char m_ExplodeSlowParticle[0xe0]; // 0x18b8            
            ...
            char m_PrimaryHitParticle[0xe0]; // 0x1998            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_AttackSound; // 0x1a78            
            CSoundEventName m_strExplodeSound; // 0x1a88            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flAttackTimePhase01; // 0x1a98            
            float m_flAttackTimePhase02; // 0x1a9c            
            float m_flAllyMinTargetRange; // 0x1aa0            
            float m_flTargetVerticalOffset; // 0x1aa4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Nano_Pounce_InstantVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Nano_Pounce_InstantVData) == 0x1aa8);
    };
};
