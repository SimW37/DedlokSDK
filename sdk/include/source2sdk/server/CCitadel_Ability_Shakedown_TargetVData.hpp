...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Shakedown_TargetVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_RootModifier[0x10]; // 0x15e8            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_PulseModifier;
            char m_PulseModifier[0x10]; // 0x15f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Shakedown_TargetVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Shakedown_TargetVData) == 0x1608);
    };
};
