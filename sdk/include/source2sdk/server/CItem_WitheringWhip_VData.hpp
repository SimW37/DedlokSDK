...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CItem_WitheringWhip_VData : public source2sdk::server::CCitadel_Item_TrackingProjectileApplyModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CItem_WitheringWhip_VData) == 0x1790);
    };
};
