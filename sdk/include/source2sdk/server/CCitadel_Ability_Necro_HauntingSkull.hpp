...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t m_tPriorityTargetTime; // 0xf90            
            ...
            char m_eSkullPriorityTarget[0x4]; // 0xf94            
            VectorWS m_vLaunchPosition; // 0xf98            
            QAngle m_qLaunchAngle; // 0xfa4            
            uint8_t _pad0fb0[0x1]; // 0xfb0
            // metadata: MNetworkEnable
            bool m_bIsFullyCharged; // 0xfb1            
            uint8_t _pad0fb2[0xa86];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Necro_HauntingSkull because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Necro_HauntingSkull) == 0x1a38);
    };
};
