...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityPowerJumpVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_JumpParticle[0xe0]; // 0x1620            
            ...
            char m_InAirModifier[0x10]; // 0x1700            
            ...
            char m_PowerJumpModifier[0x10]; // 0x1710            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityPowerJumpVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityPowerJumpVData) == 0x1720);
    };
};
