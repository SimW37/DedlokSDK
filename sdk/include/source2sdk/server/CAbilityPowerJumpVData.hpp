...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_JumpParticle[0xe0]; // 0x1618            
            ...
            char m_InAirModifier[0x10]; // 0x16f8            
            ...
            char m_PowerJumpModifier[0x10]; // 0x1708            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityPowerJumpVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityPowerJumpVData) == 0x1718);
    };
};
