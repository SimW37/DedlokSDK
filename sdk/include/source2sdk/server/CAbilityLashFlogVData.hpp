...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityLashFlogVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_FlogParticle[0xe0]; // 0x15e8            
            // metadata: MPropertyGroupName "Visuals"
            ...
            char m_FlogLifeLeachParticle[0xe0]; // 0x16c8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strHitConfirmSound; // 0x17a8            
            ...
            char m_FlogDebuffModifier[0x10]; // 0x17b8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityLashFlogVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityLashFlogVData) == 0x17c8);
    };
};
