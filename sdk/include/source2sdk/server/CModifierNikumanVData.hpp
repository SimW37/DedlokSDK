...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifierNikumanVData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
            ...
            char m_SelfParticle[0xe0]; // 0x6b0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strAmbientLoopingLocalPlayerSound; // 0x790            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifierNikumanVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CModifierNikumanVData) == 0x7a0);
    };
};
