...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Projectile_Wrecker_Teleport : public source2sdk::server::CCitadelProjectile
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Projectile_Wrecker_Teleport) == 0x878);
    };
};
