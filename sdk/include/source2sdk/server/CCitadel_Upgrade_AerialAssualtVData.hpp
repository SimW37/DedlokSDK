...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_WatcherModifier;
        char m_WatcherModifier[0x10]; // 0x1610        
