...
namespace source2sdk::server
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CCitadel_Modifier_ConeWaveProjectile : public server::CCitadel_Modifier_Intrinsic_Base
    {
    public:
