...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_SpreadingFire_DOT_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_sSpreadingFireParticle[0xe0]; // 0x660            
            ...
            char m_sSpreadingFireTetherParticle[0xe0]; // 0x740            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_SpreadingFire_DOT_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_SpreadingFire_DOT_VData) == 0x820);
    };
};
