...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_EtherealBulletsVData : public server::CCitadel_Modifier_BaseEventProcVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_BulletDamageBuffModifier;
