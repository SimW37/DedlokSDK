...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nCastParamNeedsResetTick; // 0x608            
            bool m_bIsCoolingDownInternal; // 0x60c            
            uint8_t _pad060d[0x3]; // 0x60d
            source2sdk::entity2::GameTime_t m_flCancelMashProtectionEndTime; // 0x610            
            source2sdk::entity2::GameTime_t m_flCancelLockoutEndTime; // 0x614            
