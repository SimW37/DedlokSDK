...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CModifier_FleetfootBoots_BonusClip : public source2sdk::server::CCitadelModifier
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CModifier_FleetfootBoots_BonusClip) == 0x108);
    };
};
