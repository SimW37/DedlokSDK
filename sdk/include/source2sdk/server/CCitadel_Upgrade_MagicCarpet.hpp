...
namespace source2sdk::server
{
    ...
    {
    public:
        entity2::GameTime_t m_flFlyingStartTime; // 0xba8        
        [[maybe_unused]] std::uint8_t pad_0xbac[0x84]; // 0xbac
