...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_MagicClarityWatcherVData : public server::CCitadel_Modifier_Intrinsic_BaseVData
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_MagicClarityWatcherVData) == 0x670);
};
