...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_MagicClarityWatcherVData : public source2sdk::server::CCitadel_Modifier_Intrinsic_BaseVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_MagicClarityWatcherVData) == 0x670);
    };
};
