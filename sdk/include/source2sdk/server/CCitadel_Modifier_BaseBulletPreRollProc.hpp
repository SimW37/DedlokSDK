...
namespace source2sdk::server
{
    ...
    {
    public:
        client::ShotID_t m_nSuppressProcShotID; // 0x178        
        [[maybe_unused]] std::uint8_t pad_0x17c[0x4]; // 0x17c
    ...
    static_assert(sizeof(CCitadel_Modifier_BaseBulletPreRollProc) == 0x198);
};
