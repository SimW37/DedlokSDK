...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::ShotID_t m_nSuppressProcShotID; // 0x178            
            uint8_t _pad017c[0x4]; // 0x17c
            ...
            char m_vecProcdBulletIDs[0x18]; // 0x180            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_BaseBulletPreRollProc because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_BaseBulletPreRollProc) == 0x198);
    };
};
