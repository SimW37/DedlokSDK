...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hMeasureTarget[0x4]; // 0x8d8            
            uint8_t _pad08dc[0x4]; // 0x8dc
            CUtlSymbolLarge m_iszMeasureTarget; // 0x8e0            
            float m_fRadius; // 0x8e8            
            std::int32_t m_nTouchers; // 0x8ec            
            ...
            char m_NearestEntityDistance[0x20]; // 0x8f0            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerProximity) == 0x910);
    };
};
