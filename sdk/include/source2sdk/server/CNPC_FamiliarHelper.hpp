...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad1790[0x3e0]; // 0x1790
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tCooldownStartTime; // 0x1b70            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_tCooldownEndTime; // 0x1b74            
            // metadata: MNetworkEnable
            bool m_bIsHelperAvailableNet; // 0x1b78            
            uint8_t _pad1b79[0x7];
            
            // Datamap fields:
            // uint8_t m_nHelperIdx; // 0x1804
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CNPC_FamiliarHelper because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CNPC_FamiliarHelper) == 0x1b80);
    };
};
