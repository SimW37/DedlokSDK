...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CastParticle[0xe0]; // 0x1680            
            ...
            char m_TrailParticle[0xe0]; // 0x1760            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strStackSound; // 0x1840            
            CSoundEventName m_strTargetHealSound; // 0x1850            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItem_RestorativeLocket_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CItem_RestorativeLocket_VData) == 0x1860);
    };
};
