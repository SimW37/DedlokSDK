...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_CastParticle[0xe0]; // 0x1668        
        ...
        char m_TrailParticle[0xe0]; // 0x1748        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strStackSound; // 0x1828        
        CSoundEventName m_strTargetHealSound; // 0x1838        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CItem_RestorativeLocket_VData because it is not a standard-layout class
    static_assert(sizeof(CItem_RestorativeLocket_VData) == 0x1848);
};
