...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_TechBleed_ProcVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CBaseModifier> m_BleedModifier;
            char m_BleedModifier[0x10]; // 0x770            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_TechBleed_ProcVData) == 0x790);
    };
};
