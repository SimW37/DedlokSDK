...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Ability_TangoTether_Trigger : public source2sdk::server::CCitadelBaseTriggerAbility
        {
        public:
            uint8_t _pad0fa0[0x4]; // 0xfa0
