...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityCadencePrimaryWeaponVData : public source2sdk::server::CCitadel_Ability_PrimaryWeaponVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CAbilityCadencePrimaryWeaponVData) == 0x1688);
    };
};
