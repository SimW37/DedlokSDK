...
namespace source2sdk::server
{
    ...
    public:
        ...
        client::CitadelCameraOperationsSequence_t m_cameraKineticCarbineShotFired; // 0x15f0        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Chrono_KineticCarbineVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Chrono_KineticCarbineVData) == 0x1678);
};
