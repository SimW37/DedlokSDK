...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_SmokeBombVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_PhaseOutModifier;
            char m_PhaseOutModifier[0x10]; // 0x1608            
            ...
            char m_PurgeParticle[0xe0]; // 0x1618            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_SmokeBombVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_SmokeBombVData) == 0x16f8);
    };
};
