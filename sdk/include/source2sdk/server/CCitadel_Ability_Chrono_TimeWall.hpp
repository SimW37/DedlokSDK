...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hWall[0x4]; // 0xb98            
            Vector vecDir; // 0xb9c            
            source2sdk::client::ParticleIndex_t m_hChargingParticle; // 0xba8            
            Vector m_vSpawnPos; // 0xbac            
            QAngle m_qAngles; // 0xbb8            
            // metadata: MNetworkEnable
            bool m_bAirCast; // 0xbc4            
            uint8_t _pad0bc5[0x1c3];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Chrono_TimeWall because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Chrono_TimeWall) == 0xd88);
    };
};
