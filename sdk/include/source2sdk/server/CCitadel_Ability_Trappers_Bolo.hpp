...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hHitTargets[0x18]; // 0x1018            
            std::int32_t m_iBounces; // 0x1030            
            bool m_bReturning; // 0x1034            
            uint8_t _pad1035[0x283];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Trappers_Bolo because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Trappers_Bolo) == 0x12b8);
    };
};
