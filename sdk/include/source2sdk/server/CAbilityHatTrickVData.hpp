...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityHatTrickVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_HatTrickChannelParticle[0xe0]; // 0x17e0            
        ...
        static_assert(sizeof(source2sdk::server::CAbilityHatTrickVData) == 0x18e0);
    };
};
