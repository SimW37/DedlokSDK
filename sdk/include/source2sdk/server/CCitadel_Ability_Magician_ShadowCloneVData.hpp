...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Magician_ShadowCloneVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_CloneModifier[0x10]; // 0x15f0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Magician_ShadowCloneVData) == 0x16e0);
    };
};
