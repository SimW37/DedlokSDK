...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_FlyingModifier[0x10]; // 0x15e8            
            ...
            char m_GrabModifier[0x10]; // 0x15f8            
            ...
            char m_HoldBombModifier[0x10]; // 0x1608            
            ...
            char m_DroppedBuffModifier[0x10]; // 0x1618            
            ...
            char m_ExplodingAllyModifier[0x10]; // 0x1628            
            ...
            char m_AoEModifier[0x10]; // 0x1638            
            ...
            char m_InitialExplodeParticle[0xe0]; // 0x1648            
            ...
            char m_HoldBombEffect[0xe0]; // 0x1728            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strExplodeSound; // 0x1808            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flAirDrag; // 0x1818            
            float m_flMaxFallSpeed; // 0x181c            
            float m_flTargetAirSpeedFast; // 0x1820            
            float m_flTargetAirSpeedBase; // 0x1824            
            float m_flSprintMult; // 0x1828            
            float m_flAcceleration; // 0x182c            
            float m_flDecceleration; // 0x1830            
            float m_flAirSideSpeedPercent; // 0x1834            
            float m_flBoostEndVerticalSpeed; // 0x1838            
            float m_flBoostSpeedUp; // 0x183c            
            float m_flCrouchLaunchReduction; // 0x1840            
            float m_flMinFlyHeight; // 0x1844            
            float m_flMaxFlyHeight; // 0x1848            
            float m_flMaxPitchUp; // 0x184c            
            float m_flMaxPitchDown; // 0x1850            
            float m_flAllyDelayedBoostTime; // 0x1854            
            float m_flChannelingAirDrag; // 0x1858            
            float m_flChannelingMaxFallSpeed; // 0x185c            
            float m_flBombReleaseSpeed; // 0x1860            
            float m_flBombReleasePitch; // 0x1864            
            float m_flBombDropReleaseOffset; // 0x1868            
            float m_flHoldBombOffsetX; // 0x186c            
            float m_flHoldBombOffsetY; // 0x1870            
            float m_flHoldBombOffsetZ; // 0x1874            
            float m_flAnglePitchBias; // 0x1878            
            float m_flTrackAmount; // 0x187c            
            float m_flMoveCollideSpeed; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Tengu_AirLiftVData) == 0x1888);
    };
};
