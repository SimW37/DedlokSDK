...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_SlowingBullets_ProcVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_SlowingBullets_ProcVData) == 0x6b0);
    };
};
