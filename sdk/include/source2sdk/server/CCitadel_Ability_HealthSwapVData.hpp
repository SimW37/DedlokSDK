...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_HealthSwapVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_SwapParticle[0xe0]; // 0x15e8            
            ...
            char m_SilenceExplodeParticle[0xe0]; // 0x16c8            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SwapModifier;
            char m_SwapModifier[0x10]; // 0x17a8            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_PreCastModifier;
            char m_PreCastModifier[0x10]; // 0x17b8            
            // m_BuffModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_BuffModifier;
            char m_BuffModifier[0x10]; // 0x17c8            
            ...
            char m_SilenceModifier[0x10]; // 0x17d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_HealthSwapVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_HealthSwapVData) == 0x17e8);
    };
};
