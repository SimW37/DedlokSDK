...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_GroundParticle[0xe0]; // 0x818        
        ...
        char m_FloatingParticle[0xe0]; // 0x8f8        
        ...
        char m_IcePathBuffParticle[0xe0]; // 0x9d8        
        ...
        char m_FriendlyAuraModifier[0x10]; // 0xab8        
