...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_PsychicDaggerVData : public server::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_MakeDaggersModifier;
    ...
    static_assert(sizeof(CCitadel_Ability_PsychicDaggerVData) == 0x1600);
};
