...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CastTarget[0x4]; // 0xf94            
            std::int32_t m_iCurrentShots; // 0xf98            
            std::int32_t m_iTotalShots; // 0xf9c            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Gunslinger_Salvo) == 0x10a0);
    };
};
