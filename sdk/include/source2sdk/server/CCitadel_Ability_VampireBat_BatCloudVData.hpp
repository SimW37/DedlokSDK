...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_VampireBat_BatCloudVData : public server::CitadelAbilityVData
    {
    public:
        ...
        client::CitadelCameraOperationsSequence_t m_cameraSequenceBatCloud; // 0x17e0        
    ...
    static_assert(sizeof(CCitadel_Ability_VampireBat_BatCloudVData) == 0x1878);
};
