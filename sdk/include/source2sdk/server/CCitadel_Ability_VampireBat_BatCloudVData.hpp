...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_AuraParticle[0xe0]; // 0x1608            
            ...
            char m_BatHitParticle[0xe0]; // 0x16e8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strFireBatSound; // 0x17c8            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceBatCloud; // 0x17d8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flCameraForwardForce; // 0x1860            
            float m_flInputForce; // 0x1864            
            float m_flDampingConstant; // 0x1868            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_VampireBat_BatCloudVData) == 0x1870);
    };
};
