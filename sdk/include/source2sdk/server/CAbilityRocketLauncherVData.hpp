...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityRocketLauncherVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CAbilityRocketLauncherVData) == 0x16c8);
    };
};
