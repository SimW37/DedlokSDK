...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_CounterspellWatcherVData : public server::CCitadel_Modifier_Intrinsic_BaseVData
    {
    public:
        ...
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ParryFXOverride;
    ...
    static_assert(sizeof(CCitadel_Modifier_CounterspellWatcherVData) == 0x760);
};
