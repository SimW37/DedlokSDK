...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_iIdolParticle; // 0x1d0            
            std::int32_t m_nGoldValue; // 0x1d4            
            bool m_bRevealed; // 0x1d8            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_HoldingGoldenIdol) == 0x1e0);
    };
};
