...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_LeapModifier[0x10]; // 0x15c8        
        ...
        char m_DoublePounceModifier[0x10]; // 0x15f8        
        ...
        char m_AttackParticle[0xe0]; // 0x1608        
        ...
        char m_FlashParticle[0xe0]; // 0x16e8        
        ...
        char m_ExplodeSlowParticle[0xe0]; // 0x18a8        
        ...
        char m_PrimaryHitParticle[0xe0]; // 0x1988        
    ...
    static_assert(sizeof(CCitadel_Ability_Nano_Pounce_VData) == 0x1a98);
};
