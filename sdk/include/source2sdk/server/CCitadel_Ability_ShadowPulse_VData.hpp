...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_ShadowPulse_VData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_EscapeModifier[0x10]; // 0x15f0            
            ...
            char m_StartAoEParticle[0xe0]; // 0x1610            
            ...
            char m_ExitAoEParticle[0xe0]; // 0x16f0            
            ...
            char m_EffectParticle[0xe0]; // 0x17d0            
            ...
            char m_HitParticle[0xe0]; // 0x18b0            
            ...
            char m_RadiusParticle[0xe0]; // 0x1990            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strExpireSound; // 0x1a70            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceInShadow; // 0x1a80            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ShadowPulse_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ShadowPulse_VData) == 0x1b08);
    };
};
