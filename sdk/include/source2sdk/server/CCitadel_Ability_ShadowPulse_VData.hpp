...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_ShadowPulse_VData : public server::CitadelAbilityVData
    {
    public:
        ...
        client::CitadelCameraOperationsSequence_t m_cameraSequenceInShadow; // 0x1a80        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_ShadowPulse_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_ShadowPulse_VData) == 0x1b08);
};
