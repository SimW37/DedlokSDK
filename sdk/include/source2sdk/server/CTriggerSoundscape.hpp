...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hSoundscape[0x4]; // 0x8d8            
            uint8_t _pad08dc[0x4]; // 0x8dc
            CUtlSymbolLarge m_SoundscapeName; // 0x8e0            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerSoundscape) == 0x900);
    };
};
