...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_Gunslinger_SpreadingFireVData : public server::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_FireDebuffModifier;
        char m_FireDebuffModifier[0x10]; // 0x16a8        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Ability_Gunslinger_SpreadingFireVData) == 0x16b8);
};
