...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbilityWreckerScrapBlastVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_SprayParticle[0xe0]; // 0x1618            
            ...
            char m_ChannelStartParticle[0xe0]; // 0x16f8            
        ...
        static_assert(sizeof(source2sdk::server::CAbilityWreckerScrapBlastVData) == 0x17e8);
    };
};
