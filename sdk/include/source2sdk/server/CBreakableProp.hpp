...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CPropDataComponent m_CPropDataComponent; // 0xb00            
            source2sdk::entity2::CEntityIOOutput m_OnStartDeath; // 0xb40            
            source2sdk::entity2::CEntityIOOutput m_OnBreak; // 0xb68            
            // m_OnHealthChanged has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEntityOutputTemplate<float> m_OnHealthChanged;
            char m_OnHealthChanged[0x28]; // 0xb90            
            source2sdk::entity2::CEntityIOOutput m_OnTakeDamage; // 0xbb8            
            float m_impactEnergyScale; // 0xbe0            
            std::int32_t m_iMinHealthDmg; // 0xbe4            
            ...
            source2sdk::client::PerformanceMode_t m_PerformanceMode; // 0xc0c            
            source2sdk::entity2::GameTime_t m_flPreventDamageBeforeTime; // 0xc10            
            source2sdk::client::BreakableContentsType_t m_BreakableContentsType; // 0xc14            
        ...
        static_assert(sizeof(source2sdk::server::CBreakableProp) == 0xc88);
    };
};
