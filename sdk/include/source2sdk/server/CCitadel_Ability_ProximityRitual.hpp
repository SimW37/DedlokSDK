...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ECatStatueState_t m_eState; // 0xf90            
            ...
            char m_hStatue[0x4]; // 0xf94            
            source2sdk::entity2::GameTime_t m_tCatRecallTime; // 0xf98            
            std::int32_t m_iCatRecallHealth; // 0xf9c            
            VectorWS m_vLaunchPosition; // 0xfa0            
            QAngle m_qLaunchAngle; // 0xfac            
            uint8_t _pad0fb8[0x388];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ProximityRitual because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ProximityRitual) == 0x1340);
    };
};
