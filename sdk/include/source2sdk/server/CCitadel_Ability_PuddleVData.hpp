...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_PuddleVData : public server::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_PuddleModifier;
        char m_PuddleModifier[0x10]; // 0x15c8        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_PuddleVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_PuddleVData) == 0x15d8);
};
