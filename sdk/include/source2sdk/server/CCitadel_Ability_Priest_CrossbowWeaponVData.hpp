...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_strBoltSound; // 0x1870            
            CSoundEventName m_strReadySound; // 0x1880            
            CSoundEventName m_strShootDelaySound; // 0x1890            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceBolt; // 0x18a0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Priest_CrossbowWeaponVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Priest_CrossbowWeaponVData) == 0x1928);
    };
};
