...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CastCompleteParticle[0xe0]; // 0x1680            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strBuffGainedSound; // 0x1760            
            ...
            char m_InvisModifier[0x10]; // 0x1770            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_UtilityUpgrade_AOESmokeBombVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_UtilityUpgrade_AOESmokeBombVData) == 0x1780);
    };
};
