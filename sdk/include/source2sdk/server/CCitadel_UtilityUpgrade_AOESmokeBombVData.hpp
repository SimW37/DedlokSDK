...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_CastCompleteParticle[0xe0]; // 0x1610        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strBuffGainedSound; // 0x16f0        
    ...
    static_assert(sizeof(CCitadel_UtilityUpgrade_AOESmokeBombVData) == 0x1710);
};
