...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_PreExplodeParticle[0xe0]; // 0x16f8            
            // m_ExplodeParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ExplodeParticle;
            char m_ExplodeParticle[0xe0]; // 0x17d8            
            ...
            char m_nDeathMarkParticle[0xe0]; // 0x18b8            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ZombieModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ElectricBulletBuffModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Frank_ReviveVData) == 0x1ad8);
    };
};
