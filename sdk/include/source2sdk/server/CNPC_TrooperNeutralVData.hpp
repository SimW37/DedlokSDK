...
namespace source2sdk::server
{
    ...
    {
    public:
        client::ENeutralTrooperType m_eTrooperType; // 0x1100        
        ...
        [[maybe_unused]] std::uint8_t pad_0x110f[0x1]; // 0x110f
        ...
        [[maybe_unused]] std::uint8_t pad_0x111c[0x4]; // 0x111c
        ...
        [[maybe_unused]] std::uint8_t pad_0x1449[0x7]; // 0x1449
        CSoundEventName m_IdleLoopSound; // 0x1450        
        // metadata: MPropertyStartGroup "Movement"
        client::MoveType_t m_MoveType; // 0x1460        
        ...
        int32_t m_iVaultSuccessLightBuffDropCount; // 0x1470        
        int32_t m_iVaultSuccessHeavyBuffDropCount; // 0x1474        
    ...
    static_assert(sizeof(CNPC_TrooperNeutralVData) == 0x1700);
};
