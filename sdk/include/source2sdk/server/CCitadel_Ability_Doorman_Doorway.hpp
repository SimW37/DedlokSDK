...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hDoor1[0x4]; // 0xfc0            
            uint8_t _pad0fc4[0x4]; // 0xfc4
            double m_flLastRangeFailCast; // 0xfc8            
            uint8_t _pad0fd0[0x180]; // 0xfd0
            float m_flDoorBreakableRadius; // 0x1150            
            uint8_t _pad1154[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Doorman_Doorway because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Doorman_Doorway) == 0x1158);
    };
};
