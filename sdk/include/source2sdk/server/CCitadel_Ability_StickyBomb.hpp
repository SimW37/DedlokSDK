...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hAutoTarget[0x4]; // 0xb9c            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flHookEndTime; // 0xba0            
            // metadata: MNetworkEnable
            float m_flBombBonus; // 0xba4            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_StickyBomb) == 0xce8);
    };
};
