...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_Position[0x28]; // 0x9a0            
            source2sdk::entity2::CEntityIOOutput m_OnUnpressed; // 0x9c8            
            source2sdk::entity2::CEntityIOOutput m_OnFullyOpen; // 0x9f0            
            source2sdk::entity2::CEntityIOOutput m_OnFullyClosed; // 0xa18            
            source2sdk::entity2::CEntityIOOutput m_OnReachedPosition; // 0xa40            
            std::int32_t m_lastUsed; // 0xa68            
            QAngle m_start; // 0xa6c            
            QAngle m_end; // 0xa78            
            float m_IdealYaw; // 0xa84            
            CUtlSymbolLarge m_sNoise; // 0xa88            
            bool m_bUpdateTarget; // 0xa90            
            uint8_t _pad0a91[0x3]; // 0xa91
            std::int32_t m_direction; // 0xa94            
            float m_returnSpeed; // 0xa98            
            float m_flStartPosition; // 0xa9c            
        ...
        static_assert(sizeof(source2sdk::server::CMomentaryRotButton) == 0xaa0);
    };
};
