...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_BubbleParticle[0xe0]; // 0x658        
        ...
        char m_BubbleExplodeParticle[0xe0]; // 0x738        
