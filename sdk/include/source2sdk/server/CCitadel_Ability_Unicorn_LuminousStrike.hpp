...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t m_flLastStackChangeTime; // 0xf90            
            std::int32_t m_nLastStackCount; // 0xf94            
            uint8_t _pad0f98[0x18]; // 0xf98
            ...
            char m_vecNextExplosionTime[0x18]; // 0xfb0            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            ...
            char m_vecNextExplosionLocation[0x18]; // 0xfc8            
            std::int32_t m_nStackCount; // 0xfe0            
            bool m_bPendingStackUpdate; // 0xfe4            
            uint8_t _pad0fe5[0x383];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Unicorn_LuminousStrike because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Unicorn_LuminousStrike) == 0x1368);
    };
};
