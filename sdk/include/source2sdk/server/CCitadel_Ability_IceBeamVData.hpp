...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_BeamParticle[0xe0]; // 0x15c8        
        ...
        char m_BuildupModifier[0x10]; // 0x1798        
        ...
        char m_BuildupProcModifier[0x10]; // 0x17a8        
    ...
    static_assert(sizeof(CCitadel_Ability_IceBeamVData) == 0x1808);
};
