...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bInGround; // 0x1410            
            uint8_t _pad1411[0x3]; // 0x1411
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flLastDamageTime; // 0x1414            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
            source2sdk::entity2::GameTime_t m_SpinEndTime; // 0x1418            
            uint8_t _pad141c[0x2c];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Burrow because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Burrow) == 0x1448);
    };
};
