...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_MagicShock_ProcVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CBaseModifier> m_hDamageTrackModifier;
            char m_hDamageTrackModifier[0x10]; // 0x770            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_MagicShock_ProcVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_MagicShock_ProcVData) == 0x780);
    };
};
