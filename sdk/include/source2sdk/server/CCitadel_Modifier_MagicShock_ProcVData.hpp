...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CEmbeddedSubclass<server::CBaseModifier> m_hDamageTrackModifier;
        char m_hDamageTrackModifier[0x10]; // 0x768        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Modifier_MagicShock_ProcVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Modifier_MagicShock_ProcVData) == 0x778);
};
