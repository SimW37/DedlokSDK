...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t m_flNextProcTime; // 0xf90            
            float m_flBaseCooldown; // 0xf94            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_PowerSurge) == 0x1098);
    };
};
