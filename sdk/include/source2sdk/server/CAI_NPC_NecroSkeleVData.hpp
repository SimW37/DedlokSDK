...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAI_NPC_NecroSkeleVData : public source2sdk::server::CAI_CitadelNPCVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ExplodeModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_DamageSlowModifier;
        ...
        static_assert(sizeof(source2sdk::server::CAI_NPC_NecroSkeleVData) == 0x1388);
    };
};
