...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            uint8_t _pad027c[0x4]; // 0x27c
            source2sdk::server::AI_VolumetricEventHandle_t m_hMovementEvent; // 0x280            
            float m_flTargetRadius; // 0x288            
            bool m_bDisableMovementEvents; // 0x28c            
            uint8_t _pad028d[0x3]; // 0x28d
            Vector m_vecSmoothedVelocity; // 0x290            
        ...
        static_assert(sizeof(source2sdk::server::CPlayer_MovementServices_Humanoid) == 0x2a0);
    };
};
