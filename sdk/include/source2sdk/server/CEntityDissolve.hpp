...
namespace source2sdk::server
{
    ...
    public:
        ...
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flStartTime; // 0x7e8        
        // metadata: MNetworkEnable
        client::EntityDisolveType_t m_nDissolveType; // 0x7ec        
        // metadata: MNetworkEnable
        Vector m_vDissolverOrigin; // 0x7f0        
        // metadata: MNetworkEnable
        uint32_t m_nMagnitude; // 0x7fc        
    ...
    static_assert(sizeof(CEntityDissolve) == 0x800);
};
