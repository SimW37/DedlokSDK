...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_CrushingFistsWatcher_VData : public source2sdk::server::CCitadel_Modifier_Intrinsic_BaseVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_StackingDebuffModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_CrushingFistsWatcher_VData) == 0x680);
    };
};
