...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Ability_ViperVenomVData : public server::CitadelAbilityVData
    {
    public:
        ...
        char m_BuildUpModifier[0x10]; // 0x15f0        
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_VenomModifier;
        char m_VenomModifier[0x10]; // 0x1600        
        ...
        char m_CastVenomParticle[0xe0]; // 0x1610        
        ...
        char m_VenomExplodeParticle[0xe0]; // 0x16f0        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strVenomWeakExplode; // 0x17d0        
        CSoundEventName m_strVenomExplode; // 0x17e0        
        CSoundEventName m_strVenomStrongExplode; // 0x17f0        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_ViperVenomVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_ViperVenomVData) == 0x1800);
};
