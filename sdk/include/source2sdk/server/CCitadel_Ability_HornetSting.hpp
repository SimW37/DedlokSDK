...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_BounceCount; // 0xf90            
            bool m_bHitHero; // 0xf94            
            ...
            char m_vecValidBounceTargets[0x18]; // 0xf98            
            uint8_t _pad0fb0[0x380];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_HornetSting because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_HornetSting) == 0x1330);
    };
};
