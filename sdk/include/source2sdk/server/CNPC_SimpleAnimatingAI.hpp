...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hAbilityOwner[0x4]; // 0xa94            
            // metadata: MNetworkEnable
            ...
            source2sdk::server::CCitadelRegenComponent m_CCitadelRegenComponent; // 0xa98            
        ...
        static_assert(sizeof(source2sdk::server::CNPC_SimpleAnimatingAI) == 0xc00);
    };
};
