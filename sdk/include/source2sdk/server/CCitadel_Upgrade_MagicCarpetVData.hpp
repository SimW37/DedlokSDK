...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SummonParticle[0xe0]; // 0x16b0            
            ...
            char m_FlyingCarpetModifier[0x10]; // 0x1790            
            ...
            char m_SummonFlyingCarpetModifier[0x10]; // 0x17a0            
            ...
            char m_SummonFlyingCarpetVisualModifier[0x10]; // 0x17b0            
            ...
            char m_FlyingCarpetVisualModifier[0x10]; // 0x17c0            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flSummonVisualDuration; // 0x17d0            
            float m_flBurstSpeedBonus; // 0x17d4            
            float m_flBurstSpeedMin; // 0x17d8            
            float m_flBurstSpeedDuration; // 0x17dc            
            float m_flMinDistanceAboveGround; // 0x17e0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Upgrade_MagicCarpetVData) == 0x17e8);
    };
};
