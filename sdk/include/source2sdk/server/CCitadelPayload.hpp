...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hBlockerAura[0x18]; // 0xc68            
            uint8_t _pad0c80[0x18]; // 0xc80
            // metadata: MNetworkEnable
            float m_flProgress; // 0xc98            
            // metadata: MNetworkEnable
            std::int32_t m_nNumPushers; // 0xc9c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadelPayload because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadelPayload) == 0xca0);
    };
};
