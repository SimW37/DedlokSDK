...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::Materials m_Material; // 0x818            
        ...
        static_assert(sizeof(source2sdk::server::CBreakable) == 0x8a8);
    };
};
