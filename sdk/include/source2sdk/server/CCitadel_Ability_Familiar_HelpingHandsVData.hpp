...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Familiar_HelpingHandsVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_AIPhysicsModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_AIAggroModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_InvisWatcherModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_InfestModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_InfestWaitingModifier;
            char m_InfestWaitingModifier[0x10]; // 0x1858            
            // m_InfestBuildingModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_InfestBuildingModifier;
            char m_InfestBuildingModifier[0x10]; // 0x1868            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_InfestBarrierModifier;
            char m_InfestBarrierModifier[0x10]; // 0x1878            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strHelperShootSound; // 0x1888            
            CSoundEventName m_strHelperSpawnSound; // 0x1898            
            CSoundEventName m_strHelperEmoteSound; // 0x18a8            
            CSoundEventName m_strHelperFoundEnemySound; // 0x18b8            
            CSoundEventName m_strHelperHealTroopSound; // 0x18c8            
            CSoundEventName m_strHelperScaredSound; // 0x18d8            
            CSoundEventName m_strHelperBuffSound; // 0x18e8            
            ...
            char m_EmoteParticle[0xe0]; // 0x18f8            
            ...
            char m_HealParticle[0xe0]; // 0x19d8            
            ...
            char m_DamageParticle[0xe0]; // 0x1ab8            
            ...
            char m_DamageAttachedParticle[0xe0]; // 0x1b98            
            ...
            char m_CastRegionIndicatorParticle[0xe0]; // 0x1c78            
            ...
            char m_AuraIndicatorParticle[0xe0]; // 0x1d58            
            ...
            char m_AuraInactiveParticle[0xe0]; // 0x1e38            
            ...
            char m_HelperCreateParticle[0xe0]; // 0x1f18            
            ...
            char m_HelperDestroyParticle[0xe0]; // 0x1ff8            
            ...
            char m_HelperParticle[0xe0]; // 0x20d8            
            ...
            char m_HelperSleepingParticle[0xe0]; // 0x21b8            
            ...
            char m_HelperAttackingParticle[0xe0]; // 0x2298            
            ...
            char m_HelperStunnedParticle[0xe0]; // 0x2378            
            ...
            char m_HelperChargingUpParticle[0xe0]; // 0x2458            
            ...
            char m_HelperAttachedParticle[0xe0]; // 0x2538            
            ...
            char m_HelperTeleportOutParticle[0xe0]; // 0x2618            
            ...
            char m_HelperTeleportInParticle[0xe0]; // 0x26f8            
            ...
            char m_HelperTargetIndicateParticle[0xe0]; // 0x27d8            
            ...
            char m_InfestedParticle[0xe0]; // 0x28b8            
            ...
            char m_InfestedHeroParticle[0xe0]; // 0x2998            
            ...
            char m_ScaredParticle[0xe0]; // 0x2a78            
            // metadata: MPropertyStartGroup "Collision"
            float m_flCollisionSize; // 0x2b58            
            float m_flCollisionHeight; // 0x2b5c            
            // metadata: MPropertyStartGroup "Damaging Jump"
            float m_flLaunchBiasUp; // 0x2b60            
            float m_flLaunchSpeedMult; // 0x2b64            
            float m_flLaunchMaxSpeed; // 0x2b68            
            float m_flHomingBias; // 0x2b6c            
            float m_flDamageCollisonScale; // 0x2b70            
            uint8_t _pad2b74[0x4]; // 0x2b74
            // metadata: MPropertyStartGroup "Emote"
            CPiecewiseCurve m_EmoteVelocityZByTime; // 0x2b78            
            CPiecewiseCurve m_EmoteSpinByTime; // 0x2bb8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flNewlySpawnedWaitTime; // 0x2bf8            
            float m_flHealInterval; // 0x2bfc            
            float m_flSpawnLaunchUpBias; // 0x2c00            
            float m_flSpawnLaunchForce; // 0x2c04            
            float m_flMoveTolerance_Meters; // 0x2c08            
            float m_flMoveTolerance_UnitTarget_Meters; // 0x2c0c            
            float m_flTolerance_FarFromPlayer_Meters; // 0x2c10            
            float m_flTolerance_CloseToPlayer_Meters; // 0x2c14            
            CPiecewiseCurve m_PatrolTravelTimeByDistance; // 0x2c18            
            float m_flInfestedNPCModelScale; // 0x2c58            
            uint8_t _pad2c5c[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Familiar_HelpingHandsVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Familiar_HelpingHandsVData) == 0x2c60);
    };
};
