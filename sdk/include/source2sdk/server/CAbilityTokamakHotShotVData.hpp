...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_LaserModifier[0x10]; // 0x15c8        
        ...
        char m_BeamParticle[0xe0]; // 0x16f8        
        ...
        char m_HitParticle[0xe0]; // 0x17d8        
