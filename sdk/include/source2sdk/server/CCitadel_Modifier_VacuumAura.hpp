...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xe0[0x1c0]; // 0xe0
        ...
        int32_t m_nNumPlayersKilled; // 0x2b8        
        entity2::GameTime_t m_tLastDamageTime; // 0x2bc        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Modifier_VacuumAura because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Modifier_VacuumAura) == 0x2c0);
};
