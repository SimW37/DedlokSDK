...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hEnemyHeroInVacuum[0x18]; // 0x2a0            
            std::int32_t m_nNumPlayersKilled; // 0x2b8            
            source2sdk::entity2::GameTime_t m_tLastDamageTime; // 0x2bc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_VacuumAura because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_VacuumAura) == 0x2c0);
    };
};
