...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ProjectileInfo_t m_projectileInfo; // 0x780            
            // metadata: MPropertyFriendlyName "Deployment Info"
            source2sdk::client::DeploymentInfo_t m_deploymentInfo; // 0xb20            
            // metadata: MPropertyStartGroup
            ...
            source2sdk::client::AdditionalAbilities_t m_additionalAbilities; // 0xe78            
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceCastStart; // 0xeb0            
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceCastComplete; // 0xf40            
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceChannelStart; // 0xfc8            
        ...
        static_assert(sizeof(source2sdk::server::CitadelAbilityVData) == 0x15f0);
    };
};
