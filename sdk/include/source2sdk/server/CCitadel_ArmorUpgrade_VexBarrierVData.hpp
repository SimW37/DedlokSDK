...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_ArmorUpgrade_VexBarrierVData : public source2sdk::server::CitadelItemVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_VexBarrierVData) == 0x1688);
    };
};
