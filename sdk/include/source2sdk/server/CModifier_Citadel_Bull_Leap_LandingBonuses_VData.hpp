...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Citadel_Bull_Leap_LandingBonuses_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CModifier_Citadel_Bull_Leap_LandingBonuses_VData) == 0x740);
    };
};
