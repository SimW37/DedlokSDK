...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            uint8_t _pad0fa4[0x8]; // 0xfa4
            float m_flStoredPowerPct; // 0xfac            
            uint8_t _pad0fb0[0x500];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Chrono_KineticCarbine because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Chrono_KineticCarbine) == 0x14b0);
    };
};
