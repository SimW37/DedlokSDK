...
namespace source2sdk::server
{
    ...
    public:
        ...
        server::CCitadelAbilityComponent m_CCitadelAbilityComponent; // 0x6550        
        [[maybe_unused]] std::uint8_t pad_0x6790[0x4]; // 0x6790
        // metadata: MNetworkEnable
        bool m_bPickedUp; // 0x6794        
        [[maybe_unused]] std::uint8_t pad_0x6795[0x3];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadelItemPickupRejuv because it is not a standard-layout class
    static_assert(sizeof(CCitadelItemPickupRejuv) == 0x6798);
};
