...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_strDashStartWithTargets; // 0x18d0            
            CSoundEventName m_strDashStartEcho; // 0x18e0            
            CSoundEventName m_strDashStartMiss; // 0x18f0            
            CSoundEventName m_strDashHitEnemy; // 0x1900            
            // metadata: MPropertyStartGroup "+Dash Properties"
            float m_flEchoDelay; // 0x1910            
        ...
        static_assert(sizeof(source2sdk::server::CAbilityShivDashVData) == 0x1918);
    };
};
