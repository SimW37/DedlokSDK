...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hAuraThinker[0x4]; // 0xf90            
            source2sdk::client::ParticleIndex_t m_nEyeGlowFX; // 0xf94            
            VectorWS m_vLastValidAuraPosition; // 0xf98            
            uint8_t _pad0fa4[0x84]; // 0xfa4
            ...
            char m_hWasAttachedTo[0x4]; // 0x1028            
            // metadata: MNetworkEnable
            VectorWS m_vAuraPosition; // 0x102c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Familiar_Spotlight because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Familiar_Spotlight) == 0x1038);
    };
};
