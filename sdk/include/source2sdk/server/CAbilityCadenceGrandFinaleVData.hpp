...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_StageModel[0xe0]; // 0x1618            
            float m_flStageModelHeight; // 0x16f8            
            float m_flStageModelWidth; // 0x16fc            
            float m_flStageModelLength; // 0x1700            
            float m_flStageModelScale; // 0x1704            
            ...
            char m_GrandFinaleAOEModifier[0x10]; // 0x1708            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityCadenceGrandFinaleVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityCadenceGrandFinaleVData) == 0x1718);
    };
};
