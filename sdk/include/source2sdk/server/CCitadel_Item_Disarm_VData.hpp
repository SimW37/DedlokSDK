...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_Disarm_VData : public source2sdk::server::CCitadel_Item_TrackingProjectileApplyModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Item_Disarm_VData) == 0x17c8);
    };
};
