...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_FriendlyWallParticle[0xe0]; // 0x15f0            
            ...
            char m_EnemyWallParticle[0xe0]; // 0x16d0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_WallTravelSoundLoop; // 0x17b0            
            ...
            char m_WallModifier[0x10]; // 0x17c0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_FissureWallVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_FissureWallVData) == 0x17d0);
    };
};
