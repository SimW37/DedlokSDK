...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_FriendlyWallParticle[0xe0]; // 0x1618            
            ...
            char m_EnemyWallParticle[0xe0]; // 0x16f8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_WallTravelSoundLoop; // 0x17d8            
            ...
            char m_WallModifier[0x10]; // 0x17e8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flWallPreviewDropdownRate; // 0x17f8            
            float m_flWallStepHeight; // 0x17fc            
            float m_flWallTraceRadius; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_FissureWallVData) == 0x1808);
    };
};
