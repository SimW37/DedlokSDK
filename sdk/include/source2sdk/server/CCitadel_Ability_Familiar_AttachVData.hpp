...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Familiar_AttachVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_AttachedModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_MovingToAttachModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_CameraDummyModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SpeedModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_DeathBarrierModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_HopOutLockoutModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_LaunchedSelfModifier;
            char m_LaunchedSelfModifier[0x10]; // 0x1878            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_AllyLockoutModifier;
            char m_AllyLockoutModifier[0x10]; // 0x1888            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_HopOffBuffModifier;
            char m_HopOffBuffModifier[0x10]; // 0x1898            
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_AttachHealModifier;
            char m_AttachHealModifier[0x10]; // 0x18a8            
            ...
            char m_sCamDummyModelName[0xe0]; // 0x18b8            
            ...
            char m_FakeFamiliarParticle[0xe0]; // 0x1998            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flDetachForce; // 0x1a78            
            float m_flDetachForceUp; // 0x1a7c            
            float m_flTriggeredDetachForce; // 0x1a80            
            float m_flTriggeredDetachForceUp; // 0x1a84            
            CPiecewiseCurve m_MovingToAttachProjectileSpeedCurve; // 0x1a88            
            CPiecewiseCurve m_LaunchAngleRemap; // 0x1ac8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Familiar_AttachVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Familiar_AttachVData) == 0x1b08);
    };
};
