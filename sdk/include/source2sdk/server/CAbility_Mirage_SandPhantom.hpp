...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bHasVictims; // 0xf90            
            uint8_t _pad0f91[0x7]; // 0xf91
            ...
            char m_vecVictimModifiers[0x18]; // 0xf98            
            uint8_t _pad0fb0[0x100];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Mirage_SandPhantom because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbility_Mirage_SandPhantom) == 0x10b0);
    };
};
