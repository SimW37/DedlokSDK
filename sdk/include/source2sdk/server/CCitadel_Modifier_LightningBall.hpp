...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_LightningBall : public source2sdk::server::CCitadelModifier
        {
        public:
            uint8_t _pad00c0[0xc0]; // 0xc0
            // m_hProjectile has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hProjectile;
            char m_hProjectile[0x4]; // 0x180            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_LightningBall) == 0x188);
    };
};
