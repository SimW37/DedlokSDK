...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ProjectileImpactParticle[0xe0]; // 0x1678            
            ...
            char m_TargetModifier[0x10]; // 0x1758            
            ...
            char m_FriendlyOnlyModifier[0x10]; // 0x1768            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Item_TrackingProjectileApplyModifierVData) == 0x1778);
    };
};
