...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_iMagnitude; // 0x7d0            
            float m_flPlayerDamage; // 0x7d4            
            std::int32_t m_iRadiusOverride; // 0x7d8            
            ...
            source2sdk::client::DamageTypes_t m_iCustomDamageType; // 0x7e8            
            bool m_bCreateDebris; // 0x7ec            
            uint8_t _pad07ed[0xb]; // 0x7ed
            ...
            source2sdk::client::Class_T m_iClassIgnore; // 0x80c            
            source2sdk::client::Class_T m_iClassIgnore2; // 0x810            
        ...
        static_assert(sizeof(source2sdk::server::CEnvExplosion) == 0x828);
    };
};
