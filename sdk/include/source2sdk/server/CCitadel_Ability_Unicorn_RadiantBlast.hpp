...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Ability_Unicorn_RadiantBlast : public source2sdk::server::CCitadelBaseAbility
        {
        public:
            ...
            char m_vecHitTargets[0x18]; // 0x1190            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Unicorn_RadiantBlast because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Unicorn_RadiantBlast) == 0x11a8);
    };
};
