...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_TeamRelativeParticleVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_ParentViewParticle[0xe0]; // 0x660            
            ...
            char m_OtherPlayerViewParticle[0xe0]; // 0x740            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_TeamRelativeParticleVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_TeamRelativeParticleVData) == 0x820);
    };
};
