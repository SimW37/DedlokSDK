...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_TeamRelativeParticleVData : public server::CCitadelModifierVData
    {
    public:
        ...
        char m_ParentViewParticle[0xe0]; // 0x658        
