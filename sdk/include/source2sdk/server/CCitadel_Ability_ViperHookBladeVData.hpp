...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SlowDebuffModifier[0x10]; // 0x1620            
            ...
            char m_DaggerStuckParticle[0xe0]; // 0x1630            
            ...
            char m_DaggerImpactParticle[0xe0]; // 0x1710            
            ...
            char m_DaggerExplodeParticle[0xe0]; // 0x17f0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strDaggerHitSound; // 0x18d0            
            CSoundEventName m_strDaggerExplodeSound; // 0x18e0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ViperHookBladeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ViperHookBladeVData) == 0x18f0);
    };
};
