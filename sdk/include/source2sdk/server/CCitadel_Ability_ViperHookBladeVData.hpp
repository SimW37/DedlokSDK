...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_SlowDebuffModifier[0x10]; // 0x15c8        
        ...
        char m_DaggerStuckParticle[0xe0]; // 0x15d8        
        ...
        char m_DaggerImpactParticle[0xe0]; // 0x16b8        
        ...
        char m_DaggerExplodeParticle[0xe0]; // 0x1798        
    ...
    static_assert(sizeof(CCitadel_Ability_ViperHookBladeVData) == 0x1898);
};
