...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_ViperHookBladeVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            char m_SlowDebuffModifier[0x10]; // 0x1618            
            ...
            char m_DaggerStuckParticle[0xe0]; // 0x1628            
            ...
            char m_DaggerImpactParticle[0xe0]; // 0x1708            
            ...
            char m_DaggerExplodeParticle[0xe0]; // 0x17e8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strDaggerHitSound; // 0x18c8            
            CSoundEventName m_strDaggerExplodeSound; // 0x18d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ViperHookBladeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ViperHookBladeVData) == 0x18e8);
    };
};
