...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CAbilityTargetPracticeVData : public server::CitadelAbilityVData
    {
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_TargetPracticeSelfModifier;
        char m_TargetPracticeSelfModifier[0x10]; // 0x15c8        
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_TargetPracticeEnemyModifier;
        char m_TargetPracticeEnemyModifier[0x10]; // 0x15d8        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityTargetPracticeVData because it is not a standard-layout class
    static_assert(sizeof(CAbilityTargetPracticeVData) == 0x15e8);
};
