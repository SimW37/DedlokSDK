...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_strWindupSound; // 0x1648            
            CSoundEventName m_strBeamStartSound; // 0x1658            
            CSoundEventName m_strBeamLoopSound1; // 0x1668            
            CSoundEventName m_strBeamLoopSound2; // 0x1678            
            CSoundEventName m_strBeamStopSound; // 0x1688            
            ...
            char m_szWeaponBeamParticle[0xe0]; // 0x1698            
            // metadata: MPropertyStartGroup "Misc"
            float m_flWindupRepeatCycle; // 0x1778            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_PrimaryWeapon_BebopVData) == 0x1780);
    };
};
