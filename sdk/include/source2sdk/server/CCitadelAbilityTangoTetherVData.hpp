...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_TetherModifier[0x10]; // 0x1620            
            ...
            char m_GrappleTargetModifier[0x10]; // 0x1630            
            ...
            char m_BulletGrappleTracerParticle[0xe0]; // 0x1640            
            ...
            char m_EnemyGrappleParticle[0xe0]; // 0x1720            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strDamageTarget; // 0x1800            
            CSoundEventName m_strGrappleHitTarget; // 0x1810            
            CSoundEventName m_strGrappleHitWorld; // 0x1820            
            CSoundEventName m_strGrappleHitNothing; // 0x1830            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadelAbilityTangoTetherVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadelAbilityTangoTetherVData) == 0x1840);
    };
};
