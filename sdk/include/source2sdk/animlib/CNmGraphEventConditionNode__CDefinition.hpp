...
#include "source2sdk/animlib/CNmGraphEventConditionNode__Condition_t.hpp"
...
namespace source2sdk::animlib
{
    ...
    #pragma pack(push, 1)
    class CNmGraphEventConditionNode__CDefinition : public animlib::CNmBoolValueNode__CDefinition
    {
    public:
        ...
        // CUtlVectorFixedGrowable<animlib::CNmGraphEventConditionNode__Condition_t,5> m_conditions;
    ...
    static_assert(sizeof(CNmGraphEventConditionNode__CDefinition) == 0x80);
};
