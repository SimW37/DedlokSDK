...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CParticleCollectionRendererFloatInput m_nSequenceOverride; // 0x2c08        
        ...
        particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x2d68        
        ...
        particleslib::CParticleCollectionRendererFloatInput m_flMinSize; // 0x2d78        
        // metadata: MPropertyFriendlyName "maximum visual screen size"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flMaxSize; // 0x2ed8        
        // metadata: MPropertyFriendlyName "Factor to map size adjustment to alpha"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flAlphaAdjustWithSizeAdjust; // 0x3038        
        // metadata: MPropertyFriendlyName "screen size to start fading"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flStartFadeSize; // 0x3198        
        // metadata: MPropertyFriendlyName "screen size to fade away"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flEndFadeSize; // 0x32f8        
        ...
        [[maybe_unused]] std::uint8_t pad_0x3462[0x2]; // 0x3462
        ...
        particles::ParticleLightingQuality_t m_nLightingMode; // 0x3488        
        [[maybe_unused]] std::uint8_t pad_0x348c[0x4]; // 0x348c
        ...
        particleslib::CParticleCollectionRendererFloatInput m_flLightingTessellation; // 0x3490        
        // metadata: MPropertyFriendlyName "lighting directionality"
        // metadata: MPropertySortPriority "400"
        // metadata: MPropertySuppressExpr "mod != hlx"
        particleslib::CParticleCollectionRendererFloatInput m_flLightingDirectionality; // 0x35f0        
        // metadata: MPropertyFriendlyName "Particle Shadows"
        // metadata: MPropertySortPriority "400"
        // metadata: MPropertySuppressExpr "mod != csgo"
        bool m_bParticleShadows; // 0x3750        
        [[maybe_unused]] std::uint8_t pad_0x3751[0x3]; // 0x3751
        ...
        particles::CReplicationParameters m_replicationParameters; // 0x3758        
        [[maybe_unused]] std::uint8_t pad_0x4870[0x8];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_OP_RenderSprites because it is not a standard-layout class
    static_assert(sizeof(C_OP_RenderSprites) == 0x4878);
};
