...
namespace source2sdk::particles
{
    ...
    public:
        ...
        float m_flMinSize; // 0x2c10        
        // metadata: MPropertyFriendlyName "maximum visual screen-size"
        // metadata: MPropertySortPriority "900"
        float m_flMaxSize; // 0x2c14        
        // metadata: MPropertyFriendlyName "start fade screen-size"
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flStartFadeSize; // 0x2c18        
        // metadata: MPropertyFriendlyName "end fade and cull screen-size"
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flEndFadeSize; // 0x2d78        
        ...
        bool m_bClampV; // 0x2ed8        
        [[maybe_unused]] std::uint8_t pad_0x2ed9[0x7];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CBaseTrailRenderer because it is not a standard-layout class
    static_assert(sizeof(CBaseTrailRenderer) == 0x2ee0);
};
