...
namespace source2sdk::particles
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x23b[0x5]; // 0x23b
        ...
        [[maybe_unused]] std::uint8_t pad_0xf31[0x3]; // 0xf31
        ...
        [[maybe_unused]] std::uint8_t pad_0x15b1[0x3]; // 0x15b1
        ...
        [[maybe_unused]] std::uint8_t pad_0x15b9[0x7]; // 0x15b9
        ...
        [[maybe_unused]] std::uint8_t pad_0x1971[0x7]; // 0x1971
        ...
        [[maybe_unused]] std::uint8_t pad_0x1981[0x7]; // 0x1981
