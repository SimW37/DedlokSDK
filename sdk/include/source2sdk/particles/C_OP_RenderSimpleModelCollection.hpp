...
namespace source2sdk::particles
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x3e3[0x5]; // 0x3e3
        // metadata: MPropertyFriendlyName "render filter"
        particleslib::CPerParticleFloatInput m_fDrawFilter; // 0x3e8        
        // metadata: MPropertyFriendlyName "angular velocity attribute (improves motion blur)"
        // metadata: MPropertyAttributeChoiceName "particlefield_vector"
        particles::ParticleAttributeIndex_t m_nAngularVelocityField; // 0x548        
        [[maybe_unused]] std::uint8_t pad_0x54c[0x14];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_OP_RenderSimpleModelCollection because it is not a standard-layout class
    static_assert(sizeof(C_OP_RenderSimpleModelCollection) == 0x560);
};
