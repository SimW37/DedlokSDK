...
namespace source2sdk::particles
{
    ...
    public:
        ...
        // CUtlLeanVector<particles::TextureGroup_t> m_vecTexturesInput;
        ...
        // metadata: MPropertySortPriority "500"
        particles::AnimationType_t m_nAnimationType; // 0xf9c        
        ...
        // metadata: MPropertySortPriority "500"
        particleslib::CParticleCollectionRendererFloatInput m_flMotionVectorScaleU; // 0xfa8        
        // metadata: MPropertyFriendlyName "motion vector scale V"
        // metadata: MPropertySortPriority "500"
        particleslib::CParticleCollectionRendererFloatInput m_flMotionVectorScaleV; // 0x1108        
        ...
        particleslib::CParticleCollectionRendererFloatInput m_flSelfIllumAmount; // 0x1268        
        // metadata: MPropertyFriendlyName "diffuse lighting amount"
        // metadata: MPropertyAttributeRange "0 1"
        // metadata: MPropertySortPriority "400"
        particleslib::CParticleCollectionRendererFloatInput m_flDiffuseAmount; // 0x13c8        
        // metadata: MPropertyFriendlyName "diffuse max contribution clamp"
        // metadata: MPropertyAttributeRange "0 1"
        // metadata: MPropertySortPriority "400"
        // metadata: MPropertySuppressExpr "mod != hlx"
        particleslib::CParticleCollectionRendererFloatInput m_flDiffuseClamp; // 0x1528        
        ...
        particles::ParticleAttributeIndex_t m_nSelfIllumPerParticle; // 0x168c        
        ...
        particles::ParticleOutputBlendMode_t m_nOutputBlendMode; // 0x1690        
        ...
        [[maybe_unused]] std::uint8_t pad_0x1696[0x2]; // 0x1696
        // metadata: MPropertyFriendlyName "add self amount over alphablend"
        // metadata: MPropertySortPriority "300"
        particleslib::CParticleCollectionRendererFloatInput m_flAddSelfAmount; // 0x1698        
        // metadata: MPropertyFriendlyName "desaturation amount"
        // metadata: MPropertyAttributeRange "0 1"
        // metadata: MPropertySortPriority "300"
        particleslib::CParticleCollectionRendererFloatInput m_flDesaturation; // 0x17f8        
        // metadata: MPropertyFriendlyName "overbright factor"
        // metadata: MPropertySortPriority "300"
        particleslib::CParticleCollectionRendererFloatInput m_flOverbrightFactor; // 0x1958        
        ...
        // metadata: MPropertySortPriority "300"
        particles::ParticleFogType_t m_nFogType; // 0x1abc        
        // metadata: MPropertyFriendlyName "Fog Scale"
        // metadata: MPropertySortPriority "300"
        // metadata: MPropertySuppressExpr "mod != hlx"
        particleslib::CParticleCollectionRendererFloatInput m_flFogAmount; // 0x1ac0        
        ...
        [[maybe_unused]] std::uint8_t pad_0x1c22[0x2]; // 0x1c22
        // metadata: MPropertyStartGroup "Color and alpha adjustments/Alpha Reference"
        // metadata: MPropertyFriendlyName "alpha reference"
        // metadata: MPropertySortPriority "300"
        particles::SpriteCardPerParticleScale_t m_nPerParticleAlphaReference; // 0x1c24        
        // metadata: MPropertyFriendlyName "alpha reference window size"
        // metadata: MPropertySortPriority "300"
        particles::SpriteCardPerParticleScale_t m_nPerParticleAlphaRefWindow; // 0x1c28        
        // metadata: MPropertyFriendlyName "alpha reference type"
        // metadata: MPropertySortPriority "300"
        particles::ParticleAlphaReferenceType_t m_nAlphaReferenceType; // 0x1c2c        
        // metadata: MPropertyFriendlyName "alpha reference softness"
        // metadata: MPropertyAttributeRange "0 1"
        // metadata: MPropertySortPriority "300"
        particleslib::CParticleCollectionRendererFloatInput m_flAlphaReferenceSoftness; // 0x1c30        
        // metadata: MPropertyFriendlyName "source alpha value to map to alpha of zero"
        // metadata: MPropertyAttributeRange "0 1"
        // metadata: MPropertySortPriority "300"
        particleslib::CParticleCollectionRendererFloatInput m_flSourceAlphaValueToMapToZero; // 0x1d90        
        // metadata: MPropertyFriendlyName "source alpha value to map to alpha of 1"
        // metadata: MPropertyAttributeRange "0 1"
        // metadata: MPropertySortPriority "300"
        particleslib::CParticleCollectionRendererFloatInput m_flSourceAlphaValueToMapToOne; // 0x1ef0        
        ...
        [[maybe_unused]] std::uint8_t pad_0x2052[0x6]; // 0x2052
        // metadata: MPropertyFriendlyName "refract amount"
        // metadata: MPropertyAttributeRange "-2 2"
        // metadata: MPropertySortPriority "200"
        // metadata: MPropertySuppressExpr "!m_bRefract"
        particleslib::CParticleCollectionRendererFloatInput m_flRefractAmount; // 0x2058        
        ...
        // metadata: MPropertySortPriority "200"
        // metadata: MPropertySuppressExpr "!m_bRefract"
        particles::BlurFilterType_t m_nRefractBlurType; // 0x21bc        
        ...
        // metadata: MPropertySortPriority "900"
        particles::ParticleDepthFeatheringMode_t m_nFeatheringMode; // 0x22cc        
        // metadata: MPropertyFriendlyName "particle feathering closest distance to surface"
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flFeatheringMinDist; // 0x22d0        
        // metadata: MPropertyFriendlyName "particle feathering farthest distance to surface"
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flFeatheringMaxDist; // 0x2430        
        // metadata: MPropertyFriendlyName "particle feathering alpha filter"
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flFeatheringFilter; // 0x2590        
        // metadata: MPropertyFriendlyName "particle feathering depthmap layer filter"
        // metadata: MPropertySortPriority "900"
        // metadata: MPropertySuppressExpr "mod != hlx"
        particleslib::CParticleCollectionRendererFloatInput m_flFeatheringDepthMapFilter; // 0x26f0        
        // metadata: MPropertyFriendlyName "depth comparison bias"
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flDepthBias; // 0x2850        
        // metadata: MPropertyFriendlyName "Sort Method"
        // metadata: MPropertySortPriority "900"
        particles::ParticleSortingChoiceList_t m_nSortMethod; // 0x29b0        
        // metadata: MPropertyStartGroup "Animation"
