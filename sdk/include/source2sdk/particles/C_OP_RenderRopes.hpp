...
namespace source2sdk::particles
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x2c09[0x3]; // 0x2c09
        ...
        particles::ParticleAttributeIndex_t m_nScalarFieldForTextureCoordinate; // 0x3078        
        ...
        [[maybe_unused]] std::uint8_t pad_0x3082[0x2]; // 0x3082
        ...
        particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x3084        
        ...
        particles::ParticleAttributeIndex_t m_nVectorFieldForOrientation; // 0x3088        
