...
namespace source2sdk::particles
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x2ee1[0x3]; // 0x2ee1
        ...
        particles::ParticleAttributeIndex_t m_nPrevPntSource; // 0x2eec        
        ...
        [[maybe_unused]] std::uint8_t pad_0x2ef9[0x3]; // 0x2ef9
        ...
        // metadata: MPropertySortPriority "800"
        particleslib::CPerParticleFloatInput m_flRadiusHeadTaper; // 0x2f08        
        // metadata: MPropertyFriendlyName "head color scale"
        particleslib::CParticleCollectionVecInput m_vecHeadColorScale; // 0x3068        
        // metadata: MPropertyFriendlyName "head alpha scale"
        particleslib::CPerParticleFloatInput m_flHeadAlphaScale; // 0x36e0        
        // metadata: MPropertyFriendlyName "tail taper scale"
        particleslib::CPerParticleFloatInput m_flRadiusTaper; // 0x3840        
        // metadata: MPropertyFriendlyName "tail color scale"
        particleslib::CParticleCollectionVecInput m_vecTailColorScale; // 0x39a0        
        // metadata: MPropertyFriendlyName "tail alpha scale"
        particleslib::CPerParticleFloatInput m_flTailAlphaScale; // 0x4018        
        ...
        // metadata: MPropertySortPriority "800"
        particles::ParticleAttributeIndex_t m_nHorizCropField; // 0x4178        
        // metadata: MPropertyFriendlyName "texture UV vertical Scale field"
        // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
        particles::ParticleAttributeIndex_t m_nVertCropField; // 0x417c        
