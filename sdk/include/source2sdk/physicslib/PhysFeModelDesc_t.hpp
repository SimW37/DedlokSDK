...
namespace source2sdk
{
    namespace physicslib
    {
        ...
        public:
            ...
            char m_AntiTunnelProbes[0x18]; // 0x198            
            ...
            char m_AntiTunnelTargetNodes[0x18]; // 0x1b0            
            ...
            char m_NodeInvMasses[0x18]; // 0x1e0            
            ...
            char m_CtrlOsOffsets[0x18]; // 0x210            
            ...
            char m_CollisionPlanes[0x18]; // 0x240            
            ...
            char m_NodeIntegrator[0x18]; // 0x258            
            ...
            char m_SpringIntegrator[0x18]; // 0x270            
            ...
            char m_SimdSpringIntegrator[0x18]; // 0x288            
            ...
            char m_WorldCollisionParams[0x18]; // 0x2a0            
            ...
            char m_LegacyStretchForce[0x18]; // 0x2b8            
            ...
            char m_NodeCollisionRadii[0x18]; // 0x2d0            
            ...
            char m_DynNodeFriction[0x18]; // 0x2e8            
            ...
            char m_LocalRotation[0x18]; // 0x300            
            ...
            char m_TaperedCapsuleStretches[0x18]; // 0x330            
            ...
            char m_TaperedCapsuleRigids[0x18]; // 0x348            
            ...
            char m_SphereRigids[0x18]; // 0x360            
            ...
            char m_WorldCollisionNodes[0x18]; // 0x378            
            ...
            char m_TreeCollisionMasks[0x18]; // 0x3a8            
            ...
            char m_TreeChildren[0x18]; // 0x3c0            
            ...
            char m_ReverseOffsets[0x18]; // 0x420            
            ...
            char m_AnimStrayRadii[0x18]; // 0x438            
            ...
            char m_SimdAnimStrayRadii[0x18]; // 0x450            
            ...
            char m_KelagerBends[0x18]; // 0x468            
            ...
            char m_CtrlSoftOffsets[0x18]; // 0x480            
            ...
            char m_GoalDampedSpringIntegrators[0x18]; // 0x4c8            
            ...
            char m_Tris[0x18]; // 0x4e0            
            std::uint16_t m_nTriCount1; // 0x4f8            
            std::uint16_t m_nTriCount2; // 0x4fa            
            std::uint8_t m_nReservedUint8; // 0x4fc            
            std::uint8_t m_nExtraPressureIterations; // 0x4fd            
            std::uint8_t m_nExtraGoalIterations; // 0x4fe            
            std::uint8_t m_nExtraIterations; // 0x4ff            
            ...
            char m_DynNodeVertexSet[0x18]; // 0x530            
            ...
            char m_VertexSetNames[0x18]; // 0x548            
            ...
            char m_RigidColliderPriorities[0x18]; // 0x560            
            ...
            char m_MorphSetData[0x18]; // 0x590            
            ...
            char m_VertexMapValues[0x18]; // 0x5c0            
            ...
            char m_LockToParent[0x18]; // 0x5f0            
            ...
            char m_DynNodeWindBases[0x18]; // 0x638            
            float m_flInternalPressure; // 0x650            
            float m_flDefaultTimeDilation; // 0x654            
            float m_flWindage; // 0x658            
            float m_flWindDrag; // 0x65c            
            float m_flDefaultSurfaceStretch; // 0x660            
            float m_flDefaultThreadStretch; // 0x664            
            float m_flDefaultGravityScale; // 0x668            
            float m_flDefaultVelAirDrag; // 0x66c            
            float m_flDefaultExpAirDrag; // 0x670            
            float m_flDefaultVelQuadAirDrag; // 0x674            
            float m_flDefaultExpQuadAirDrag; // 0x678            
            float m_flRodVelocitySmoothRate; // 0x67c            
            float m_flQuadVelocitySmoothRate; // 0x680            
            float m_flAddWorldCollisionRadius; // 0x684            
            float m_flDefaultVolumetricSolveAmount; // 0x688            
            float m_flMotionSmoothCDT; // 0x68c            
            float m_flLocalDrag1; // 0x690            
            std::uint16_t m_nRodVelocitySmoothIterations; // 0x694            
            std::uint16_t m_nQuadVelocitySmoothIterations; // 0x696            
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nDynamicNodeFlags) == 0x34);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flLocalForce) == 0x38);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flLocalRotation) == 0x3c);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nNodeCount) == 0x40);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nStaticNodes) == 0x42);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nRotLockStaticNodes) == 0x44);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nFirstPositionDrivenNode) == 0x46);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nSimdTriCount1) == 0x48);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nSimdTriCount2) == 0x4a);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nSimdQuadCount1) == 0x4c);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nSimdQuadCount2) == 0x4e);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nQuadCount1) == 0x50);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nQuadCount2) == 0x52);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nTreeDepth) == 0x54);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nNodeBaseJiggleboneDependsCount) == 0x56);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nRopeCount) == 0x58);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_Ropes) == 0x60);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_NodeBases) == 0x78);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SimdNodeBases) == 0x90);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_Quads) == 0xa8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SimdQuads) == 0xc0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SimdTris) == 0xd8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SimdRods) == 0xf0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SimdRodsAnim) == 0x108);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_InitPose) == 0x120);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_Rods) == 0x138);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_Twists) == 0x150);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_HingeLimits) == 0x168);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_AntiTunnelBytecode) == 0x180);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_AntiTunnelProbes) == 0x198);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_AntiTunnelTargetNodes) == 0x1b0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_AxialEdges) == 0x1c8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_NodeInvMasses) == 0x1e0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_CtrlOffsets) == 0x1f8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_CtrlOsOffsets) == 0x210);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_FollowNodes) == 0x228);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_CollisionPlanes) == 0x240);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_NodeIntegrator) == 0x258);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SpringIntegrator) == 0x270);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SimdSpringIntegrator) == 0x288);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_WorldCollisionParams) == 0x2a0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_LegacyStretchForce) == 0x2b8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_NodeCollisionRadii) == 0x2d0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_DynNodeFriction) == 0x2e8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_LocalRotation) == 0x300);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_LocalForce) == 0x318);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_TaperedCapsuleStretches) == 0x330);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_TaperedCapsuleRigids) == 0x348);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SphereRigids) == 0x360);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_WorldCollisionNodes) == 0x378);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_TreeParents) == 0x390);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_TreeCollisionMasks) == 0x3a8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_TreeChildren) == 0x3c0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_FreeNodes) == 0x3d8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_FitMatrices) == 0x3f0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_FitWeights) == 0x408);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_ReverseOffsets) == 0x420);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_AnimStrayRadii) == 0x438);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SimdAnimStrayRadii) == 0x450);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_KelagerBends) == 0x468);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_CtrlSoftOffsets) == 0x480);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_JiggleBones) == 0x498);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SourceElems) == 0x4b0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_GoalDampedSpringIntegrators) == 0x4c8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_Tris) == 0x4e0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nTriCount1) == 0x4f8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nTriCount2) == 0x4fa);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nReservedUint8) == 0x4fc);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nExtraPressureIterations) == 0x4fd);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nExtraGoalIterations) == 0x4fe);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nExtraIterations) == 0x4ff);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SDFRigids) == 0x500);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_BoxRigids) == 0x518);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_DynNodeVertexSet) == 0x530);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_VertexSetNames) == 0x548);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_RigidColliderPriorities) == 0x560);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_MorphLayers) == 0x578);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_MorphSetData) == 0x590);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_VertexMaps) == 0x5a8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_VertexMapValues) == 0x5c0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_Effects) == 0x5d8);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_LockToParent) == 0x5f0);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_LockToGoal) == 0x608);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_SkelParents) == 0x620);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_DynNodeWindBases) == 0x638);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flInternalPressure) == 0x650);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flDefaultTimeDilation) == 0x654);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flWindage) == 0x658);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flWindDrag) == 0x65c);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flDefaultSurfaceStretch) == 0x660);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flDefaultThreadStretch) == 0x664);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flDefaultGravityScale) == 0x668);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flDefaultVelAirDrag) == 0x66c);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flDefaultExpAirDrag) == 0x670);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flDefaultVelQuadAirDrag) == 0x674);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flDefaultExpQuadAirDrag) == 0x678);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flRodVelocitySmoothRate) == 0x67c);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flQuadVelocitySmoothRate) == 0x680);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flAddWorldCollisionRadius) == 0x684);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flDefaultVolumetricSolveAmount) == 0x688);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flMotionSmoothCDT) == 0x68c);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_flLocalDrag1) == 0x690);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nRodVelocitySmoothIterations) == 0x694);
        static_assert(offsetof(source2sdk::physicslib::PhysFeModelDesc_t, m_nQuadVelocitySmoothIterations) == 0x696);
        
        static_assert(sizeof(source2sdk::physicslib::PhysFeModelDesc_t) == 0x698);
    };
};
