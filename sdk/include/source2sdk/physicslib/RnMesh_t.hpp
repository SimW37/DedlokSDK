...
namespace source2sdk::physicslib
{
    ...
    public:
        ...
        // CUtlVector<uint8_t> m_TriangleEdgeFlags;
    ...
    static_assert(offsetof(RnMesh_t, m_TriangleEdgeFlags) == 0x78);
    static_assert(offsetof(RnMesh_t, m_Materials) == 0x90);
    static_assert(offsetof(RnMesh_t, m_vOrthographicAreas) == 0xa8);
    static_assert(offsetof(RnMesh_t, m_nFlags) == 0xb4);
    static_assert(offsetof(RnMesh_t, m_nDebugFlags) == 0xb8);
    
    static_assert(sizeof(RnMesh_t) == 0xc0);
};
