...
namespace source2sdk
{
    namespace pulse_system
    {
        ...
        #pragma pack(push, 1)
        class CPulseCell_CursorQueue : public source2sdk::pulse_system::CPulseCell_WaitForCursorsWithTagBase
        {
        public:
        ...
        static_assert(sizeof(source2sdk::pulse_system::CPulseCell_CursorQueue) == 0xa0);
    };
};
