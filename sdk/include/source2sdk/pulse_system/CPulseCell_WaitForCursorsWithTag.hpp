...
namespace source2sdk
{
    namespace pulse_system
    {
        ...
        // static metadata: MPulseCellOutflowHookInfo "ир"Ш°"
        ...
        #pragma pack(push, 1)
        class CPulseCell_WaitForCursorsWithTag : public source2sdk::pulse_system::CPulseCell_WaitForCursorsWithTagBase
        {
        public:
        ...
        static_assert(sizeof(source2sdk::pulse_system::CPulseCell_WaitForCursorsWithTag) == 0xa0);
    };
};
