...
namespace source2sdk::materialsystem2
{
    ...
    static_assert(offsetof(PostProcessingBloomParameters_t, m_flComputeBloomRadius) == 0x28);
    static_assert(offsetof(PostProcessingBloomParameters_t, m_flComputeBloomEffectsScale) == 0x2c);
    static_assert(offsetof(PostProcessingBloomParameters_t, m_flComputeBloomLensDirtStrength) == 0x30);
    static_assert(offsetof(PostProcessingBloomParameters_t, m_flComputeBloomLensDirtBlackLevel) == 0x34);
    static_assert(offsetof(PostProcessingBloomParameters_t, m_flBlurWeight) == 0x38);
    static_assert(offsetof(PostProcessingBloomParameters_t, m_vBlurTint) == 0x4c);
    
    static_assert(sizeof(PostProcessingBloomParameters_t) == 0x88);
};
