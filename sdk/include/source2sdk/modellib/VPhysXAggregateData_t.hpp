...
namespace source2sdk
{
    namespace modellib
    {
        ...
        {
        public:
            std::uint16_t m_nFlags; // 0x0            
            std::uint16_t m_nRefCounter; // 0x2            
        ...
        static_assert(offsetof(source2sdk::modellib::VPhysXAggregateData_t, m_nFlags) == 0x0);
        static_assert(offsetof(source2sdk::modellib::VPhysXAggregateData_t, m_nRefCounter) == 0x2);
        static_assert(offsetof(source2sdk::modellib::VPhysXAggregateData_t, m_bonesHash) == 0x8);
        static_assert(offsetof(source2sdk::modellib::VPhysXAggregateData_t, m_boneNames) == 0x20);
        static_assert(offsetof(source2sdk::modellib::VPhysXAggregateData_t, m_indexNames) == 0x38);
