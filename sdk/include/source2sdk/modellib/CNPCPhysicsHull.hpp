...
namespace source2sdk::modellib
{
    ...
    public:
        ...
        modellib::NPCPhysicsHullType_t m_eType; // 0x8        
    ...
    static_assert(offsetof(CNPCPhysicsHull, m_sName) == 0x0);
    static_assert(offsetof(CNPCPhysicsHull, m_eType) == 0x8);
    static_assert(offsetof(CNPCPhysicsHull, m_flCapsuleHeight) == 0xc);
    static_assert(offsetof(CNPCPhysicsHull, m_flCapsuleRadius) == 0x10);
    static_assert(offsetof(CNPCPhysicsHull, m_vCapsuleCenter1) == 0x14);
    static_assert(offsetof(CNPCPhysicsHull, m_vCapsuleCenter2) == 0x20);
    static_assert(offsetof(CNPCPhysicsHull, m_flGroundBoxHeight) == 0x2c);
    static_assert(offsetof(CNPCPhysicsHull, m_flGroundBoxWidth) == 0x30);
    
    static_assert(sizeof(CNPCPhysicsHull) == 0x38);
};
