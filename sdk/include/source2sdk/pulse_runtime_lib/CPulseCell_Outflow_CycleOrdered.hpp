...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        // static metadata: MPulseCellOutflowHookInfo "аp^лю"
        // static metadata: MPulseCellWithCustomDocNode
        #pragma pack(push, 1)
        class CPulseCell_Outflow_CycleOrdered : public source2sdk::pulse_runtime_lib::CPulseCell_BaseFlow
        {
        public:
        ...
        // Cannot assert offsets of fields in CPulseCell_Outflow_CycleOrdered because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulseCell_Outflow_CycleOrdered) == 0x60);
    };
};
