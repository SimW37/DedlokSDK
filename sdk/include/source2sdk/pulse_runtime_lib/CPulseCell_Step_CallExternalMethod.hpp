...
namespace source2sdk::pulse_runtime_lib
{
    ...
    public:
        ...
        pulse_runtime_lib::PulseMethodCallMode_t m_nAsyncCallMode; // 0x78        
        [[maybe_unused]] std::uint8_t pad_0x7c[0x4]; // 0x7c
        pulse_runtime_lib::CPulse_ResumePoint m_OnFinished; // 0x80        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CPulseCell_Step_CallExternalMethod because it is not a standard-layout class
    static_assert(sizeof(CPulseCell_Step_CallExternalMethod) == 0xc8);
};
