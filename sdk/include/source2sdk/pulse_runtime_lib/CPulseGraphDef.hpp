...
namespace source2sdk::pulse_runtime_lib
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x140[0x50];
    };
    #pragma pack(pop)
    
    static_assert(offsetof(CPulseGraphDef, m_DomainIdentifier) == 0x8);
    static_assert(offsetof(CPulseGraphDef, m_DomainSubType) == 0x18);
    static_assert(offsetof(CPulseGraphDef, m_ParentMapName) == 0x30);
    static_assert(offsetof(CPulseGraphDef, m_ParentXmlName) == 0x40);
    static_assert(offsetof(CPulseGraphDef, m_Chunks) == 0x50);
    static_assert(offsetof(CPulseGraphDef, m_Cells) == 0x68);
    static_assert(offsetof(CPulseGraphDef, m_Vars) == 0x80);
    static_assert(offsetof(CPulseGraphDef, m_PublicOutputs) == 0x98);
    static_assert(offsetof(CPulseGraphDef, m_InvokeBindings) == 0xb0);
    static_assert(offsetof(CPulseGraphDef, m_CallInfos) == 0xc8);
    static_assert(offsetof(CPulseGraphDef, m_Constants) == 0xe0);
    static_assert(offsetof(CPulseGraphDef, m_DomainValues) == 0xf8);
    static_assert(offsetof(CPulseGraphDef, m_BlackboardReferences) == 0x110);
    static_assert(offsetof(CPulseGraphDef, m_OutputConnections) == 0x128);
    
    static_assert(sizeof(CPulseGraphDef) == 0x190);
};
