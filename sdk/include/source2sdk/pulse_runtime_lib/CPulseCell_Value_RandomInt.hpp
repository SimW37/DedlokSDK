...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        // static metadata: MPulseCellOutflowHookInfo "ÀwnÖø"
        ...
        #pragma pack(push, 1)
        class CPulseCell_Value_RandomInt : public source2sdk::pulse_runtime_lib::CPulseCell_BaseValue
        {
        public:
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulseCell_Value_RandomInt) == 0x48);
    };
};
