...
namespace source2sdk::pulse_runtime_lib
{
    ...
    {
    public:
        pulse_runtime_lib::CPulse_BlackboardReference m_BlackboardReference; // 0x80        
        bool m_bSelfReference; // 0x180        
        [[maybe_unused]] std::uint8_t pad_0x181[0x7];
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CPulseCell_Inflow_ObservableVariableListener) == 0x188);
};
