...
namespace source2sdk::pulse_runtime_lib
{
    ...
    public:
        ...
        // CUtlVector<pulse_runtime_lib::CPulseCell_Timeline__TimelineEvent_t> m_TimelineEvents;
        ...
        pulse_runtime_lib::CPulse_ResumePoint m_OnCanceled; // 0xb0        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CPulseCell_Timeline because it is not a standard-layout class
    static_assert(sizeof(CPulseCell_Timeline) == 0xf8);
};
