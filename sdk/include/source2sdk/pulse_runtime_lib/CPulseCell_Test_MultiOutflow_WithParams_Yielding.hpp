...
namespace source2sdk::pulse_runtime_lib
{
    ...
    public:
        ...
        pulse_runtime_lib::SignatureOutflow_Continue m_AsyncChild1; // 0x90        
        pulse_runtime_lib::SignatureOutflow_Continue m_AsyncChild2; // 0xd8        
        pulse_runtime_lib::SignatureOutflow_Resume m_YieldResume1; // 0x120        
        pulse_runtime_lib::SignatureOutflow_Resume m_YieldResume2; // 0x168        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CPulseCell_Test_MultiOutflow_WithParams_Yielding) == 0x1b0);
};
