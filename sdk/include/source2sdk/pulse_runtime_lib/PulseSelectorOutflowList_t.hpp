...
namespace source2sdk::pulse_runtime_lib
{
    ...
    public:
        ...
        // CUtlVector<pulse_runtime_lib::OutflowWithRequirements_t> m_Outflows;
        char m_Outflows[0x18]; // 0x0        
    };
    #pragma pack(pop)
    
    static_assert(offsetof(PulseSelectorOutflowList_t, m_Outflows) == 0x0);
    
    static_assert(sizeof(PulseSelectorOutflowList_t) == 0x18);
};
