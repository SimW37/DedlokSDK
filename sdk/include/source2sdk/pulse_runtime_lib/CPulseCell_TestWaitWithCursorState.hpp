...
namespace source2sdk::pulse_runtime_lib
{
    ...
    public:
        ...
        pulse_runtime_lib::CPulse_ResumePoint m_WakeCancel; // 0x90        
        pulse_runtime_lib::CPulse_ResumePoint m_WakeFail; // 0xd8        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CPulseCell_TestWaitWithCursorState because it is not a standard-layout class
    static_assert(sizeof(CPulseCell_TestWaitWithCursorState) == 0x120);
};
