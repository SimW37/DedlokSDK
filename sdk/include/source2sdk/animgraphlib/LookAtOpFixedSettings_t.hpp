...
namespace source2sdk::animgraphlib
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0xc4[0xc];
    };
    #pragma pack(pop)
    ...
    static_assert(offsetof(LookAtOpFixedSettings_t, m_bones) == 0x98);
    static_assert(offsetof(LookAtOpFixedSettings_t, m_flYawLimit) == 0xb0);
    static_assert(offsetof(LookAtOpFixedSettings_t, m_flPitchLimit) == 0xb4);
    static_assert(offsetof(LookAtOpFixedSettings_t, m_flHysteresisInnerAngle) == 0xb8);
    static_assert(offsetof(LookAtOpFixedSettings_t, m_flHysteresisOuterAngle) == 0xbc);
    static_assert(offsetof(LookAtOpFixedSettings_t, m_bRotateYawForward) == 0xc0);
    static_assert(offsetof(LookAtOpFixedSettings_t, m_bMaintainUpDirection) == 0xc1);
    static_assert(offsetof(LookAtOpFixedSettings_t, m_bTargetIsPosition) == 0xc2);
    static_assert(offsetof(LookAtOpFixedSettings_t, m_bUseHysteresis) == 0xc3);
    
    static_assert(sizeof(LookAtOpFixedSettings_t) == 0xd0);
};
